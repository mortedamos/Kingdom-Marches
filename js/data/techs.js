...
window.GameData.TECHS = {
  ...
  halfellow_fairy_ring: {
    ...
    description: "The Mycomancer gains a full-turn action, Create Mushroom: summons a Mushroom onto an open adjacent tile (at most one Mushroom per living Mycomancer at a time). For 4 turns, every allied unit within 1 tile heals 5% of its max HP per turn (minimum 1) and gains Toadstool Tranquility. Any enemy unit within that same 1 tile has a 66% chance each turn to become Poisoned.",
