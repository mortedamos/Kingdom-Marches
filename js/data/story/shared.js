...
window.GameData.STORY_SHARED = {
  ...
  human: {
    ...
    bloodline: {
      ...
      lines: [
        ...
        { s: "corvin", t: "Majesty. Why can humans work magic at all? Dwarves can't. Halfellows can't. The Temple says the Dawn chose us. I went looking for a less flattering answer." },
        { s: "maren", t: "And?" },
        { s: "corvin", t: "Nine hundred years ago, an elf of the Silverwood loved a human woman. Their child's children founded the old magus families. The Ashcrofts. The Varros. The blood thinned, but it never left." },
        { n: "He turns the ancient page toward her. The elf's name is written in a looping silver hand: *Aelthir Moonveil*." },
        { s: "maren", t: "The Warden of the Silverwood. Our enemy is our… great-grandfather, several hundred times over." },
        { s: "corvin", t: "Which means the Dawn Omen may simply have been his blood waking in you. I'm sorry, Majesty. I did say it was a less flattering answer." },
        { s: "aldric", t: "*(from the doorway, pale)* The Temple must never hear of this.", req: { charAlive: "aldric" } },
      ],
    },
    ...
    mercy: {
      ...
      lines: [
        ...
        { s: "vaelis", t: "The Queen's own brother. Kneel, Lord-Paladin. It will be brief. Everything about your kind is.", req: { charAlive: "aldric" },
        ...
        { s: "vaelis", t: "Great-uncle. They are *mayflies*. They are at *war* with us." },
        ...
        { s: "aldric", t: "The elf spared me, sister. The Warden himself. He looked at me as though he *knew* me.", req: { charAlive: "aldric" },
          alt: { s: "corvin", t: "The Warden spared me, Majesty. He called me *blood*. I have never been so insulted and so grateful in the same breath." } },
        { s: "maren", t: "He does know us. Better than we know ourselves, it seems.", req: { seen: "bloodline" },
    ...
    "feud:1": {
      ...
      lines: [
        ...
        { s: "corvin", t: "A curse. Orcish work, a Bog Witch's. And a grove that ancient is sacred to the Elves' Archdruid. Someone is picking a very personal fight." },
        { s: "aldric", t: "Witchcraft against witchcraft. The Dawn keeps us from both.", req: { charAlive: "aldric" },
          alt: { s: "maren", t: "Let the witches claw at each other. Every curse they throw is one not thrown at us." } },
      ],
    },
    "feud:2": {
      when: { inGame: ["elf", "orc"] },
      lines: [
        ...
        { s: "corvin", t: "The orc witch Skarra and the elf Archdruid Ysolde. They despise each other more than either despises us. I find that almost restful." },
      ],
    },
    "feud:3": {
      when: { inGame: ["elf", "orc"] },
      lines: [
        ...
        { s: "maren", t: "Two of the most powerful women in the Marches, and all they wanted was each other's heads. There's a lesson in that. …Write it down." },
      ],
    },
    ...
    "whisper:1": {
      ...
      lines: [
        ...
        { s: "corvin", t: "Silver leaves. That's not orcish, dwarvish or halfellow. That's the Silverwood. Someone in the elf court is writing other people's wars for them." },
        { s: "maren", t: "Vaelis. The Warden's heir. Watch him, Archmage. A man who starts other people's wars will start ours too." },
      ],
    },
    "whisper:2": {
      when: { inGame: "elf", kingdoms: 3 },
      lines: [
        ...
        { s: "corvin", t: "He's very good. Every kingdom in the Marches is at someone's throat, and the Silverwood has barely drawn a bow." },
        { s: "maren", t: "Then let's not be the next one he plays. Keep our quarrels our own." },
      ],
    },
  },
  ...
  elf: {
    bloodline: {
      ...
      lines: [
        ...
        { s: "ysolde", t: "You grieve for the human dead more than our own, Warden. The trees have noticed. They are too polite to ask why." },
        { s: "aelthir", t: "Nine hundred years ago, I loved a human woman. We had a son. He lived a whole life in the time it takes an oak to thicken. His children's children founded the magus families of Westmarch." },
        { s: "ysolde", t: "Then the Humans' magic…" },
        { s: "aelthir", t: "…is mine. Diluted, a thousand times over. The Queen of Westmarch is my descendant. So is her brother. So is her Archmage." },
        { n: "A leaf cracks underfoot. Lord Vaelis Nightbloom stands at the edge of the clearing. His face has gone perfectly white." },
        { s: "vaelis", t: "You are telling me I share blood with *mayflies*." },
        { s: "aelthir", t: "I am telling you that you share *me* with them, Vaelis. Whether that shames you is your affair." },
        { s: "vaelis", t: "It does not shame me, great-uncle. It *explains* you." },
      ],
    },
    mercy: {
      ...
      lines: [
        ...
        { s: "vaelis", t: "A prize. I shall make an example of him, great-uncle, the kind the lesser peoples remember. Briefly." },
        { s: "aelthir", t: "You will not." },
        { s: "vaelis", t: "He is the *enemy*." },
        { s: "aelthir", t: "He is my blood, as you know very well. Give him a horse and an escort to the border. That is the Warden's word." },
        { n: "Vaelis sheathes his blade slowly, and bows exactly as deeply as courtesy requires, and not one hair deeper." },
        { s: "vaelis", t: "As the Warden commands. I shall remember this, great-uncle. I remember everything." },
        { s: "ysolde", t: "So do the trees, my son. And they remember *you* sulking." },
      ],
    },
    "feud:1": {
      when: { inGame: "orc" },
      lines: [
        ...
        { s: "ysolde", t: "Bog-rot. Wisp-poison. This is Skarra's hand, the orc witch. She has cursed a grove that was old when the Accord was sworn." },
        { s: "vaelis", t: "Then flood her bog, mother. With something that does not wash out." },
        { s: "ysolde", t: "Oh, I intend to, my son. I intend to." },
      ],
    },
    "feud:2": {
      when: { inGame: "orc" },
      lines: [
        ...
        { s: "ysolde", t: "She sent her spirits to drown in my water. I drowned them instead. Tell the bog-witch the Wellspring says *hello*." },
        { s: "aelthir", t: "Ysolde. This feud will cost us more than the war." },
        { s: "ysolde", t: "Everything costs, Warden. This one I will pay gladly." },
      ],
    },
    "feud:3": {
      when: { inGame: "orc" },
      lines: [
        ...
        { s: "ysolde", t: "You cursed my grove." },
        { s: "skarra", t: "You drowned my Wisps! And you laughed! Skarra HEARD you laugh!" },
        { s: "ysolde", t: "I did. It was the first time in a century." },
        ...
        { s: "vaelis", t: "My mother has returned with singed hair and the first smile I have seen on her in three hundred years. I find it deeply unsettling." },
      ],
    },
    ...
    "whisper:1": {
      ...
      lines: [
        ...
        { s: "vaelis", t: "A forged letter, great-uncle. A seal of the right colour, a grievance of the right size. The lesser peoples do the rest. They always do." },
        { s: "aelthir", t: "You started a war." },
        { s: "vaelis", t: "I *redirected* one. They were always going to fight someone. Better each other than us." },
        { s: "aelthir", t: "And when they find the seal, Vaelis?" },
        { s: "vaelis", t: "They will blame each other for forging it. Trust me." },
      ],
    },
    "whisper:2": {
      when: { kingdoms: 3 },
      lines: [
        ...
        { s: "ysolde", t: "You are playing with the Marches the way a child plays with ants, my son." },
        { s: "vaelis", t: "Ants do not mind, mother. Ants do not *notice*." },
        { s: "aelthir", t: "Ants remember, Vaelis. Everything does, in the end. I will not always be here to stand between you and what you've sown." },
      ],
    },
  },
  ...
  dwarf: {
    "titan:runes": [
      ...
      { s: "kazra", t: "New rune-lore from the scholars. Good. Gives me somewhere to start." },
      { s: "oskar", t: "Start what, exactly?" },
      { s: "kazra", t: "A mountain that walks, Oskar." },
      { s: "oskar", t: "Entry {grudge} in the Book of Grudges: Kazra, for being cryptic in a forge." },
    ],
    "titan:relic": [
      ...
      { s: "kazra", t: "Every relic from that age has a heartbeat. Runes older than ours, holding power still. I want to know how." },
      { s: "brunna", t: "Kazra, that's a relic of the Accord. It's not a *spare part*.", req: { charAlive: "brunna" },
        alt: { s: "sigrun", t: "Mother Kazra, that's a relic of the Accord. You can't take it apart!" } },
      { s: "kazra", t: "I'm not taking it apart. I'm *listening* to it. …Then I might take it apart a little." },
    ],
    "titan:wall": [
      ...
      { s: "kazra", t: "It hums. Good. Titan-grade runes, tested on a wall that can't walk away if they go wrong." },
      { s: "oskar", t: "And if they go *wrong*?" },
      { s: "kazra", t: "Then we'll need a new wall. Walls first." },
    ],
    "titan:tech": [
      ...
      { s: "kazra", t: "It's done. The design. Every rune for a Runeforged Titan." },
      { s: "brunna", t: "Then build it, love.", req: { charAlive: "brunna" },
        alt: { s: "sigrun", t: "Then build it, Mother Kazra. For her." } },
      { s: "kazra", t: "Now I just need a mountain.", req: { charAlive: "brunna" },
  ...
  orc: {
    "feud:1": {
      ...
      lines: [
        ...
        { s: "skarra", t: "Skarra has cursed the elf-witch's favourite grove, little Warchief! Every tree, weeping green! She'll SMELL it from her fancy spring!" },
        { s: "grukka", t: "We're at war with the whole Silverwood, and you're fighting one witch." },
        { s: "skarra", t: "One witch is *all the war Skarra needs*." },
      ],
    },
    "feud:2": {
      when: { inGame: "elf" },
      lines: [
        ...
        { s: "skarra", t: "She DROWNED them! All of them! And she *laughed*, Skarra heard it on the wind!" },
        { s: "gnash", t: "Wisps can drown? Gnash thought Wisps were made of *glow*." },
        { s: "skarra", t: "Everything drowns if the witch is spiteful enough, you great lump." },
      ],
    },
    "feud:3": {
      when: { inGame: "elf" },
      lines: [
        ...
        { s: "grukka", t: "Well? Did you win?" },
        { s: "skarra", t: "…Skarra doesn't want to talk about it." },
        { s: "gnash", t: "Witch lost. Gnash can tell. Witch only quiet when she lose." },
        { s: "skarra", t: "Neither of us lost! *Neither* of us! …Next time, Skarra brings MORE frogs." },
      ],
    },
  },
...
Object.assign(window.GameData.STORY_SHARED.dwarf, {
  "found:3": {
    ...
    lines: [
      ...
      { s: "sigrun", t: "Three holds, Mother. That's three borders to guard. Give me a war-band. Metal Singers, all of us. We'll hold the loudest border in the Marches.", req: { charAlive: "brunna" },
      ...
      { s: "oskar", t: "Entry {grudge} in the Book of Grudges, *pre-emptively*: the noise." },
      { s: "brunna", t: "…Fine. But you tune those axes before you march.", req: { charAlive: "brunna" } },
      { s: "sigrun", t: "HA! You won't regret it!" },
      { s: "kazra", t: "She will." },
    ],
  },
  "relic:found:axe_of_doom": [
    ...
    { s: "sigrun", t: "The Axe of Doom. THE Axe of Doom. The first Metal Singer's own axe. I've dreamed about this since I could *hold* a pick!" },
    { s: "oskar", t: "Entry {grudge} in the Book of Grudges: whoever let her near it." },
    { s: "kazra", t: "Give it here a moment. I want to hear its runes." },
    { s: "sigrun", t: "You can hear its runes from *there*, Mother Kazra. Everyone can. That's the *point*." },
  ],
  "relic:news:axe_of_doom": [
    ...
    { s: "sigrun", t: "The Axe of Doom? In *their* hands? They don't even know which end you strum!" },
    { s: "brunna", t: "Then go and get it back, daughter.", req: { charAlive: "brunna" }, alt: { s: "kazra", t: "Then go and get it back, Thane." } },
    { s: "sigrun", t: "Gladly." },
  ],
});
...
Object.assign(window.GameData.STORY_SHARED.orc, {
  "found:3": {
    ...
    lines: [
      ...
      { s: "varg", t: "Father. Three camps, and all three will be empty by spring if we just take and move on. Let me build something here. Walls. A well. Something we *keep*.", req: { notFlag: "mossDead" },
        alt: "Three camps. Good. More places to raise warriors. More warriors to make them pay." },
      { s: "grukka", t: "Orcs don't keep, boy.", req: { notFlag: "mossDead" }, alt: "…You used to want to build things, boy." },
      { s: "varg", t: "Then orcs have never had anything worth keeping. Let's change that.", req: { notFlag: "mossDead" }, alt: "I used to have Moss." },
      { s: "skarra", t: "Soft! SOFT! Skarra has frogs with harder hearts!", req: { notFlag: "mossDead" },
