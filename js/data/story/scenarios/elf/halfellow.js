...
window.GameData.STORY_SCENARIOS["elf/halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aelthir", t: "And to the south, the Hearthlands. The halfellows. I held the torch when their first Mayor swore the Accord. I promised, then, to shelter them." },
      { s: "vaelis", t: "You promised a great many things to a great many small people, great-uncle. The stone that held you to those promises is broken." },
      { s: "ysolde", t: "The oaks are asking whether this war means mushrooms." },
      { s: "vaelis", t: "It will mean *pies*, mother. Thrown ones. The Trickgrin woman has been an embarrassment to me for forty years." },
      ...
      { s: "hobby", t: "The Elves. Oh, bother. I *like* the Elves. …Well. Most of them." },
    ],
    B1: [
      ...
      { s: "vaelis", t: "A grove facing the Hearthlands. The halfellows will see it every morning and remember who was here first." },
      { n: "By the next morning, somebody has planted a neat row of mushrooms all the way around the new grove, spelling out a word." },
      { s: "ysolde", t: "It says *HELLO*, my son. In mushrooms. They are very good mushrooms." },
      { s: "vaelis", t: "*Burn* them." },
    ],
    B2: [
      { n: "The forest's edge, at dawn. Elf and halfellow warriors have clashed for the first time since the Accord." },
      { s: "aelthir", t: "First blood, with the halfellows. I swore to shelter them, Ysolde." },
      { s: "ysolde", t: "The Accord is broken, Warden. So is the oath. The trees say you may stop feeling guilty. They do not think you will." },
      { n: "In The Goose & Kettle, Hobby hears the news quietly, and for once she doesn't grin." },
      { s: "hobby", t: "First blood. With the *Elves*. I used to take bets on who could make Lord Vaelis twitch." },
    ],
    B3: [
      ...
      { s: "ysolde", t: "The geese are wearing little hats, my son." },
      { s: "vaelis", t: "I can *see* the hats, mother." },
      { n: "Beneath the Heartwood, the ancient Warden hears the story, and laughs until he has to sit down." },
      { s: "aelthir", t: "I have not laughed like that since the Accord. Tell no one, Ysolde." },
    ],
    B4: [
      ...
      { s: "ysolde", t: "The druids have argued with the mycomancers about the rot beneath the forest for three hundred years. I asked her what she thought of the stone." },
      { s: "ysolde", t: "She said: “Decay makes room, dear.” The stone did not break, Warden. It *sighed*, and rotted, and made room. For whatever grows next." },
      { s: "aelthir", t: "Then the Accord cannot be restored." },
      { s: "ysolde", t: "Only replaced. The halfellow and the trees agree. That has never happened before." },
      { s: "vaelis", t: "I am losing this war to *mushrooms*." },
    ],
    B6: [
      ...
      { s: "aelthir", t: "“Warden, you swore to shelter us once. I know you can't now. No hard feelings. The honey's from the geese. Hobby.”" },
      { s: "ysolde", t: "Geese do not make honey, Warden." },
      { s: "aelthir", t: "I know, Ysolde. That is rather the joke." },
      { s: "vaelis", t: "*(from the shadows)* If that honey is from *my tent*, great-uncle, I will have her *head*." },
    ],
    ...
    "E-Held": [
      ...
      { s: "ysolde", t: "And to mushrooms now, my son. They have a great deal to say about you." },
      ...
      { s: "vaelis", t: "…Tell her I shall come. And that I am bringing my *own* geese.", req: { alive: "halfellow" } },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying the Halfellows. The Hearthlands are empty, and the meadows are going back to forest." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "The Trickgrin woman is gone. The Silverwood will be quieter." },
      { n: "Vaelis stands at the edge of an empty meadow for a very long time." },
      { s: "vaelis", t: "…I find I do not care for the quiet, great-uncle." },
      { s: "aelthir", t: "Nor I, child. I swore to shelter them." },
    ],
    "E-Fallen": [
      { n: "The Halfellows have broken the Silverwood. {capital} has been surrounded by barley fields and very polite militia." },
      { s: "ysolde", t: "The oaks are going back to sleep, Warden. The mushrooms are staying up." },
      { s: "aelthir", t: "I swore to shelter them. In the end, they sheltered themselves. Tell the Mayor I am proud of her." },
      { n: "Lord Vaelis mounts his Shadowsteed. A goose is sitting on its saddle." },
      { s: "vaelis", t: "I shall remember all of you. Briefly. Except *her*. Her I shall remember *forever*." },
      { s: "hobby", t: "*(in the ruins)* Leave the Warden's tree alone, everybody. And put the kettle on." },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "I swore to shelter them, Ysolde. They have ended up sheltering the whole Marches." },
      { n: "A letter arrives from The Goose & Kettle: supper, every Midsummer, forever. Lord Vaelis reads it twice." },
      { s: "vaelis", t: "…I suppose one supper would not *kill* me." },
    ],
  },
};
