...
window.GameData.STORY_SCENARIOS["elf/dwarf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aelthir", t: "I held the torch when they swore it. A thousand years of peace. Broken in a night." },
      ...
      { s: "vaelis", t: "Then the Silverwood holds them. Who else is there? The mud-folk?" },
      { s: "ysolde", t: "The roots at the eastern edge are trembling, my son. Something is digging beneath them." },
      ...
      { s: "aelthir", t: "The Rootcut. Eight hundred years ago, dwarf tunnels ran beneath a grove of our elder trees, and every one of them died from the roots up." },
      { s: "vaelis", t: "Then let us finish what the mud-folk started, great-uncle. Seal their holes. The world will be quieter." },
      { s: "aelthir", t: "*(quietly)* I stood in that grove, Vaelis. It never *felt* like dwarves." },
    ],
    B1: [
      ...
      { s: "vaelis", t: "A grove, on the eastern edge. Facing the mud-folk. Let them see what they will never have." },
      { s: "ysolde", t: "The trees there are uneasy. They can hear digging." },
      { s: "aelthir", t: "Then post rangers in the treetops, and let no tunnel come within a mile of a root." },
    ],
    B2: [
      { n: "The forest's edge, at dawn. Elf and dwarf warriors have clashed for the first time since the Accord." },
      { s: "aelthir", t: "First blood. Theirs and ours. I will remember every name, Vaelis. Even theirs." },
      { s: "vaelis", t: "You mourn the mud-folk, great-uncle? They would not mourn *you*." },
      { s: "aelthir", t: "They have a book for their grudges. I have only my memory. Mine is longer." },
      { n: "In Karrak, the Dwarves' Loremaster Oskar opens an iron-bound tome, the Book of Grudges, to its very first page." },
      { s: "oskar", t: "Entry the First: the Rootcut. Reopened." },
    ],
    B4: [
      { n: "Beneath the Heartwood, Ysolde kneels among its roots with her eyes closed. She has been listening for three days." },
      { s: "ysolde", t: "The stone did not break, Warden. It *sighed*. And its roots run under half the Marches. Under the old Rootcut grove, too." },
      { s: "aelthir", t: "…Its roots." },
      { s: "ysolde", t: "When the stone drew power to hold the Accord, it drank that grove dry. The dwarves' tunnels never killed a thing. It was the *stone*, Warden." },
      ...
      { s: "vaelis", t: "How thorough. Tell your Thane we are not interested in being *right*, herald. We are interested in being rid of you." },
      { s: "aelthir", t: "*(after the herald has gone)* We blamed them for eight hundred years, Vaelis." },
      { s: "vaelis", t: "Then we have eight hundred years of practice, great-uncle. It would be a shame to waste it." },
    ],
    B6: [
      ...
      { s: "aelthir", t: "I owe the Holds of Karrak an apology, Ysolde. The oldest one in the Marches." },
      { s: "ysolde", t: "Then give it, Warden. The trees would like to hear it." },
      { s: "vaelis", t: "An apology from the Silverwood, to the mud-folk, in the middle of a war. Great-uncle, the Conclave will think you *senile*." },
      { s: "aelthir", t: "The Conclave, Vaelis, may think what it likes. I stood in that grove." },
    ],
    ...
    "E-Held": [
      ...
      { s: "aelthir", t: "“I stood in that grove. I should have listened. I am sorry.”", req: { alive: "dwarf" } },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying the Dwarves. The mountains of Karrak are silent." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "The mud-folk, gone. The Rootcut, avenged. They ended, as brief things do." },
      { s: "aelthir", t: "It was never theirs to answer for, Vaelis. And now there is no one left to apologise to." },
    ...
    "E-Fallen": [
      ...
      { s: "aelthir", t: "Tell the Thane of Karrak… it was never them. The grove. Tell her I knew." },
      ...
      { s: "oskar", t: "Entry the First. The Rootcut. …Struck out. Too late. It's always too late." },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "The Dwarves hold the stone they cut. Perhaps that is fitting. I will witness their Accord. The second of my life." },
      { s: "vaelis", t: "You will *witness* the mud-folk's treaty, great-uncle? I shall be elsewhere. Anywhere." },
      { s: "ysolde", t: "Then I shall go with the Warden, my son. The trees want to see the stone kept by the people who were blamed for them." },
    ],
  },
};
