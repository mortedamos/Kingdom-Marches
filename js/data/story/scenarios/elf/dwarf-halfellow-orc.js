...
window.GameData.STORY_SCENARIOS["elf/dwarf+halfellow+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "vaelis", t: "Our neighbours, great-uncle: the mud-folk in their holes, the Orcs in their bog, the halfellows in their burrows. Everyone in the Marches lives *underground* except us.", m: "aloof" },
      { s: "ysolde", t: "They live in the earth, my son. We live in the trees. The trees live in the earth. It is all the same soil.", m: "uncanny" },
      { s: "vaelis", t: "Mother, please do not make me *related* to the mud-folk before breakfast.", m: "aloof" },
      ...
      { s: "skarra", t: "Dwarves AND elves AND the goose-girl's people! Skarra has curses for EVERYONE!", m: "gleeful" },
    ],
    B1: [
      ...
      { s: "ysolde", t: "Deep roots. The trees want to hear what the tunnels and the bogs are saying.", m: "uncanny" },
      { s: "vaelis", t: "They are saying *dig*, mother. And *burn*. And *pie*. It is not a sophisticated conversation.", m: "aloof" },
    ],
    B2: [
      ...
      { s: "aelthir", t: "First blood. Every one of these peoples has an old wound with us. Now they have a new one.", m: "sad" },
      { s: "vaelis", t: "Then let us make it a *memorable* one, great-uncle.", m: "aloof" },
    ],
    B6: [
      { n: "Night, beneath the Heartwood. Ysolde has pressed her ear to the roots for hours, listening." },
      { s: "ysolde", t: "Under the whole Marches, Warden: dwarf tunnels, orc bog-water, halfellow cellars. All touching. All the same soil.", m: "uncanny" },
      { s: "aelthir", t: "And the Marchstone's roots through all of it.", m: "wistful" },
      { s: "ysolde", t: "Yes. Everyone is standing on the same stone, and fighting over who owns the top of it.", m: "uncanny" },
      { s: "vaelis", t: "Then let us own the *top*, great-uncle. The view is better.", m: "aloof" },
    ],
    ...
    "E-Held": [
      ...
      { s: "ysolde", t: "And to *bogs* now, my son. And *tunnels*. They all have a great deal to say about you.", m: "uncanny" },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying every rival. The tunnels, the bog and the burrows are silent." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "No one underground any more, great-uncle. We have the whole Marches to ourselves.", m: "aloof" },
      { s: "ysolde", t: "The roots are quiet, Warden. No tunnels. No bog-water. No cellars. It is very lonely down there.", m: "sad" },
      { s: "aelthir", t: "It is very lonely up here too, Ysolde.", m: "sad" },
    ],
    "E-Fallen": [
      { n: "The Silverwood has fallen, and {capital} is lost." },
      { s: "ysolde", t: "The oaks are going back to sleep, Warden.", m: "sad" },
      { s: "aelthir", t: "Same soil, Ysolde. They will grow something here. It may even be good.", m: "wistful" },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly.", m: "aloof" },
      { s: "skarra", t: "The elf-witch's forest, ASH! Ha! HA!", m: "gleeful", req: { conqueror: "orc" } },
      { s: "oskar", t: "Entry the First. Settled. It doesn't feel settled.", m: "sad", req: { conqueror: "dwarf" } },
      { s: "hobby", t: "Leave the big tree standing, everyone. Put a bench under it.", m: "sad", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "One of the underground peoples holds the Marches. I will witness their Accord. It is all the same soil, in the end.", m: "wistful" },
      { s: "vaelis", t: "Please stop saying that, great-uncle.", m: "angry" },
    ],
  },
};
