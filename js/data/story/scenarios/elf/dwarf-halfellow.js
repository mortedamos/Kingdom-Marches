...
window.GameData.STORY_SCENARIOS["elf/dwarf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "vaelis", t: "Our neighbours: the mud-folk of Karrak in their mountains, and the halfellows of the Hearthlands in their meadows. And between them, great-uncle, a very old *partnership*." },
      { s: "aelthir", t: "The ale trade. Halfellow barley, dwarf brewing. They have shared a barrel at every Midsummer Fair for three hundred years." },
      { s: "vaelis", t: "And never once invited us." },
      { s: "ysolde", t: "Did you *want* to be invited, my son?" },
      { s: "vaelis", t: "Certainly not. I merely wished to be asked, so that I could refuse." },
    ...
    B1: [
      ...
      { s: "vaelis", t: "Right on their trade road. Every barrel of ale between Karrak and the Hearthlands will have to pass through *our* trees." },
      { s: "aelthir", t: "You are taxing their *ale*, Vaelis." },
      { s: "vaelis", t: "I am *inconveniencing* their friendship, great-uncle. The ale is merely a vehicle." },
    ],
    B2: [
      ...
      { s: "aelthir", t: "First blood. And I wonder, Ysolde, how many of the ones who fell once shared a barrel with the ones who killed them." },
      { s: "oskar", t: "*(in Karrak)* Entry the First, the Rootcut. Reopened.", req: { firstBlood: "dwarf" } },
      { s: "hobby", t: "*(in the Hearthlands)* First blood with the Elves. I used to take bets on who could make Lord Vaelis twitch.", req: { firstBlood: "halfellow" } },
    ],
    B6: [
      ...
      { s: "aelthir", t: "They are still singing together, Ysolde. In the middle of a war." },
      { s: "ysolde", t: "And we have never once been asked to sing, Warden." },
      { s: "vaelis", t: "Elves do not *sing drinking songs*, mother." },
      { s: "ysolde", t: "No, my son. That, I think, is rather our problem." },
    ],
    ...
    "E-Remains": [
      ...
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "Their partnership is ended, great-uncle. As brief things do." },
      { s: "aelthir", t: "We were never invited, Vaelis. And now there is no one left to invite us." },
    ...
    "E-Fallen": [
      ...
      { s: "aelthir", t: "They beat us *together*. I think that is what I envy most." },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly." },
      { s: "hobby", t: "*(in the ruins)* Leave a barrel under the Heartwood, dear. For the Warden. He always looked thirsty.", req: { conqueror: "halfellow" } },
      { s: "oskar", t: "*(in the ruins)* Entry the First. The Rootcut. Settled. Finally.", req: { conqueror: "dwarf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "vaelis", t: "…We are *not* going." },
      { s: "aelthir", t: "*We*, Vaelis, are going." },
    ],
  },
};
