 ...
 * Aelthir sees Maren's great-great-grandmother in her: the same hunger, the same
...
window.GameData.STORY_SCENARIOS["elf/human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aelthir", t: "Their Queen, Maren. I taught her great-great-grandmother to read. I sent the family a sapling at her coronation.", m: "wistful" },
      { s: "ysolde", t: "She let it die, Warden. The trees told me.", m: "uncanny" },
      { s: "aelthir", t: "Yes. The young always do. They forget to water what they did not plant themselves.", m: "sad" },
    ...
    B1: [
      ...
      { s: "vaelis", t: "Let their scholars measure *that*.", m: "aloof" },
    ...
    B2: [
      ...
      { s: "vaelis", t: "And now they come with soldiers behind their scholars. Mayflies, great-uncle. Bright, brief, and taking in a season what took us an age to grow.", m: "aloof" },
    ...
    B6: [
      ...
      { s: "vaelis", t: "You are *pitying* them now, great-uncle? While their soldiers camp in our groves?", m: "angry" },
    ...
    "E-Remains": [
      ...
      { s: "aelthir", t: "They were *my blood*, Vaelis. Diluted a thousand times. Still mine.", m: "sad", req: { seen: "bloodline" }, alt: "I taught their great-great-grandmother to read, Vaelis." },
    ...
    "E-Fallen": [
      ...
      { s: "aelthir", t: "Tell the Queen of Westmarch… her great-great-grandmother read beautifully. She should know that.", m: "sad" },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly.", m: "aloof" },
      { n: "In the ruins, Queen Maren of Westmarch finds a single book beneath the Heartwood: a child's primer, more than a century old, inscribed in her great-great-grandmother's hand." },
