...
window.GameData.STORY_SCENARIOS["elf/dwarf+halfellow+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aelthir", t: "I held the torch when the five crowns swore it. A human Queen. A dwarf Thane. An orc Warchief. A halfellow Mayor. And my own grandmother.", m: "wistful" },
      { s: "aelthir", t: "I remember how young they all looked.", m: "wistful" },
      ...
      { s: "vaelis", t: "Then every one of their descendants will come for it. Four kingdoms of the brief, great-uncle, and only one of the *enduring*.", m: "aloof" },
      { s: "aelthir", t: "I have outlived the Accord, Vaelis. I intend to outlive its breaking too.", m: "wistful" },
      { s: "vaelis", t: "Oh, I have no doubt of it, great-uncle. The question is whether the Silverwood will outlive *you*.", m: "aloof" },
    ...
    B2: [
      ...
      { s: "aelthir", t: "First blood. I will remember every name, Vaelis, ours and theirs. That is what the long memory is for.", m: "sad" },
      { s: "vaelis", t: "You mourn the enemy, great-uncle? It embarrasses the court.", m: "aloof" },
      { s: "aelthir", t: "Then let the court be embarrassed. I knew their ancestors.", m: "wistful" },
    ],
    B6: [
      ...
      { s: "aelthir", t: "The old world is ending, Ysolde. One kingdom at a time. And I have to decide what the Silverwood carries into the new one.", m: "sad" },
      { s: "ysolde", t: "And who carries it, Warden.", m: "uncanny" },
      { n: "They both look at Vaelis, who stands at the edge of the clearing with his arms folded." },
      { s: "vaelis", t: "Carry the Silverwood forward, great-uncle, not those five dead names. Let the old promises die with the old world.", m: "aloof" },
      { s: "aelthir", t: "No, Vaelis. The names are the only thing worth carrying.", m: "wistful" },
    ],
    ...
    "E-Held": [
      ...
      { s: "aelthir", t: "And I will write a new Accord, with every crown still standing. This time, I will not be its only witness.", m: "happy" },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying every other kingdom. The last witness is the last crown." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "They ended, great-uncle. As brief things do. I told you they would.", m: "aloof" },
      { s: "aelthir", t: "I outlived the Accord, and everyone who swore it. And now I have outlived their children's children too.", m: "sad" },
      { n: "It is quiet beneath the Heartwood, and hollow." },
      { s: "aelthir", t: "Sit down, Vaelis. I am going to teach you the names. All of them. Someone has to remember what the brief were *for*.", m: "wistful" },
    ],
    "E-Fallen": [
      ...
      { s: "aelthir", t: "Take the book, Ysolde. The names. Someone must remember them.", m: "sad" },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly.", m: "aloof" },
      { s: "ysolde", t: "*(taking the book)* No, my son. *I* shall remember them. Properly.", m: "sad" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "A new Accord will be sworn. I will witness it, the second of my life. I remember how young they all looked. They still do.", m: "wistful" },
      { s: "vaelis", t: "You will outlive this one too, great-uncle.", m: "aloof" },
      { s: "aelthir", t: "Perhaps, Vaelis. But this time I will not be the only one who remembers. I will make sure of it.", m: "wistful" },
    ],
  },
};
