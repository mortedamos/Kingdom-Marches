...
window.GameData.STORY_SCENARIOS["elf/dwarf+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "vaelis", t: "Every crown in the Marches will want to know what the Accord *promised* them, great-uncle. And only one person alive was in the room." },
      { s: "aelthir", t: "I held the torch. I remember every word." },
      { s: "vaelis", t: "Then you are the most valuable thing in the Silverwood. I do hope you realise that." },
      ...
      { s: "ysolde", t: "“Tell us what the Accord owed *us*.”" },
    ],
    B1: [
      ...
      { s: "vaelis", t: "The Dwarves want you to say the Marchstone was theirs. The Humans want you to say the Accord gave them the roads. The Orcs want you to say it cheated them." },
      { s: "aelthir", t: "It gave the Dwarves nothing but a debt of stone. It gave the Humans nothing but time. And it did cheat the Orcs, Vaelis. It cheated them of the good land." },
      { s: "vaelis", t: "Then say *none* of that, great-uncle. Say whatever wins us the war." },
    ],
    B2: [
      ...
      { s: "aelthir", t: "First blood. And every one of them still wants my testimony." },
      { s: "vaelis", t: "Then sell it, great-uncle. To the highest bidder. I will handle the negotiations." },
    ],
    B3: [
      { n: "Beneath the Heartwood. Lord Vaelis has returned from a secret meeting, and he is smiling his thinnest smile." },
      { s: "vaelis", t: "Great-uncle, the Dwarves will leave our forest alone if the last witness swears the Marchstone was theirs by right. I have agreed to swear it. On your behalf." },
      { s: "aelthir", t: "You have *what*?" },
      { s: "vaelis", t: "You are the last witness. I am your heir. When you are gone, great-uncle, my testimony will be the only testimony there is. I thought I would start early." },
      { s: "ysolde", t: "My son. That is a *lie*." },
      { s: "vaelis", t: "It is a *negotiation*, mother. The lesser peoples cannot tell the difference. Neither, frankly, can I." },
      { s: "aelthir", t: "The Accord favoured no one, Vaelis. That was the entire point of it. I will not lie about it. Not for the forest. Not for you." },
    ],
    B6: [
      { n: "Night, at the split Marchstone. Aelthir has come alone, to stand where he stood a thousand years ago holding a torch." },
      { s: "aelthir", t: "They all want me to say it was theirs. It was never anyone's. That was why it worked." },
      { n: "Ysolde finds him there at dawn. She has brought Vaelis. He looks, for once, uncertain." },
      { s: "ysolde", t: "Tell them the truth, Warden. All of them, together. Then no one can lie about it after you're gone." },
      { s: "vaelis", t: "…Not even me, great-uncle. I suppose that is the point." },
    ],
    ...
    "E-Held": [
      ...
      { s: "vaelis", t: "Because I tried to lie for you." },
      { s: "aelthir", t: "Because you tried to lie *as* me, Vaelis. When you understand the difference, come and see me." },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying every rival. There is no one left to ask what the Accord promised." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "No one left to testify to, great-uncle. Your memory is the only record now. It is ours to write." },
      { s: "aelthir", t: "Then I will write the truth, Vaelis. Even if no one reads it." },
    ],
    "E-Fallen": [
      ...
      { s: "aelthir", t: "Write it down, Ysolde. Every word of the Accord. The truth. Before Vaelis can tell it any other way." },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly. And I shall remember it *correctly*, great-uncle. I promise." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "They will write a new Accord. I will witness it, the second of my life, and I will tell them what the first one really said, so they do not repeat its mistakes." },
      { s: "vaelis", t: "And I shall stand beside you, great-uncle, and *not* improve on it." },
    ],
  },
};
