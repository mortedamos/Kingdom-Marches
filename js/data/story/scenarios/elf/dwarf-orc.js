...
window.GameData.STORY_SCENARIOS["elf/dwarf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aelthir", t: "And to the east, the Dwarves of Karrak. To the south, the Orcs of the Bloodmire. They fought the Mountain Wars for centuries, until the Accord made them stop.", m: "wistful" },
      { s: "vaelis", t: "And now nothing will stop them. How *convenient*. We need only wait, great-uncle, and let them do our work.", m: "aloof" },
      { s: "aelthir", t: "I have no wish to stand in their war, Vaelis. The Silverwood will stay apart from it.", m: "sad" },
      { s: "ysolde", t: "The trees do not think we will be allowed to, Warden.", m: "uncanny" },
    ...
    B1: [
      ...
      { s: "aelthir", t: "Far from both of them. The Silverwood is not their battlefield.", m: "angry" },
      { s: "vaelis", t: "The Silverwood, great-uncle, is between their battlefields. It is very difficult to stand apart from a war when you are standing in the *middle*.", m: "aloof" },
    ],
    B2: [
      ...
      { s: "aelthir", t: "First blood. We did not choose this fight. It walked through our forest.", m: "sad" },
      { s: "ysolde", t: "Wars do that, Warden. They are not polite about trees.", m: "uncanny" },
      { s: "vaelis", t: "Then let us be *impolite* back.", m: "aloof" },
    ],
    B6: [
    ...
    "E-Remains": [
      ...
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "They ended, great-uncle. As brief things do. We did not even have to push very hard.", m: "aloof" },
      { s: "aelthir", t: "The two in the tunnels, Vaelis. The Thane's daughter and the Warchief's son. I said I would not let their parents' war end them.", m: "sad", req: { seen: "lovers:meet" },
        alt: "I wanted to stand apart from their war, Vaelis. Instead I finished it." },
      { s: "aelthir", t: "I was wrong. I did not stop it. I only watched.", m: "sad", req: { seen: "lovers:meet" } },
    ],
    "E-Fallen": [
      ...
      { s: "aelthir", t: "I wanted to stand apart. In the end, the war stood on *us*.", m: "sad" },
      { s: "vaelis", t: "*(mounting his Shadowsteed)* I shall remember all of you. Briefly.", m: "aloof" },
      { s: "skarra", t: "The elf-witch's forest, ASH! Skarra wins!", m: "gleeful", req: { conqueror: "orc" } },
      { s: "oskar", t: "Entry the First, the Rootcut. Settled. Finally. It doesn't feel settled.", m: "sad", req: { conqueror: "dwarf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "One side of the Mountain War holds the Marches. I will witness their Accord, and I will ask for one clause: the tunnels stay open.", m: "wistful" },
      { s: "vaelis", t: "For *trade*, great-uncle?", m: "aloof" },
      { s: "aelthir", t: "For two young people who taught me something, Vaelis.", m: "happy", req: { seen: "lovers:meet" }, alt: "For peace, Vaelis. Tunnels are how the mud-folk visit." },
    ],
  },
};
