...
window.GameData.STORY_SCENARIOS["elf/orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "vaelis", t: "*(reading the scouts' report)* Something called *Gnash* wishes to speak with me? How extraordinary. No.", m: "aloof" },
    ],
    B1: [
      ...
      { s: "ysolde", t: "Plant it deep. The roots will need to be strong. She is going to try to burn them.", m: "uncanny" },
      { s: "vaelis", t: "Then we shall plant it *wet*, mother. You have a spring for that.", m: "aloof" },
    ],
    B2: [
      { n: "The borderwood, at dawn. Orc war-bands have set the forest's edge alight, and elf rangers have met them in the smoke." },
      { s: "aelthir", t: "First blood. And first fire. The forest will remember this for a thousand years.", m: "sad" },
      { s: "vaelis", t: "Fire-bringers. The forest's oldest enemy. Send the rangers, great-uncle. I shall not ask twice.", m: "angry" },
      { n: "At the Speaking Stones, the ancient standing stones glow red. Skarra dances between them." },
      { s: "skarra", t: "Elf blood and elf ash! The ancestors are FEASTING, little Warchief!", m: "gleeful" },
      { s: "grukka", t: "Burn their trees, Skarra. Not our own camp. *Again*.", m: "angry" },
    ],
    B6: [
      ...
      { s: "ysolde", t: "Skarra left me a message, Warden. Burned into the bark of the oldest oak in the south.", m: "uncanny" },
      { s: "aelthir", t: "What does it say?" },
      { s: "ysolde", t: "*Still angry about the frog.*", m: "uncanny" },
      { s: "vaelis", t: "Eighty years. A war. Burning groves. Over a *frog*.", m: "aloof" },
      { s: "ysolde", t: "Over *pride*, my son. You of all people should understand.", m: "uncanny" },
    ],
    ...
    "E-Held": [
      ...
      { s: "skarra", t: "*(reading)* “Your frog. Returned. I kept it eighty years. It is well. — Y.” …She KEPT my Destiny's *brother*?! My frog's BROTHER?!", m: "angry", req: { alive: "orc" } },
    ],
    "E-Remains": [
      { n: "The Elves have won by destroying the Orcs. The Bloodmire is silent, and the fires are out." },
      { s: "stone", t: "REMAINS." },
      { s: "vaelis", t: "The fire-bringers, gone. They ended, as brief things do.", m: "aloof" },
      { s: "ysolde", t: "The bog-witch is gone. I expected to feel triumphant.", m: "sad" },
      { s: "ysolde", t: "…I feel as though someone has closed a window. I shall miss hating her, Warden. Isn't that strange?", m: "sad" },
      { s: "aelthir", t: "No, Ysolde. It is the least strange thing you have ever said.", m: "wistful" },
    ],
    "E-Fallen": [
      { n: "The Orcs have broken the Silverwood. The forest is burning, and {capital} is falling." },
      { s: "ysolde", t: "The oaks are going back to sleep, Warden. The fire is too close.", m: "sad" },
      ...
      { s: "gnash", t: "*(arriving, cleaver raised)* Pretty one! Pretty one LOOK at Gnash!", m: "angry" },
      { s: "vaelis", t: "*(not looking)* No.", m: "aloof" },
      { s: "skarra", t: "The elf-witch's forest, ASH! Skarra wins! Skarra WINS! …Where is she? WHERE IS SHE?", m: "gleeful" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aelthir", t: "The Orcs hold the Marches. They will need to learn to keep them. Perhaps we can teach them how.", m: "wistful" },
      { s: "vaelis", t: "Teach the fire-bringers to garden, great-uncle? You have finally gone mad.", m: "aloof" },
      { s: "ysolde", t: "I shall go and teach Skarra myself. She will hate it. So shall I. It will be *wonderful*.", m: "happy" },
    ],
  },
};
