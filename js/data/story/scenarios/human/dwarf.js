...
window.GameData.STORY_SCENARIOS["human/dwarf"] = {
  ...
  beats: {
    ...
    B1: [
      ...
      { s: "maren", t: "I've already chosen the site. Consecrate it at sunrise. Survey it at noon. Build it by evening. With *local* stone.", m: "resolute" },
    ],
    B2: [
      ...
      { s: "maren", t: "The Dwarves are collecting their debt with axes now. Brunna Stonefast always did prefer to collect in person.", m: "happy" },
    ...
    "E-Held": [
      ...
      { s: "corvin", t: "A renewable Omen, and a paid debt. How very *efficient*.", m: "wry" }, { s: "aldric", t: "Paid in full, and blessed besides. Admit it, Archmage: the Dawn keeps better accounts than the Temple ever did.", m: "happy" },
    ],
    "E-Remains": [
      { n: "Westmarch has won by destroying the Dwarves. The mountain holds are silent." },
      { s: "stone", t: "REMAINS." },
      { n: "Maren sits alone with the pen, and a four-hundred-year-old loan contract that no one will ever collect." },
      ...
      { s: "corvin", t: "Every Accord begins with someone who won, Majesty. The trick is being the one who *stops*.", m: "sad" }, { s: "aldric", t: "Then let the Temple be the one that stops, Archmage. I'll preach it from the Cathedral steps myself.", m: "fervent" },
    ],
    "E-Fallen": [
