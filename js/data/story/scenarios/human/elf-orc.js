...
window.GameData.STORY_SCENARIOS["human/elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come. And the Silverwood lies between their bog and our river.", m: "resolute" },
    ...
    B1: [
      ...
      { s: "maren", t: "Consecrate it. Survey it. And keep a bucket chain ready.", m: "resolute" },
    ],
    B2: [
