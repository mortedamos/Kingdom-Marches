...
window.GameData.STORY_SCENARIOS["human/elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come. And the Silverwood lies between their bog and our river. So we meet them at the forest's edge, not ours.", m: "resolute" },
      { s: "aldric", t: "*(a moment too quickly)* The Orcs are oath-breakers, Majesty. The Dawn knows the truth.", m: "sad" },
      { n: "In the Bloodmire, the Orcs' swamp country, the Bog Witch Skarra Ironjaw is already lighting torches." },
      { s: "skarra", t: "The tree-folk's pretty forest first! Skarra has waited EIGHTY YEARS to see the Silverwood burn!", m: "gleeful" },
      ...
      { s: "aelthir", t: "Write to the Queen of Westmarch. Tell her the fire will not stop at the forest's edge.", m: "sad" },
      { s: "vaelis", t: "Ask the *mayflies* for help? Great-uncle, they cannot even help *themselves*.", m: "aloof" },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. And, Majesty, from the tower I can see smoke over the Silverwood. Every day, a little more.", m: "sad" },
      { s: "maren", t: "Consecrate it. Survey it. And send a Collegium weather-mage to the Warden. If the Orcs set the forest alight, I want rain there before the fire is.", m: "resolute" },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "maren", t: "*(reading the Warden's letter)* “The Orcs are burning the Silverwood, grove by grove. Under the Accord, Westmarch was sworn to help. I know the stone is broken. I am asking anyway.”", m: "sad" },
      { s: "corvin", t: "No oath binds us, Majesty. The stone is broken. We owe the Silverwood nothing.", m: "wry" },
      { s: "aldric", t: "The Dawn says we owe *everyone* something, Archmage. I… I have reason to know.", m: "sad" },
      { n: "Corvin raises an eyebrow. The Lord-Paladin has never before argued for helping the Elves." },
      { s: "maren", t: "We can't send an army. We need every sword on our own border. Tell the Warden… tell him I'm sorry.", m: "sad" },
      { s: "skarra", t: "*(at the Speaking Stones)* The Queen said NO! The tree-folk BURN, and the Queen says NO! Oh, this is the BEST war!", m: "gleeful" },
    ],
    ...
    mercy: {
      ...
      lines: [
        ...
        { s: "vaelis", t: "The Queen's own brother. The Queen who would not help us. Kneel, Lord-Paladin. It will be brief. Everything about your kind is.", m: "aloof", req: { charAlive: "aldric" },
        ...
        { s: "vaelis", t: "Great-uncle. They left us to *burn*.", m: "angry" },
        ...
        { s: "corvin", t: "The Warden spared me, Majesty. He called me *blood*. I have never been so insulted and so grateful in the same breath.", m: "wry", req: { charDead: "aldric" } },
        { n: "The Lord-Paladin does not ride home. He rides south, toward the smoke.", req: { charAlive: "aldric" } },
        { s: "aldric", t: "*(to his knights, on the forest road)* The Warden gave me my life. I owe him a debt, and the Dawn has shown me how to pay it. We ride for the burning groves.", m: "fervent" },
        { s: "maren", t: "*(in {capital}, reading his message)* He's gone into the Silverwood. Against the Orcs. Without orders. …Corvin, why would he *do* that?", m: "angry", req: { charAlive: "aldric" } },
        { s: "corvin", t: "I think, Majesty, your brother has been carrying something very heavy for a very long time. And someone has just shown him a way to put it down.", m: "sad", req: { charAlive: "aldric" } },
      ],
    },
    ...
    B5: [
      ...
      { s: "aldric", t: "*(to his knights)* The Warden spared my life. This is how I repay it. Nobody passes this path. *Nobody*.", m: "fervent", req: { seen: "mercy" },
      ...
      { s: "skarra", t: "The pretty paladin! Protecting TREES! Skarra thought the Queen said NO!", m: "gleeful" },
      { s: "aldric", t: "The Queen did. *I* didn't.", m: "fervent" },
      ...
      { s: "aelthir", t: "*(kneeling beside him, in the ashes)* He was my blood. He came to repay a debt I never asked of him. …Take him home to his sister. Gently.", m: "sad", req: { alive: "elf" } },
      ...
      { s: "maren", t: "*(standing over her brother)* The Orcs. The Orcs broke faith at the parley, and now they've killed my brother.", m: "angry" },
      { n: "On the Cathedral steps, the priests are already calling him the Martyr of the Dawn. The crowd is chanting for a crusade." },
      { s: "maren", t: "Then they'll have one. Westmarch marches on the Bloodmire. Every knight. Every tower.", m: "resolute" },
      { n: "In the Collegium tower, Corvin listens to the chanting from his window, and closes the shutters." },
      { s: "corvin", t: "*(alone)* Twenty years I argued with that man. I never once let him win. He died saving *elf children*, and I never told him he was braver than me. …I'd give anything to lose one argument to him now.", m: "sad" },
    ...
    B6: [
      ...
      { s: "maren", t: "*(reading)* …He struck first. At the parley. And I've marched a crusade into the Bloodmire in his name.", m: "sad" },
      { s: "corvin", t: "He was trying to put it right, Majesty. The groves, the elf children. I think every sword-stroke in that forest was an apology.", m: "sad" },
      { s: "maren", t: "And I have told all Westmarch the Orcs broke faith. Twice.", m: "sad" },
    ...
    "E-Held": [
      ...
      { s: "maren", t: "“I struck first. The Orcs never broke faith.” …The Lord-Paladin wrote this. He died in a burning grove, saving elf children. He was a liar, and a hero, and my brother. …Write it down. All of it.", m: "sad", req: { charDead: "aldric" },
        alt: { s: "aldric", t: "A sign.", m: "fervent" } },
      { s: "maren", t: "No, brother. It's the land. It was always the land.", m: "sad", req: { charAlive: "aldric" } },
      { s: "aelthir", t: "*(in the Silverwood)* Plant a silver tree on the Cathedral steps. For the paladin who held the path.", m: "wistful", req: { alive: "elf", charDead: "aldric" } },
      { s: "vaelis", t: "*(in the Silverwood)* A mayfly, remembered by the Silverwood. …He was *brief*. He was also, I admit, somewhat in the way of the fire.", m: "aloof", req: { alive: "elf", charDead: "aldric" } },
      { s: "corvin", t: "Every generation must renew the charter, Majesty. Let this be the first thing they read in it.", m: "wry", req: { charDead: "aldric" }, alt: "A renewable Omen. How very *efficient*." },
    ],
    "E-Remains": [
      ...
      { s: "maren", t: "He died saving the Elves. And then I finished them anyway. And the Orcs, for a lie he was trying to take back. …Write it down, Corvin.", m: "sad", req: { charDead: "aldric" },
        alt: { s: "aldric", t: "*(very quietly)* Sister. The parley. I struck first. I have to tell you. Now, when it's too late to matter.", m: "sad" } },
      { s: "corvin", t: "Every Accord begins with someone who won, Majesty. The trick is being the one who *stops*.", m: "sad" }, { s: "maren", t: "Then we stop. I would rather be remembered for that than for any of this.", m: "resolute" },
    ],
    "E-Fallen": [
      ...
      { s: "skarra", t: "*(on the Cathedral steps)* WESTMARCH IS NO MORE! And the tree-folk NEXT! Skarra saved the best for LAST!", m: "gleeful", req: { conqueror: "orc" } },
      { s: "vaelis", t: "*(in the empty Cathedral)* They would not help us. And now there is nobody left to ask. …We shall let the forest have it.", m: "sad", req: { conqueror: "elf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aldric", t: "This is the conjurors' failure. We should have helped the Elves when they asked.", m: "sad" },
