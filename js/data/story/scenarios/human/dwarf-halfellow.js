...
window.GameData.STORY_SCENARIOS["human/dwarf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "corvin", t: "And the first casualty of the war, Majesty, is the *ale tariff*. Karrak's brewers use halfellow barley. Westmarch set the price between them, a hundred years ago." },
      { s: "maren", t: "So the Dwarves and the halfellows will both blame *us* for the price of beer." },
      { s: "aldric", t: "A grave matter, sister. Gravely grave." },
      { s: "corvin", t: "The Lord-Paladin speaks from long personal experience." },
      ...
      { s: "oskar", t: "Entry nine hundred and four: the ale tariff. My only grudge against the halfellows. I've polished it for a century." },
      { s: "hobby", t: "The Dwarves want our barley cheaper, Westmarch wants our bread cheaper, and *nobody* wants to pay the Lord-Paladin's bar tab." },
    ],
    B1: [
      ...
      { s: "aldric", t: "It must be consecrated before a single stone is laid, Majesty. And it must have a tavern. For the *soldiers*." },
      { s: "corvin", t: "For the soldiers. Of course, Lord-Paladin." },
      { s: "maren", t: "Consecrate it. Survey it. Build a brewery, and stop buying ale from people we're fighting. …And write it down." },
    ],
    B2: [
      ...
      { s: "corvin", t: "Over *beer*, Lord-Paladin. I'd keep the hymns short." },
      { s: "maren", t: "The first battle of the war for the Marches, and it was about the price of ale. …Write it down. Someone will laugh at this in a hundred years." },
    ],
    ...
    B3: [
      ...
      { s: "goldie", t: "Before we talk tariffs, Majesty. *Four hundred silver*. Lord-Paladin Aldric Ashcroft. Overdue." },
      { s: "aldric", t: "It is a *tithe*—" },
      { s: "oskar", t: "*(opening the Book)* Entry nine hundred and four, the ale tariff. *Sub-entry*: the Lord-Paladin, for drinking dwarf ale at a halfellow pub and paying neither." },
      { s: "goldie", t: "*(opening her ledger)* He had seven pints of it. On the twelfth of last month. I have it *here*." },
      { s: "corvin", t: "Majesty, I believe this is the first time in history a dwarf and a halfellow have agreed on anything." },
      { s: "maren", t: "Aldric. Pay them. Both of them. From your own purse. …And write it down. This is the only treaty this war is going to get." },
    ],
    ...
    "E-Held": [
      ...
      { s: "oskar", t: "*(in Karrak)* Entry nine hundred and four. Struck through. I've nothing left against the halfellows. I feel quite naked.", req: { alive: "dwarf" } },
      { s: "goldie", t: "*(in the Hearthlands)* And the Lord-Paladin's tab, Majesty?", req: { alive: "halfellow" } },
      { s: "aldric", t: "*(sighing)* …Paid. In full. With interest." },
      { s: "corvin", t: "A renewable Omen, a fair price for beer, and a paid bar tab. How very *efficient*." },
    ],
    "E-Remains": [
      ...
      { s: "corvin", t: "Over the brewers and the bakers. I'd keep the hymns short, Lord-Paladin." },
      { s: "maren", t: "It started with the price of ale. Nobody will laugh at this in a hundred years. …Write it down anyway." },
    ],
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(on the Cathedral steps)* Entry nine hundred and three, the Cathedral debt: collected. Entry nine hundred and four: …the tab. Also collected.", req: { conqueror: "dwarf" } },
      { s: "hobby", t: "*(pinning a note to the Cathedral door)* “Tab: *closed*. — H.T.”", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aldric", t: "This is the conjurors' failure." },
      { s: "corvin", t: "It's the Temple's failure. And, specifically, the Temple's *bar tab*." },
      { s: "maren", t: "Enough. I'm not standing with the Temple, and I'm not standing with the Collegium. I'm standing with *Westmarch*. We'll build roads for the new crown. Roads outlast crowns. …And we'll pay for our own ale." },
    ],
  },
};
