...
window.GameData.STORY_SCENARIOS["human/dwarf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "aldric", t: "Laugh if you like, Archmage. Men who can't afford their bread and beer don't march on the enemy. They march on the palace.", m: "fervent" },
      { s: "corvin", t: "…That is annoyingly astute, Lord-Paladin. I'll pretend I thought of it.", m: "wry" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aldric", t: "This is the conjurors' failure. The Collegium counted coins while the Dawn's knights bled for them.", m: "angry" },
