...
window.GameData.STORY_SCENARIOS["human/elf"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "aldric", t: "*Loud*?!", m: "angry" },
      { s: "corvin", t: "I confess, Lord-Paladin, I've always found it rather loud myself.", m: "wry" },
    ...
    "E-Held": [
      ...
      { s: "aelthir", t: "*(reading it in the Silverwood)* She left the trees alone. Her grandmother would be proud. So am I.", m: "happy", req: { alive: "elf" } },
    ...
    "E-Remains": [
      ...
      { s: "maren", t: "He taught my grandmother to read. He sent a sapling to my coronation. I let it die. …And now this.", m: "sad" },
