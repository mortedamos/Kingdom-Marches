...
window.GameData.STORY_SCENARIOS["human/orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come. Grukka Ironjaw still thinks we betrayed him at the parley." },
      ...
      { s: "skarra", t: "And Skarra hasn't forgotten either, little brother! Skarra NEVER forgets! Skarra keeps her grudges in a JAR!" },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*, and given walls. The Orcs are coming, Lord-Paladin. Hymns don't stop arrows." },
      { s: "maren", t: "Consecrate it at sunrise. Survey it at noon. Wall it by evening. …And write it down." },
    ],
    B2: [
      ...
      { s: "maren", t: "Grukka still thinks this is about the parley." },
      ...
      { s: "skarra", t: "Human blood on the road, little Warchief! The Queen's roads run RED! Ha! HA!" },
      { s: "grukka", t: "Skarra. If you're going to gloat, do it where I can't hear." },
    ],
    B4: [
      ...
      { s: "corvin", t: "The first: I know what the Dawn Omen was. I've taught light spells for thirty years. I'll say nothing. Tonight." },
      { s: "maren", t: "And the second?" },
      { s: "corvin", t: "Your brother hasn't slept in a week. He's been writing letters in the Cathedral, and burning them. I don't know what's in them. I'd very much like to." },
      ...
      { s: "aldric", t: "*(alone)* Dawn give me the courage to tell her. And to tell *them*." },
    ],
    ...
    B5: [
      ...
      { s: "aldric", t: "*(to the empty bog)* Warchief! I have come to parley. Again. And this time, to tell you the truth!" },
      ...
      { s: "skarra", t: "The Queen's brother! Alone! Under a *white flag*! Oh, Skarra doesn't want the truth, pretty paladin. Skarra LIKES the grudge!" },
      ...
      { s: "grukka", t: "*(to Skarra)* Under a white flag. You killed a man under a *white flag*." },
      { s: "skarra", t: "So did he, little brother. Remember? At the parley. Skarra is only *returning the favour*." },
      ...
      { s: "maren", t: "*(standing over her brother)* They killed him under a flag of truce. The Orcs broke faith at the parley, and they've broken it again." },
      { n: "On the Cathedral steps, the priests are already calling him the Martyr of the Dawn. The crowd is chanting for a crusade." },
      { s: "maren", t: "Then they'll have one. Westmarch marches on the Bloodmire. Every knight. Every tower. Every road. …And write it down." },
      { n: "In the Collegium tower, Corvin listens to the chanting from his window, and closes the shutters." },
      { s: "corvin", t: "*(alone)* Twenty years I argued with that man. Every council, every feast. I never once let him win. …I'd give anything to lose one argument to him now." },
    ...
    B6: [
      ...
      { s: "maren", t: "*(reading)* …He struck first. At the parley. He *struck first*." },
      { s: "corvin", t: "He was riding to tell them, Majesty. That's why he went alone. Under a white flag. He was going to confess." },
      { s: "maren", t: "And I have told all Westmarch that the Orcs broke faith. Twice. I have a crusade in the field built on my brother's lie." },
      { s: "corvin", t: "You could tell them. The Temple will call it slander. The crowd will call it treason. And it would be the truth." },
    ...
    "E-Held": [
      ...
      { s: "maren", t: "“I struck first. The Orcs never broke faith. *I* did.” …The Lord-Paladin wrote this. He died trying to deliver it. Westmarch owes the Bloodmire an apology, and I will deliver it myself.", req: { charDead: "aldric" },
        alt: { s: "aldric", t: "A sign." } },
      { s: "maren", t: "No, brother. It's the land. It was always the land.", req: { charAlive: "aldric" } },
      { s: "grukka", t: "*(reading the Queen's letter in the Bloodmire)* …He was coming to tell me. Under a white flag. …Skarra. Get out of my sight.", req: { alive: "orc", charDead: "aldric" } },
      { s: "corvin", t: "Every generation must renew the charter, Majesty. Let this be the first thing they read in it.", req: { charDead: "aldric" },
    ...
    "E-Remains": [
      ...
      { s: "maren", t: "I burned their whole country for a lie my brother told, and died trying to take back. …Write it down, Corvin. Write *all* of it down.", req: { charDead: "aldric" },
    ...
    "E-Fallen": [
      ...
      { s: "corvin", t: "*(tucking them under his arm)* Somebody has to tell the truth, eventually. Even if it's only me.", req: { charDead: "aldric" },
      ...
      { s: "grukka", t: "Next time, Queen, draw second." },
      { s: "skarra", t: "WESTMARCH IS NO MORE! Skarra will wear the Queen's crown as a FROG HAT! Destiny, try it on!" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "corvin", t: "It's the Temple's failure. Hymns don't stop war-bands, *Lord-Paladin*.", req: { charAlive: "aldric" },
      ...
      { s: "maren", t: "Grukka Ironjaw holds the Marches now. Then we'll build roads for him. Roads outlast crowns. …And we owe him an apology. Aldric, you'll deliver it.", req: { charAlive: "aldric" },
        alt: "Grukka Ironjaw holds the Marches now. Then we'll build roads for him. And I'll bring him my brother's letter myself. …Roads outlast crowns. So does the truth." },
    ],
  },
};
