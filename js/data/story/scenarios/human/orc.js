...
window.GameData.STORY_SCENARIOS["human/orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come. Grukka Ironjaw still thinks we betrayed him at the parley.", m: "resolute" },
    ...
    B1: [
      ...
      { s: "maren", t: "Consecrate it at sunrise. Survey it at noon. Wall it by evening.", m: "resolute" },
    ],
    B2: [
      ...
      { s: "maren", t: "Grukka still thinks this is about the parley.", m: "sad" },
    ...
    "E-Remains": [
      ...
      { s: "maren", t: "I burned their whole country for a lie my brother told, and died trying to take back. …Write it down, Corvin. Write *all* of it down.", m: "sad", req: { charDead: "aldric" },
