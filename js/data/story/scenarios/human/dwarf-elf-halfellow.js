...
window.GameData.STORY_SCENARIOS["human/dwarf+elf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "Karrak, the Silverwood, the Hearthlands. Dwarves, Elves, halfellows. No Orcs, no raiders. Just sensible neighbours." },
      { s: "corvin", t: "Sensible neighbours with armies, Majesty." },
      ...
      { s: "brunna", t: "Westmarch owes us for the Cathedral. We'll start there." },
      { s: "hobby", t: "Everyone's being so *reasonable*. Let's have a Moot! All four crowns, one table, and a very large pie." },
      { s: "vaelis", t: "A war between the reasonable. How *exhausting*. Wake me when it becomes interesting." },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. And, Majesty, the halfellows have written. *Again*. About the Moot." },
      { s: "maren", t: "Consecrate it. Survey it. Tell the Mayor… we'll think about it. …And write it down." },
    ],
    B2: [
      ...
      { s: "maren", t: "Sensible neighbours. With armies. You did warn me, Archmage." },
    ],
    ...
    B3: [
      ...
      { s: "corvin", t: "The Dwarves to the halfellows: *Westmarch is building roads toward all of us*. The halfellows to the Elves: *Westmarch has the biggest army in the Marches*. The Elves to the Dwarves, and I quote: *the mayflies are the only danger here*." },
      { s: "aldric", t: "They fear the Dawn's might! As they should!" },
      { s: "corvin", t: "They fear *us*, Lord-Paladin. Not the Dawn. Us. We're the Orcs in this story." },
      { n: "Maren reads the letters twice. Nobody in the chamber speaks." },
      { s: "maren", t: "No Orcs. No villain. Three quiet kingdoms, and every one of them is afraid of Westmarch." },
      { s: "maren", t: "…Write to the Mayor, Corvin. Tell her yes to the Moot. Let them see we can sit at a table." },
      { s: "hobby", t: "*(a week later, in the Hearthlands, reading the reply)* She said *yes*! Goldie! Pie! The biggest pie!" },
      { s: "vaelis", t: "*(in the Silverwood, reading the invitation)* A pie. The Queen of the only dangerous kingdom in the Marches has agreed to a *pie*. …I shall attend. Purely to observe." },
    ],
    ...
    "E-Held": [
      ...
      { s: "aldric", t: "A sign." },
      { s: "maren", t: "No, brother. It's the land. And the land was afraid of us. We'll spend my reign showing it why it needn't be." },
      { n: "The new charter's first clause: every generation must renew it. Its second: *a Moot, every year, at a halfellow table*." },
      { s: "hobby", t: "*(in the Hearthlands)* A Moot! Every year! In *writing*!", req: { alive: "halfellow" } },
      { s: "brunna", t: "*(in Karrak)* A Moot's fine. As long as the Cathedral debt's on the agenda.", req: { alive: "dwarf" } },
      { s: "vaelis", t: "*(in the Silverwood)* Every *year*? …I suppose I shall have to go. Purely to observe.", req: { alive: "elf" } },
      { s: "corvin", t: "A renewable Omen, and an annual pie. How very *efficient*." },
    ],
    "E-Remains": [
      ...
      { s: "corvin", t: "They were afraid of us, Majesty. And they were right." },
      { s: "maren", t: "There were no villains in this war, Corvin. Until we won it. …Write it down." },
    ],
    "E-Fallen": [
      ...
      { s: "corvin", t: "*(tucking it under his arm)* They were afraid of us. Three quiet kingdoms, afraid enough to band together. …We should have listened." },
      { s: "maren", t: "Write it down. Someone… write it down." },
      { s: "brunna", t: "*(on the Cathedral steps)* Karrak stone. Back in Karrak hands. Uncle, write it down: “Westmarch. Worthy foe.”", req: { conqueror: "dwarf" } },
      { s: "vaelis", t: "*(in the empty Cathedral)* The only dangerous kingdom in the Marches. …How *quiet* it is now.", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(pinning a note to the Cathedral door)* “The Moot will still meet. Your chair's still there. — H.T.”", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "corvin", t: "It's the Temple's failure. The Marches were afraid of us, Lord-Paladin, and you kept giving them reasons." },
      { s: "maren", t: "Enough. I'm not standing with the Temple, and I'm not standing with the Collegium. I'm standing with *Westmarch*. We'll build roads for the new crown, and go to every Moot we're invited to. Roads outlast crowns. …And write it down." },
    ],
  },
};
