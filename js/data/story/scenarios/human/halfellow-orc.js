...
window.GameData.STORY_SCENARIOS["human/halfellow+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come for the Hearthlands first. The Bog Witch has hated the halfellows for forty years.", m: "resolute" },
    ...
    B1: [
      ...
      { s: "maren", t: "Consecrate it. Survey it. And fill the granaries.", m: "resolute" },
    ],
    B2: [
