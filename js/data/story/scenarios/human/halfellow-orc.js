/**
 * STORY SCENARIO -- human/halfellow+orc, "The Hearthlands Road"
...
window.GameData.STORY_SCENARIOS["human/halfellow+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "The Orcs will come for the Hearthlands first. The Bog Witch has hated the halfellows for forty years." },
      ...
      { s: "aldric", t: "And the Lord-Paladin's… that is, *my*… account at the halfellows' pub remains in good standing." },
      { s: "corvin", t: "It's four hundred silver overdue, Lord-Paladin." },
      ...
      { s: "skarra", t: "The goose-girl first! Then the Queen! Gnash, are you READY?" },
      { s: "gnash", t: "Is goose there?" },
      { s: "skarra", t: "…Possibly." },
      { s: "gnash", t: "Gnash not ready." },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*, and it must have a road south. If the Orcs burn the Hearthlands, Westmarch starves." },
      { s: "maren", t: "Consecrate it. Survey it. And build the road. …And write it down." },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "corvin", t: "The Orcs will burn the halfellow fields by harvest, Majesty. Then Westmarch starves. So: we can *protect* the Hearthlands, or we can *take* them first." },
      { s: "aldric", t: "The halfellows are our friends, sister. They fed our mother. They fed *me*. Rather a lot." },
      { s: "corvin", t: "Friendship won't stop a Bog Witch, Lord-Paladin. Garrisons will. Ours. In *their* towns." },
      { s: "maren", t: "If we march into the Hearthlands to protect them, the halfellows will call it an invasion. If we don't, Skarra will call it dinner." },
      { n: "A letter arrives from the Hearthlands, in a hurried hand, with a jam stain in one corner." },
      { s: "hobby", t: "*(her letter)* “Majesty. We don't need protecting. We need *geese*. Lots of them. Send any you have. — H.T. P.S. The Lord-Paladin's tab is still open.”" },
      { s: "maren", t: "…Send her geese. As many as we have. …And write it down. I want *everyone* to know." },
    ],
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "*(in the Hearthlands)* Forever! In *writing*! …And the tab?", req: { alive: "halfellow" } },
      { s: "aldric", t: "*(sighing)* …Paid." },
      { s: "grukka", t: "*(in the Bloodmire)* Next time, Queen, I'll draw second. Tell your brother.", req: { alive: "orc", seen: "B6" } },
    ...
    "E-Remains": [
      ...
      { s: "corvin", t: "Over the Orcs, and over the farmers we swore we'd protect. Keep the hymn short, Lord-Paladin." },
      { s: "maren", t: "We were supposed to protect the Hearthlands, Corvin. …Write it down. Every name." },
    ],
    "E-Fallen": [
      ...
      { s: "skarra", t: "*(on the Cathedral steps)* WESTMARCH IS NO MORE! And not ONE goose! Skarra checked!", req: { conqueror: "orc" } },
      { s: "gnash", t: "*(peering into the Cathedral)* …Goose in here?", req: { conqueror: "orc" } },
      { s: "hobby", t: "*(pinning a note to the Cathedral door)* “Tab: *closed*. Thank you for the geese. — H.T.”", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
