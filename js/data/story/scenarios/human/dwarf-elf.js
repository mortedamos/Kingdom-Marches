...
window.GameData.STORY_SCENARIOS["human/dwarf+elf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "corvin", t: "And, Majesty. The Dwarves and the Elves. The Rootcut, the oldest feud in the Marches: dwarf tunnels that killed an elf grove, eight hundred years ago. The Accord was all that kept it quiet." },
      { s: "maren", t: "Then they'll be at each other's throats by midsummer. And we're standing between them." },
      ...
      { s: "oskar", t: "Entry the First. The Elves, for blaming us. We'll be needing a fresh volume." },
      { s: "vaelis", t: "The mud-folk will dig. The mayflies will build. We shall wait. We are very good at waiting." },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. With neither dwarf stone nor elf timber. We don't want to be accused of taking sides." },
      { s: "maren", t: "Consecrate it at sunrise. Survey it at noon. Build it by evening. …And write it down." },
    ],
    B2: [
      ...
      { s: "maren", t: "So much for standing between them. We're in it now." },
    ],
    ...
    B3: [
      ...
      { s: "aldric", t: "A crusade, Majesty! Against *both*! Tunnel-diggers and tree-worshippers, and neither kneels to the Dawn!" },
      { s: "corvin", t: "Or we *sell* to both, Majesty. Steel to the Dwarves, grain to the Elves, and let them pay us to keep fighting." },
      { s: "maren", t: "One of you wants me to be a zealot. The other wants me to be a vulture." },
      { s: "corvin", t: "I prefer *broker*, Majesty." },
      { s: "maren", t: "You would. …Send both envoys home. Westmarch sells nothing that kills, and blesses nothing that burns. We win this *ourselves*. …Write it down." },
      { n: "The dwarf envoy leaves grumbling. The elf envoy leaves without a word. That night, a letter arrives from the Silverwood." },
      { s: "vaelis", t: "*(his letter)* “How principled. The mud-folk will be delighted to hear that Westmarch is neutral. I have already told them you are not.”" },
    ],
    ...
    "E-Held": [
      ...
      { s: "oskar", t: "*(in Karrak)* Closed? *Closed*? …Entry the First. Struck through. By a human. I'll need to lie down.", req: { alive: "dwarf" } },
      { s: "vaelis", t: "*(in the Silverwood)* A mayfly has ended an eight-hundred-year feud with a pen. It will not last. …It may last a little.", req: { alive: "elf" } },
    ...
    "E-Remains": [
      ...
      { s: "maren", t: "We said we'd stand between them. We ended up standing on them. …Write it down." },
    ...
    "E-Fallen": [
      ...
      { s: "vaelis", t: "*(in the empty Cathedral)* Three hundred years of building. We shall let the forest have it back. It will take the forest a *week*.", req: { conqueror: "elf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aldric", t: "This is the conjurors' failure. They'd have sold swords to both sides." },
      { s: "corvin", t: "It's the Temple's failure. You'd have *fought* both sides, Lord-Paladin." },
