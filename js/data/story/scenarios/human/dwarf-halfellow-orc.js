...
window.GameData.STORY_SCENARIOS["human/dwarf+halfellow+orc"] = {
  ...
  beats: {
    ...
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. And walled. Hammer to the north, blade to the south, Majesty. We're the anvil.", m: "wry" },
      { s: "maren", t: "Consecrate it. Survey it. Wall it.", m: "resolute" },
    ],
    B2: [
    ...
    "E-Fallen": [
      ...
      { s: "corvin", t: "*(tucking it under his arm)* The halfellows have the Accord. Somebody should have the rest.", m: "sad" },
