 ...
 * Two kingdoms that never wanted war, and Westmarch needs roads through
...
window.GameData.STORY_SCENARIOS["human/elf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "Our neighbours are the Elves of the Silverwood and the halfellows of the Hearthlands. Neither of them has raised a sword in a hundred years." },
      { s: "corvin", t: "Which leaves only one kingdom in this corner of the Marches that *looks* like a conqueror, Majesty. Ours." },
      ...
      { s: "aelthir", t: "Westmarch will need roads. And roads need land. I had hoped her generation would ask before it took." },
      { s: "vaelis", t: "Mayflies do not ask, great-uncle. They *hurry*." },
      { s: "hobby", t: "Westmarch is coming, and the Elves are the only ones between them and us. Goldie, bake something for the Warden. Something *big*." },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. And, Majesty, it's on land the halfellows have farmed for two hundred years. Someone should tell them." },
      { s: "maren", t: "…Someone should. Consecrate it. Survey it. And send the halfellows *compensation*. …Write it down." },
    ],
    B2: [
      ...
      { s: "corvin", t: "Against people who didn't want to fight, Lord-Paladin. I'd keep the hymns *very* short." },
      { s: "maren", t: "Nobody else in this war started it, Corvin. We did. …Write it down. We should remember that." },
    ],
    ...
    B5: [
      ...
      { s: "aldric", t: "Majesty. The Temple declares this war *holy work*: to bring the Dawn to the godless forest and the heathen fields. And the Temple demands a Dawn Trial, to prove your anointing before we march on." },
      ...
      { s: "corvin", t: "And the Collegium declares: *there is nothing holy about this war*. We are the aggressors. We started it. We are taking land from farmers and trees from the oldest people in the Marches, and if the Queen submits to the Temple's trial, the magi will withdraw her election." },
      ...
      { s: "maren", t: "The Archmage is right. We started this. And the Lord-Paladin is right that we must finish it. I will not stand trial, and I will not be un-elected. I will win this war *quickly*, and then I will pay for it. Every field. Every tree." },
      { s: "maren", t: "Lord-Paladin. Archmage. Council chamber. Both of you. *Now*. …And write it down." },
    ...
    "E-Held": [
      ...
      { s: "aldric", t: "A sign." },
      { s: "maren", t: "No, brother. It's the land. And we took it from people who didn't want to fight. We'll spend my whole reign paying for it." },
      ...
      { s: "hobby", t: "*(in the Hearthlands)* Reparations! In *writing*! Goldie, frame it.", req: { alive: "halfellow" } },
      { s: "aelthir", t: "*(in the Silverwood)* She asked forgiveness. Late. But she asked. Her grandmother would have too.", req: { alive: "elf" } },
      { s: "corvin", t: "A renewable Omen, and an apology. How very *efficient*." },
    ],
    "E-Remains": [
      ...
      { s: "corvin", t: "Over two peoples who never wanted to fight us. Proclaim it quietly, Lord-Paladin." },
      { s: "maren", t: "We were the conquerors, Corvin. The only ones. …Write it down. And never let anyone call it holy." },
    ],
    "E-Fallen": [
      ...
      { s: "corvin", t: "*(tucking it under his arm)* We started it, Majesty. The gentle ones finished it. There's a justice in that I don't enjoy." },
      { s: "maren", t: "Write it down. Someone… write it down." },
      { s: "aelthir", t: "*(on the Cathedral steps)* Leave the Cathedral standing. Leave the library's ashes. They will want to remember.", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(pinning a note to the Cathedral door)* “You started it. We finished it. Supper's at six. — H.T.”", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "aldric", t: "This is the conjurors' failure. They sapped the army's faith." },
      { s: "corvin", t: "It's the Temple's failure. You called an invasion *holy*, Lord-Paladin. The land didn't agree." },
      { s: "maren", t: "Enough. I'm not standing with the Temple, and I'm not standing with the Collegium. I'm standing with *Westmarch*. We'll build roads for the new crown, and pay for every field we took. Roads outlast crowns. …And write it down." },
    ],
  },
};
