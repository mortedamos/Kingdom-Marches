...
window.GameData.STORY_SCENARIOS["human/halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "maren", t: "And the Hearthlands grow half the bread in our cities. If the halfellows choose to hold on to it, Westmarch goes hungry. …Write it down." },
      ...
      { s: "corvin", t: "*(opening it)* A bill. From The Goose & Kettle, the halfellows' oldest pub. “Lord-Paladin Aldric Ashcroft: four hundred silver. *Overdue*.”" },
      ...
      { s: "hobby", t: "Westmarch will want our granaries. Let them *ask*. Nicely. With the four hundred silver." },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. And it needs its own fields. We can't keep buying bread from people we're at war with." },
      { s: "maren", t: "Consecrate it. Survey it. And plant wheat. …And write it down." },
    ],
    B2: [
      ...
      { s: "corvin", t: "Against *bakers*, Lord-Paladin. I'd keep the hymns short." },
      { s: "maren", t: "Three hundred years they fed us. And our first battle was over *bread*." },
      { s: "hobby", t: "*(in the Hearthlands)* First blood. Over a bread cart. I'm not grinning, Goldie. Not this time." },
    ],
    ...
    B3: [
      ...
      { s: "corvin", t: "The halfellows have made it a condition of *any* truce, Majesty. The tab first. Then we can talk about granaries." },
      { s: "aldric", t: "The Temple will not pay a pub! It is beneath the dignity of the Dawn!" },
      { s: "corvin", t: "And the Collegium will not pay it on *principle*. I didn't drink it." },
      { s: "maren", t: "So Westmarch goes to war with its own granary because my brother likes *halfellow ale*." },
      { s: "aldric", t: "…It is very good ale, sister." },
      { s: "maren", t: "Pay it, Aldric. From your own purse. And then we'll talk about granaries. …Write it down. *Especially* this." },
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "*(reading it in the Hearthlands)* Three hundred years. And they finally said it. In *writing*.", req: { alive: "halfellow" } },
      { s: "corvin", t: "A renewable Omen, and a thank-you note. How very *efficient*." },
    ],
    "E-Remains": [
      ...
      { s: "corvin", t: "Over the people who fed us. I'd keep that proclamation short, Lord-Paladin." },
      { s: "maren", t: "Three hundred years of bread. And we never said thank you. …Write it down. Put it first." },
    ...
    "E-Fallen": [
      ...
      { s: "hobby", t: "*(the paper)* “Tab: *closed*. — H.T.”" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "corvin", t: "It's the Temple's failure. We lost the Marches over a *bar tab*, Lord-Paladin." },
      ...
      { s: "maren", t: "The halfellows hold the Marches now. Then we'll build roads to their markets. Roads outlast crowns. …And, Aldric. Say *thank you* for the bread. In person." },
    ],
  },
};
