...
window.GameData.STORY_SCENARIOS["human/dwarf+elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "corvin", t: "And every old war in the Marches wakes up with it, Majesty. The Rootcut, between the Dwarves and the Elves. The Mountain Wars, between the Dwarves and the Orcs. And our own: the Last Parley.", m: "wry" },
      ...
      { s: "maren", t: "Three old wars. And I wasn't there for any of them. I'm the youngest crown in the Marches.", m: "sad" },
      { s: "aldric", t: "*(a moment too quickly)* The parley was the Orcs' doing, Majesty. The Dawn knows the truth.", m: "sad" },
      ...
      { s: "oskar", t: "Volume One, the Elves. Volume Seven, the Orcs. Volume Twelve, Westmarch. I'll need a bigger desk.", m: "grudging" },
      { s: "vaelis", t: "Three old wars, and one young Queen. I believe I shall write some letters.", m: "aloof" },
      { s: "skarra", t: "ALL the wars! At ONCE! Skarra doesn't know where to START!", m: "gleeful" },
    ],
    B1: [
      ...
      { s: "corvin", t: "It must be *surveyed*. Preferably somewhere none of the three old wars has ever been fought. I'm struggling to find one.", m: "wry" },
      { s: "maren", t: "Consecrate it. Survey it. Build it. Then find me the three old battlefields. I want a garrison on each before the old wars wake up.", m: "resolute" },
    ],
    B2: [
    ...
    B4: [
      ...
      { s: "corvin", t: "The first: I know what the Dawn Omen was. I'll say nothing. Tonight.", m: "sad" },
      { s: "maren", t: "And the second?" },
      { s: "corvin", t: "Your brother has been writing letters in the Cathedral every night, and burning them. And someone in the Silverwood has been writing letters too. To everyone. I've seen the seals: silver leaves.", m: "sad" },
      { n: "In the Cathedral, Aldric kneels before the great eastern window, a half-written page on the floor beside him." },
      { s: "aldric", t: "*(alone)* The old parley ground. At dawn. Under a white flag. Dawn give me the courage to tell her. To tell *them*.", m: "sad" },
    ],
    ...
    B5: [
      ...
      { s: "aldric", t: "*(to the empty reeds)* Warchief! I have come to parley. Again. And this time, to tell you the truth!", m: "fervent" },
      ...
      { s: "skarra", t: "*(waving a letter sealed with silver leaves)* A little bird told Skarra the pretty paladin was coming! A little *silver* bird! Skarra doesn't want the truth, paladin. Skarra LIKES the grudge!", m: "gleeful" },
      ...
      { s: "grukka", t: "*(to Skarra)* Under a white flag. On the *parley stone*. …Who told you he was coming?", m: "angry" },
      { s: "skarra", t: "A friend, little brother! Skarra has LOTS of friends now!", m: "gleeful" },
      ...
      { s: "maren", t: "*(standing over her brother)* On the parley stone. Under a white flag. The Orcs broke faith at the parley, and they've broken it again.", m: "angry" },
      ...
      { s: "corvin", t: "*(alone, in the tower)* Twenty years I argued with that man. I never once let him win. …And now the Temple has a saint, the crowd has a crusade, and reason won't get a word in for a generation.", m: "sad" },
      { s: "vaelis", t: "*(in the Silverwood, sealing another letter)* One old war, restarted. Two to go.", m: "aloof", req: { alive: "elf" } },
    ],
    ...
    B6: [
      ...
      { s: "maren", t: "*(reading the letter)* He struck first. At the parley. And he died going to confess it.", m: "sad" },
      { s: "corvin", t: "And someone in the Silverwood told the Bog Witch exactly where he'd be, Majesty. Your brother was killed by a lie, a grudge and a letter. Only the lie was his, and he died trying to take it back.", m: "angry" },
      { s: "maren", t: "And I have marched a crusade into the Bloodmire in his name. Exactly as Vaelis wanted.", m: "angry" },
      { n: "Maren stands at the window for a long time. Below, the crowd is still chanting her brother's name." },
      { s: "maren", t: "Not yet. Not in the middle of a war. …But write it down, Corvin. Every word. The letter, and the seal. When this is over, I'll read both aloud on the Cathedral steps.", m: "resolute" },
    ],
    ...
    "E-Held": [
      ...
      { s: "maren", t: "“I struck first.” …My brother wrote this. He died carrying it to the Orcs, betrayed by the Silverwood's heir. Westmarch owes the Bloodmire an apology. And Lord Vaelis owes *me* one.", m: "resolute", req: { charDead: "aldric" },
        alt: { s: "aldric", t: "A sign.", m: "fervent" } },
      { s: "maren", t: "No, brother. It's the land. It was always the land.", m: "sad", req: { charAlive: "aldric" } },
      { s: "vaelis", t: "*(in the Silverwood)* I merely wrote a letter. The Bog Witch did the rest. …I shall not be apologising.", m: "aloof", req: { alive: "elf", charDead: "aldric" } },
      { s: "aelthir", t: "*(in the Silverwood, very quietly)* Yes, Vaelis. You will. In person. To his sister.", m: "angry", req: { alive: "elf", charDead: "aldric" } },
    ...
    "E-Remains": [
      ...
      { s: "maren", t: "I was the youngest crown in the Marches, Corvin. The only one who wasn't there for any of the old wars. And I finished all three.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(on the Cathedral steps)* Volume Twelve, Westmarch. Closed. …I'll not need the bigger desk after all.", m: "grudging", req: { conqueror: "dwarf" } },
      { s: "vaelis", t: "*(in the empty Cathedral)* Three old wars, and the youngest crown lost all of them. …I did warn her. By letter.", m: "aloof", req: { conqueror: "elf" } },
