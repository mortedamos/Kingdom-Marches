...
window.GameData.STORY_SCENARIOS["human/dwarf+elf+orc"] = {
  ...
  beats: {
    ...
    B1: [
      ...
      { s: "maren", t: "Consecrate it. Survey it. Build it.", m: "resolute" },
    ],
    B2: [
    ...
    B6: [
      ...
      { s: "corvin", t: "And someone in the Silverwood told the Bog Witch exactly where he'd be, Majesty. Your brother was killed by a lie, a grudge and a letter. Only one of them was his.", m: "angry" },
