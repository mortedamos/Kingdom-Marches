...
window.GameData.STORY_SCENARIOS["dwarf/elf+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "kazra", t: "And the Underways, Brunna. The old tunnels beneath the Marches. The split cracked their seals. Every one of them is open again.", m: "focused" },
      { s: "brunna", t: "Then Karrak can be anywhere in the Marches by morning. And so can anyone who finds a door.", m: "proud" },
      ...
      { s: "vaelis", t: "Dwarves, Humans and Orcs. Three quarrels to tend. I shall be *so* busy.", m: "aloof" },
      { s: "grukka", t: "The dwarves' doors are open. Doors break. Open ones break easier.", m: "defiant" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. And a guard on every Underway door within a day's walk of it.", m: "proud" },
    ...
    B2: [
      ...
      { s: "oskar", t: "First blood. Entry {grudge} in the Book of Grudges.", m: "grudging" },
      ...
      { s: "brunna", t: "Three enemies, and a hundred open doors. Walls first, Uncle. And locks.", m: "proud" },
    ],
    B3: [
      ...
      { s: "oskar", t: "Somebody's using the bog-door, Thane. A dwarf. And a *wolf*.", m: "grudging" },
      { s: "brunna", t: "Orc scouts. Double the guard.", m: "angry" },
    ...
    B5: [
      ...
      { s: "brunna", t: "*Sigrun*.", m: "angry" },
      { s: "sigrun", t: "Mother— his name is Varg. Since the Midsummer Fair. He isn't what they say—", m: "sad" },
      ...
      { s: "skarra", t: "The Warchief's son and the Thane's girl! TOGETHER! And the Thane HERSELF! Oh, the ancestors are *generous* tonight!", m: "gleeful" },
      { s: "brunna", t: "Behind me. *Both* of you.", m: "angry" },
      ...
      { s: "varg", t: "She saved us. Both of us. My aunt did this. My *family* did this. I'm sorry. I'm so sorry.", m: "sad" },
      ...
      { s: "kazra", t: "I knew. I forged the locks on those doors. I knew, and I didn't tell her. I lost a brother to this feud, and now I've lost a wife.", m: "sad" },
      ...
      { s: "sigrun", t: "Let him go, Uncle. He carried her home. Karrak doesn't punish the ones who carry us home.", m: "fierce" },
    ],
    B6: [
      ...
      { s: "oskar", t: "The Orcs killed your mother, Thane. The clan-moot wants Volume Seven *finished*.", m: "grudging" },
      { s: "sigrun", t: "The *Bog Witch* killed my mother, Uncle. And the Warchief's son carried her home. I'll finish Skarra. I won't finish *him*.", m: "fierce" },
      { s: "kazra", t: "That's not a Thane's answer.", m: "angry" },
      { s: "sigrun", t: "It's *my* answer, Mother Kazra. It'll have to be a Thane's now.", m: "fierce" },
    ],
    ...
    "E-Remains": [
      { n: "The Dwarves have won by destroying every rival. The forest, the river cities and the bog are silent." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Every book closed, Thane.", m: "sad" },
      { s: "sigrun", t: "Every book, Uncle. Even the one I didn't want closed.", m: "sad", req: { charDead: "brunna" }, alt: { s: "brunna", t: "Start a new book anyway.", m: "sad" } },
    ...
    "E-Fallen": [
      ...
      { s: "sigrun", t: "Then I'll hold the wall. Where she would have.", m: "fierce", req: { charDead: "brunna" }, alt: { s: "brunna", t: "Stone remembers, Kazra.", m: "sad" } },
      { n: "The Underways seal from within, one door at a time. The mountain goes dark." },
      { s: "skarra", t: "The Thane AND the mountain! Skarra has had a VERY good war!", m: "gleeful", req: { conqueror: "orc" } },
      { s: "varg", t: "*(at the bog-door)* Moss knows the way. There's no one at the end of it anymore.", m: "sad", req: { alive: "orc" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "sigrun", t: "Write it as a debt, Uncle. Mother would have.", req: { charDead: "brunna" }, alt: { s: "brunna", t: "Write it as a debt, Uncle. Not a grudge.", m: "proud" } },
