...
window.GameData.STORY_SCENARIOS["dwarf/halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "kazra", t: "The Marchstone's split, Brunna. The Accord's gone.", m: "sad" },
      ...
      { s: "oskar", t: "The closing clause stands, Thane: the Marches pass to the crown that *holds* them, or failing that, the crown that *remains*. And, Thane… with the Accord gone, so is the ale tariff.", m: "grudging" },
      { s: "brunna", t: "…The *ale tariff*?", m: "angry" },
      { s: "oskar", t: "A century of paying the halfellows through the nose for barley. Frozen by the Accord. It's the only halfellow entry in the whole Book. Entry nine hundred and four. I've underlined it forty times.", m: "grudging" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. Stone foundations, a proper cellar. A *very* proper cellar.", m: "proud" },
      { s: "oskar", t: "The clan-moot wants to know if the cellar is for defence or for ale, Thane." },
      { s: "brunna", t: "Yes.", m: "happy" },
      { n: "In the Hearthlands, a halfellow pedlar brings Hobby a sketch of the new dwarf hold." },
      { s: "hobby", t: "Look at the size of that cellar, Goldie. They're planning to *brew their own*. The cheek.", m: "angry" },
    ],
    B2: [
      ...
      { s: "oskar", t: "Entry nine hundred and four, amended: the barley, *and* the fields it grew in.", m: "grudging" },
      ...
      { s: "sigrun", t: "Mother Kazra, you can't march a *Titan* at *halfellows*. It'd step on them by accident.", m: "happy" },
      ...
      { s: "goldie", t: "You still could, love. After.", m: "happy" },
    ],
    B3: [
      ...
      { s: "oskar", t: "Entry nine hundred and four, Thane. It's grown. It's now eleven pages long. I've had to start *sub-entries*.", m: "grudging" },
      { s: "brunna", t: "Read me the worst one." },
      { s: "oskar", t: "Nine hundred and four, part K: “The halfellow Mayor sent a goose into our supply train. The goose was *wearing a hat*.”", m: "angry" },
      { s: "sigrun", t: "*(trying very hard not to laugh)* …Was it a nice hat?", m: "happy" },
      { s: "oskar", t: "That is *not the point*, child.", m: "angry" },
      { s: "brunna", t: "Hobby Trickgrin. She always did fight like a festival.", m: "happy" },
    ],
    B6: [
      { n: "Night, on the walls of {capital}. Brunna and Kazra share the last barrel of halfellow ale left in Karrak." },
      { s: "brunna", t: "When this is done, I'm going to sit down with Hobby Trickgrin and settle that tariff over a proper drink.", m: "happy", alt: { s: "sigrun", t: "When this is done, I'm going to sit down with Hobby Trickgrin and settle that tariff. Mother always meant to.", m: "happy" } },
      { s: "kazra", t: "You'll lose.", m: "happy" },
      { s: "brunna", t: "I'll lose *slowly*. That's the dwarf way.", m: "proud", alt: { s: "sigrun", t: "I'll lose *loudly*. That's *my* way.", m: "fierce" } },
    ],
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "Nothing. Zero. No tariff at all. In exchange for one barrel a month, delivered to The Goose & Kettle, forever.", m: "scheming", req: { alive: "halfellow" } },
      { s: "brunna", t: "…Done.", m: "happy", req: { alive: "halfellow" }, alt: { s: "sigrun", t: "…Done. Mother would've haggled. I'm thirsty.", m: "happy", req: { alive: "halfellow" } } },
      { s: "oskar", t: "Entry nine hundred and four, all eleven pages. *Struck out*. …And the goose's hat. Struck out as well. It was a very nice hat.", m: "happy" },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying the Halfellows. The Hearthlands are empty." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Entry nine hundred and four, Thane. The tariff. There's no one left to pay it, or to be paid.", m: "sad" },
      { n: "Sigrun sits on the walls of {capital} with her axe-guitar across her knees, and doesn't play a note." },
      { s: "sigrun", t: "No more pies. No more ale. No more geese in hats. Was the barley worth it, Uncle?", m: "sad" },
      { s: "oskar", t: "*(closing the Book)* No, child. It never is.", m: "sad" },
    ],
    "E-Fallen": [
      ...
      { s: "oskar", t: "Unlocked, Thane. Not broken. Unlocked. They didn't even have the decency to *siege* us.", m: "angry" },
      { s: "brunna", t: "Stone remembers, Kazra. Even when it loses to a goose.", m: "sad", alt: { s: "sigrun", t: "Stone remembers, Mother Kazra. Even when it loses to a goose.", m: "sad" } },
      { n: "The halfellow Mayor walks into the Thane's Hall alone, with two tankards." },
      { s: "hobby", t: "No hard feelings, dear. Well. A few hard feelings. Drink?", m: "happy" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "brunna", t: "Beaten by barley. Write it down, Uncle. As a debt, not a grudge.", m: "sad", alt: { s: "sigrun", t: "Beaten by barley. Write it as a debt, Uncle.", m: "sad" } },
      { s: "oskar", t: "A debt to the halfellows. Payable in…?", m: "grudging" },
      ...
      { s: "kazra", t: "Payable in *attendance*, it seems.", m: "happy" },
    ],
  },
};
