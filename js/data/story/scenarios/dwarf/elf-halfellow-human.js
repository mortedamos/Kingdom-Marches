...
window.GameData.STORY_SCENARIOS["dwarf/elf+halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "kazra", t: "The Deep is shaking. Worse than the stone. Something under the Marches is moving." },
      { s: "brunna", t: "Then we're the only ones who'll hear it. Everyone else lives on top." },
      { s: "oskar", t: "Three surface kingdoms, Thane. The Elves' forest. The halfellows' meadows. Westmarch's river roads. They see the Marches. We see what's *under* them." },
      { n: "In the Silverwood, Lord Vaelis, heir to the Warden, reads a report of dwarf surveyors in the hills." },
      { s: "vaelis", t: "The mud-folk will dig. They always dig. Let them. We have three kingdoms to play against each other, and they have only rocks." },
      ...
      { s: "maren", t: "Everyone wants something from the Marches. The Dwarves want what's underneath them. …Write that down, Corvin. It worries me." },
      { s: "hobby", t: "The Dwarves never look up, dear. That's how you win against them. You stand on their roof." },
      { s: "brunna", t: "*(in Karrak)* Walls first. And somebody keep an eye on the roof." },
    ],
    B1: [
      ...
      { s: "kazra", t: "I'll go down myself." },
      { s: "oskar", t: "Entry {grudge} in the Book of Grudges, pre-emptively: whatever's down there." },
    ],
    B2: [
      ...
      { s: "oskar", t: "First blood with the surface. Entry {grudge} in the Book of Grudges." },
      ...
      { s: "brunna", t: "Three kingdoms up there, and every one of them thinks the ground is just something to stand on." },
    ],
    B3: [
      ...
      { s: "kazra", t: "Roots, Brunna. Stone roots. The same black granite as the Marchstone, running under half the Marches. Like veins." },
      { s: "oskar", t: "The Marchstone… has *roots*?" },
      { s: "kazra", t: "The Marchstone *is* roots. The bit on top is just the part you can see." },
      { s: "brunna", t: "Then I need to read what's carved on it. At the stone itself. Uncle, pack your quills." },
    ],
    B4: [
      ...
      { s: "oskar", t: "Move it, and it dies. Leave it, and it holds. *Held*, Thane. That's what the clause means. Not taken. *Held*." },
    ...
    B5: [
      ...
      { s: "brunna", t: "Uncle. Kazra. Take the rune-rubbings and *run*. That's an order." },
      { s: "kazra", t: "Brunna—" },
      { s: "brunna", t: "Karrak needs what's on those pages more than it needs me. Walls first, love. Today *I'm* the wall." },
      ...
      { s: "oskar", t: "She bought us every word on these pages. Entry {grudge} in the Book of Grudges: *the surface*. All of it." },
      ...
      { s: "sigrun", t: "She told me once that a Thane stands on her own walls. I didn't know she meant *this*." },
      { s: "kazra", t: "Stand up, Thane. Read what she died for. Then make them pay for it." },
    ],
    B6: [
      { n: "Night, in the Thane's Hall of {capital}. High Thane Sigrun Stonefast has read the rune-rubbings through three times." },
      { s: "sigrun", t: "It says the stone is held by whoever keeps the Marches. Not owns. *Keeps*. Mother died for a sentence about gardening, Uncle." },
      { s: "oskar", t: "She died for Karrak, Thane. The sentence was just where she was standing." },
      { s: "sigrun", t: "Then Karrak keeps the Marches. All of it. The surface can look up at us for a change." },
      { s: "kazra", t: "*(quietly)* She'd have said that. Louder, but she'd have said it." },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "sigrun", t: "Held, Mother. Not owned. Held. You were right.", req: { charDead: "brunna" }, alt: { s: "brunna", t: "Held. Not owned. Uncle, put the rune-rubbings in the deepest vault." } },
      { s: "oskar", t: "Entry the First: struck out. The ale tariff: struck out. The Cathedral debt: struck out. Three in one day." },
      { s: "kazra", t: "The Deep's stopped shaking." },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying every surface kingdom. Only Karrak remains." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Nobody left on the surface, Thane. Nobody left to look up at us." },
      { s: "sigrun", t: "Then we'll have to go up there ourselves. Mother always hated the sun.", req: { charDead: "brunna" }, alt: { s: "brunna", t: "Start a new book anyway, Uncle. For what we owe." } },
      { s: "kazra", t: "The Deep's quiet. Too quiet." },
    ],
    "E-Fallen": [
      ...
      { s: "oskar", t: "The rune-rubbings go to the deepest vault. With the Book. For whoever comes after." },
      { n: "The Underways seal from within. The mountain goes dark." },
      { s: "vaelis", t: "*(in the ruins)* They sealed themselves in with their precious runes. How very *them*.", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(in the ruins)* Leave a barrel at the door, Goldie. For when they come back out.", req: { conqueror: "halfellow" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "sigrun", t: "Somebody on the surface holds it now. Send them the rune-rubbings, Uncle. They'll need them. They don't know what's underneath.", req: { charDead: "brunna" },
        alt: { s: "brunna", t: "Send them the rune-rubbings, Uncle. They don't know what's underneath." } },
    ],
  },
};
