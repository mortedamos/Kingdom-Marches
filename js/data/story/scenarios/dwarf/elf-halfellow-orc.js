...
window.GameData.STORY_SCENARIOS["dwarf/elf+halfellow+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "oskar", t: "Entry the First: the Rootcut, against the Elves. Entry nine hundred and four: the ale tariff, against the halfellows. Volume Seven: the Mountain Wars, against the Orcs. Every one of them is on our border." },
      { s: "brunna", t: "Which do we settle first, Uncle?" },
      { s: "oskar", t: "That's the only question I've never had to answer. The Book was always for *remembering*, Thane. Not for *choosing*." },
      ...
      { s: "vaelis", t: "Dwarves, Orcs and halfellows, and not one human to break the tedium. How very *rural*." },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. Walls toward the forest, the meadows *and* the bog." },
      { s: "kazra", t: "That's three walls, love." },
      { s: "brunna", t: "Walls first. Three times." },
    ],
    B2: [
      ...
      { s: "oskar", t: "Entry the First, reopened.", req: { firstBlood: "elf" } },
      { s: "oskar", t: "Entry nine hundred and four, reopened. With *violence*.", req: { firstBlood: "halfellow" } },
      { s: "oskar", t: "Volume Seven, reopened.", req: { firstBlood: "orc" } },
      ...
      { s: "brunna", t: "One grudge settled at a time, Uncle. Or none at all." },
    ],
    B3: [
      ...
      { s: "oskar", t: "Thane, a word. About Sigrun. The noise, and then the silence. Always on nights the Underways are open." },
      { s: "brunna", t: "She's young, Uncle." },
      { s: "oskar", t: "I've a page here with no name at the top. I don't want to write the name I think goes there." },
      { n: "Kazra quietly takes the candle and snuffs it." },
      { s: "kazra", t: "Then don't, Oskar. Not tonight." },
    ],
    B6: [
      ...
      { s: "oskar", t: "I've decided which grudge to settle first, Thane." },
      ...
      { s: "oskar", t: "Some grudges aren't worth keeping, child. I'm old. I'm allowed to change my mind *once*." },
      { s: "sigrun", t: "…Uncle Oskar." },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "oskar", t: "Entry the First: struck out. Nine hundred and four: struck out. Volume Seven: crossed out. The Book's never been this *light*." },
      ...
      { s: "vaelis", t: "*(by letter)* “The Silverwood notes that it has not been invited. The Silverwood is *relieved*.”", req: { alive: "elf" } },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying every rival. The forest, the meadows and the bog are all silent." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Every grudge settled, Thane. The Book is finished. There's no one left in it who can read." },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "The Book goes to the deepest vault. Every grudge unsettled. Someone will have to finish it." },
      { n: "The Underways seal from within. The mountain goes dark." },
      { s: "skarra", t: "Sealed in their holes! Skarra LOVES it when they do the work themselves!", req: { conqueror: "orc" } },
      { s: "vaelis", t: "The Rootcut, avenged. I feel nothing. How disappointing.", req: { conqueror: "elf" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "brunna", t: "Write it as a debt, Uncle. Not a grudge. We've had enough grudges for one lifetime." },
      { s: "oskar", t: "For *several* lifetimes, Thane." },
    ],
  },
};
