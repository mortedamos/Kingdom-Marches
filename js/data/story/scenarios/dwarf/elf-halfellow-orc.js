...
window.GameData.STORY_SCENARIOS["dwarf/elf+halfellow+orc"] = {
  ...
  beats: {
    ...
    "E-Held": [
      ...
      { s: "grukka", t: "I heard there was singing. The whole bog heard it.", m: "happy", req: { alive: "orc" } },
    ...
    "E-Remains": [
      ...
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Every grudge settled, Thane. The Book is finished. Everyone written in it is gone. There's no one left to read their names to.", m: "sad" },
