...
window.GameData.STORY_SCENARIOS["dwarf/elf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "brunna", t: "Then Karrak holds. We cut that stone. We lent it for a peace. The peace is over, and I'll have our Heartstone back.", m: "proud" },
      ...
      { s: "oskar", t: "Entry the First in the Book of Grudges: *the Rootcut*. A grove of the Elves' elder trees died above our tunnels, and they blamed the whole of Karrak for it. They never once let us prove otherwise.", m: "grudging" },
      ...
      { s: "aelthir", t: "Karrak will march. I remember the Rootcut, Vaelis. I stood in that dying grove.", m: "wistful" },
      ...
      { s: "sigrun", t: "Elves! Finally, someone worth writing a war-song about.", m: "fierce" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. Stone foundations, a proper cellar, and good thick walls. Nowhere near a tree.", m: "proud" },
      { s: "oskar", t: "The clan-moot asks whether *nowhere near a tree* is policy, Thane." },
      { s: "brunna", t: "It is now.", m: "proud" },
      { n: "Far to the west, an elf scout in the treetops watches the masons at work and sends word to the Silverwood." },
      { s: "vaelis", t: "They are digging again. Of course they are. It is the only thing they know how to do.", m: "aloof" },
    ],
    B2: [
      { n: "The forest's edge, at dawn. Dwarf and elf warriors have clashed for the first time since the Accord." },
      { s: "oskar", t: "First blood with the Silverwood. I'll add it under Entry the First. It's a *long* entry now.", m: "grudging" },
      ...
      { s: "vaelis", t: "The mud-folk fight the way they dig: slowly, loudly, and in the dark.", m: "aloof" },
      { s: "ysolde", t: "The oaks at the eastern edge would like to walk against them, my son.", m: "uncanny" },
      { s: "vaelis", t: "Let them walk, mother. I shall watch from somewhere clean.", m: "aloof" },
    ],
    B3: [
      ...
      { s: "oskar", t: "I don't know yet. But it wasn't us. Eight hundred years, and it *wasn't us*.", m: "angry" },
      { s: "sigrun", t: "Then tell them! March up to the Heartwood and read it to them!", m: "fierce" },
      { s: "brunna", t: "Proof first, daughter. Then walls. Then we'll see who needs telling.", m: "proud" },
    ],
    B4: [
      { n: "At the heart of the Marches, Oskar kneels beside the split Marchstone, tracing the deep runes carved into its base." },
      { s: "oskar", t: "The stone is *rooted*, Thane. Its veins run under half the Marches. Move it, and it dies.", m: "sad" },
      ...
      { s: "oskar", t: "Eight hundred years. It was the *stone*.", m: "sad" },
      ...
      { s: "vaelis", t: "How thorough. Do tell your Thane we are not interested in being *right*, herald. We are interested in being rid of you.", m: "aloof" },
      { s: "aelthir", t: "*(quietly, after the herald has gone)* …I stood in that grove, Vaelis. It never felt like dwarves.", m: "wistful" },
    ],
    B6: [
    ...
    "E-Remains": [
      ...
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Entry the First, Thane. The Rootcut. There's no one left to prove it to.", m: "sad" },
      { s: "brunna", t: "Strike it out anyway.", m: "proud", alt: { s: "sigrun", t: "Strike it out anyway, Uncle.", m: "sad" } },
      { s: "oskar", t: "I can't. It isn't settled. It's just *over*. Those aren't the same thing.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "One last entry in the Book of Grudges. Then it goes to the deepest vault, for whoever comes after.", m: "sad" },
      ...
      { s: "vaelis", t: "Thirty-seven. I am *flattered*.", m: "aloof" },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "brunna", t: "The Silverwood holds the Marches. Write it as a debt, Uncle, not a grudge. We'll pay it back.", m: "proud", alt: { s: "sigrun", t: "The Silverwood holds the Marches. Write it as a debt, Uncle. We'll pay it back. Loudly." } },
      { s: "oskar", t: "And Entry the First?" },
      { s: "brunna", t: "Send the rune-proof to the Warden. Every year. Until he reads it.", m: "proud", alt: { s: "sigrun", t: "Send the rune-proof to the Warden. Every year. Until he reads it.", m: "fierce" } },
    ],
  },
};
