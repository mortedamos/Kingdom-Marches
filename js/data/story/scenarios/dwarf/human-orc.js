 ...
 * The Orcs raid the Human wagon trains that carry dwarf goods. Brunna ends up
 * defending a debtor's wagons for her own profit, and hates it; Sigrun uses
...
window.GameData.STORY_SCENARIOS["dwarf/human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "oskar", t: "Every ingot we sell goes west in Westmarch's wagons, Thane. The Humans owe us for their Dawn Cathedral. And the Orcs raid those wagons for sport.", m: "grudging" },
      { s: "brunna", t: "So our debtor's wagons carry our iron past our oldest enemy. Wonderful.", m: "angry" },
      ...
      { s: "maren", t: "We'll pay in gold and in Collegium ward-work, not land. Write back and tell them.", m: "resolute" },
      ...
      { s: "grukka", t: "Human wagons. Dwarf iron. Two enemies, one ambush. The clans eat well this winter.", m: "defiant" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. And our own road out of it. We'll not trust our iron to Westmarch's.", m: "proud" },
      { s: "oskar", t: "Our own road will run past the same bog, Thane." },
      { s: "brunna", t: "Then it'll have *walls*.", m: "proud" },
    ],
    B2: [
      ...
      { s: "oskar", t: "Volume Seven, reopened.", m: "grudging", req: { firstBlood: "orc" }, alt: "Entry {grudge} in the Book of Grudges: Westmarch. Debt *and* violence." },
      ...
      { s: "brunna", t: "We're guarding a debtor's caravans against our oldest enemy. For *profit*. I hate every part of this.", m: "angry", req: { firstBlood: "orc" } },
      { s: "skarra", t: "*(in the Bloodmire)* Dwarf iron AND human wagons! Skarra loves a two-for-one! Ha! HA!", m: "gleeful", req: { firstBlood: "orc" } },
    ],
    B3: [
      ...
      { s: "oskar", t: "Thane. Sigrun's been riding out with the caravan guards. Always the night runs. Always past the bog.", m: "sad" },
      { s: "brunna", t: "She's guarding the iron, Uncle. Good girl.", m: "proud" },
      { s: "oskar", t: "She comes back without a scratch, Thane. From the most-raided road in the Marches. Every time.", m: "grudging" },
    ...
    B6: [
      ...
      { s: "sigrun", t: "He's worth not killing, Mother. And he's never once raided a caravan I was guarding. Not once.", m: "sad" },
      { s: "brunna", t: "…So that's why the night runs came home safe.", m: "sad" },
      { s: "brunna", t: "Tell the boy he's the best caravan guard Karrak ever had. And that he's *never* getting paid.", m: "happy" },
    ],
    ...
    "E-Remains": [
      ...
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Debt closed. Volume Seven closed. The road runs nowhere now, Thane.", m: "sad" },
    ...
    "E-Eclipsed": [
      ...
      { s: "brunna", t: "…Let him in. Walls first. Then we talk wages.", m: "happy", req: { winner: "orc" } },
    ],
  },
};
