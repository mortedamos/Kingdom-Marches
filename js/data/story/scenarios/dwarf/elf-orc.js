...
window.GameData.STORY_SCENARIOS["dwarf/elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "brunna", t: "Then Karrak holds. I'll have our Heartstone back." },
      { n: "Oskar opens the Book of Grudges in two places at once, a thumb in each." },
      { s: "oskar", t: "Entry the First: the Rootcut, against the Elves of the Silverwood. And Volume Seven: the Mountain Wars, against the Orcs of the Bloodmire. Both open. Both at once. I'll need more ink." },
      { n: "In the Silverwood, the Warden Aelthir Moonveil feels the stone split. His heir, Lord Vaelis Nightbloom, smiles thinly." },
      { s: "vaelis", t: "Dwarves and Orcs, both at our borders. How fortunate that they hate each other more than they hate us." },
      ...
      { s: "skarra", t: "Dwarves in the mountains! Elves in the trees! And the elf-witch Ysolde in her precious spring! Skarra has so MANY curses to spend!" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. Walls toward the forest, walls toward the bog. Walls both ways." },
      { s: "oskar", t: "The clan-moot asks which way is *first*, Thane." },
      { s: "brunna", t: "Both, Uncle. Walls first. Both ways first." },
    ],
    B2: [
      ...
      { s: "oskar", t: "Entry the First, reopened.", req: { firstBlood: "elf" }, alt: "Volume Seven, reopened." },
      ...
      { s: "vaelis", t: "*(in the Silverwood)* The mud-folk have come to argue about a grove. We shall answer them with arrows.", req: { firstBlood: "elf" } },
    ...
    B3: [
      ...
      { s: "oskar", t: "Thane, a word. About Sigrun. For weeks now: the noise, and then the silence. And the silence is always on nights the Underways are open." },
      { s: "brunna", t: "She's young, Uncle. Young dwarves go quiet." },
      { s: "kazra", t: "*(too quickly)* She is. They do." },
      { n: "In the Silverwood, an elf scout has returned from the bog-edge with a strange report. Lord Vaelis reads it twice." },
      { s: "vaelis", t: "The Thane's daughter. And the Warchief's *son*. In the tunnels, at midnight. Oh, this is *exquisite*." },
      { s: "ysolde", t: "What will you do with it, my son?" },
      { s: "vaelis", t: "Nothing, mother. Yet. A secret is like wine. It improves with *waiting*." },
    ],
    B6: [
      ...
      { s: "brunna", t: "The elf heir sent me a letter today. He knows. He says if I don't pull back from the forest, he'll tell the Warchief *everything*, and let his son pay for it." },
      { s: "sigrun", t: "…Mother." },
      { s: "brunna", t: "I burned it, daughter. Karrak doesn't bargain with blackmailers. And I'll not have Vaelis Nightbloom decide who my daughter loves." },
      { s: "kazra", t: "*(from the stair)* Thirty years, and she can still surprise me." },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "oskar", t: "Entry the First: struck out. Volume Seven, last page: *crossed out*. Two grudges, one night. I need to sit down." },
      ...
      { s: "vaelis", t: "*(by letter)* “The Silverwood notes that a dwarf and an orc are now attending the same *feasts*. It declines to comment further.”", req: { alive: "elf" } },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying the Elves and the Orcs. The forest is silent. The bog is empty." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Both volumes closed, Thane. No one left to write about." },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "Sealed in their own holes! Skarra LOVES it when they do the work themselves! Ha! HA!", req: { conqueror: "orc" } },
      { s: "varg", t: "*(alone, at the bog-edge)* Moss knows the way. There's no one at the end of it anymore.", req: { conqueror: "orc" } },
      { s: "vaelis", t: "The mud-folk, sealed in. The Rootcut avenged. I feel nothing. How disappointing.", req: { conqueror: "elf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
