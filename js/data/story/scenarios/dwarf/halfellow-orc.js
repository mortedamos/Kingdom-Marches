...
window.GameData.STORY_SCENARIOS["dwarf/halfellow+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "oskar", t: "The Bloodmire Clans, the Orcs, will want our breweries. They've wanted them since the Mountain Wars. And the halfellows' barley fields lie right between us.", m: "grudging" },
      ...
      { s: "skarra", t: "Dwarf ale and halfellow barley! And the halfellow Mayor who ruined Skarra's raid forty years ago with a *goose*! Skarra will have ALL of it!", m: "gleeful" },
      ...
      { s: "hobby", t: "Skarra Ironjaw, back for another go. Goldie, is the goose's hat still in the attic?", m: "scheming" },
      { s: "goldie", t: "You promised me no more geese, Hobby Trickgrin.", m: "stern" },
    ...
    B1: [
      ...
      { s: "brunna", t: "A second hold. Walls first. Then the brewery. *Inside* the walls.", m: "proud" },
      { s: "kazra", t: "Put a Runewall round the brewery and the orcs'll never get near the ale.", m: "happy" },
      { s: "sigrun", t: "Put a Runewall round the brewery and *I'll* never get near the ale.", m: "sad" },
    ],
    B2: [
      ...
      { s: "oskar", t: "Volume Seven, reopened.", m: "grudging", req: { firstBlood: "orc" }, alt: "Entry nine hundred and four, the ale tariff. Reopened, with *violence*." },
    ...
    B3: [
      ...
      { s: "goldie", t: "*(her letter)* “Thane, forgive me for writing. A traveller in my pub says your daughter has been seen at night near the bog-edge, with an orc Wolf Rider. I thought a mother should know. Gently, Goldie.”", m: "sad" },
      { s: "brunna", t: "*(crumpling it)* Halfellow gossip. Sigrun would never.", m: "angry" },
      { s: "oskar", t: "Thane. The noise, and then the silence. For weeks.", m: "sad" },
      { s: "brunna", t: "*Never*, Uncle.", m: "angry" },
    ...
    B6: [
      ...
      { s: "brunna", t: "The halfellow was right. Goldie Trickgrin wrote to me weeks ago. I didn't believe her.", m: "sad" },
      { s: "sigrun", t: "Is he worth it, you're going to ask.", m: "sad" },
      { s: "brunna", t: "No. I'm going to ask if *you* are all right. Then I'm going to write Goldie an apology. Then I'll ask the other thing.", m: "sad" },
      { s: "sigrun", t: "…He's worth not killing, Mother. That's all.", m: "sad" },
      { s: "brunna", t: "Tell the boy to keep his wolf off my brewery.", m: "happy" },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "oskar", t: "The ale tariff: struck out. Volume Seven, the orc volume: crossed out. And the goose's hat…", m: "happy" },
      { s: "hobby", t: "*(arriving with a barrel)* …stays in the attic, where Goldie can keep an eye on it.", m: "happy", req: { alive: "halfellow" } },
      ...
      { s: "grukka", t: "I heard there was singing. And ale.", m: "happy", req: { alive: "orc" } },
      { s: "brunna", t: "Stay by the door, Warchief. I'll bring you a tankard.", m: "happy", req: { alive: "orc" } },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying the Orcs and the Halfellows. The bog is empty. The meadows are empty." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Volume Seven closed. The tariff closed. There's no one left to sell us barley or steal our ale.", m: "sad" },
      { s: "brunna", t: "Start a new book anyway, Uncle.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "The BREWERY is Skarra's! Destiny, my frog, fetch a tankard! No, a BUCKET!", m: "gleeful", req: { conqueror: "orc" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "brunna", t: "Well? Let him in. He's brought the ale.", m: "happy", req: { winner: "orc" } },
    ],
  },
};
