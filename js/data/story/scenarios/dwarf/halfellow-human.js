...
window.GameData.STORY_SCENARIOS["dwarf/halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "oskar", t: "Our two best customers stand in the way, Thane. The halfellows sell us barley. Westmarch, the Humans, owes us for their Cathedral. Half our treasury walks in through those two doors." },
      { s: "kazra", t: "Then we're about to find out how much of a war you can fight on credit." },
      ...
      { s: "goldie", t: "The Dwarves buy our barley, Hobby. The Humans buy our bread. And the Lord-Paladin of Westmarch owes this pub a fortune." },
      { s: "hobby", t: "Then this war will be won with *prices*, dear. And a little plan." },
      ...
      { s: "aldric", t: "It is a *tithe*, Majesty. For the pub's spiritual wellbeing." },
      { s: "corvin", t: "It is four hundred silver, Lord-Paladin. The pub's spirit is *very* well, thank you." },
    ],
    B1: [
      ...
      { s: "brunna", t: "A second hold. A market hall in the middle, so we can sell to whoever's still talking to us." },
      { s: "oskar", t: "The halfellows have raised the price of barley, Thane. Westmarch has stopped paying the Cathedral instalments." },
      { s: "brunna", t: "Then we'll brew with *mushrooms* if we have to." },
      { s: "sigrun", t: "Mother, *no*." },
    ],
    B2: [
      ...
      { s: "oskar", t: "First blood. Entry {grudge} in the Book of Grudges. And I've started a *ledger*, too. The Book isn't built for prices." },
      ...
      { s: "hobby", t: "*(in the Hearthlands)* First blood with the Dwarves. Goldie, raise the price of barley. Again.", req: { firstBlood: "halfellow" } },
    ...
    B3: [
      ...
      { s: "oskar", t: "Thane. The Lord-Paladin of Westmarch owes the halfellows four hundred silver. In *ale*. And he's been paying the interest with Cathedral funds. *Our* Cathedral funds." },
      { s: "sigrun", t: "He's drinking our debt? He's *drinking our debt*?" },
      { s: "brunna", t: "Send a copy to the halfellow Mayor. And one to the Queen of Westmarch. Let them sort out their own bar tab." },
      { n: "A week later, word comes back: the Queen and the Mayor have both frozen the Lord-Paladin's accounts." },
      { s: "oskar", t: "Entry {grudge} in the Book of Grudges: *satisfying*. I'm allowed one of those a century." },
    ],
    B6: [
      { n: "Night, on the walls of {capital}. Brunna and Oskar look out at two kingdoms that used to be customers." },
      { s: "brunna", t: "When this is over, Uncle, somebody has to buy our iron and sell us barley. It might as well be them.", alt: { s: "sigrun", t: "When this is over, Uncle, somebody still has to sell us barley. It might as well be them." } },
      { s: "oskar", t: "Then don't burn the market hall, Thane." },
      { s: "brunna", t: "Walls first, Uncle. Market second. Everything else after.", alt: { s: "sigrun", t: "Walls first. Market second. Music third." } },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "*(at the market's opening)* No tariff, Thane? None at all? …Goldie, pinch me.", req: { alive: "halfellow" } },
      { s: "maren", t: "*(by letter)* “The Cathedral debt, repaid in full. And the Lord-Paladin's bar tab, repaid in full, out of his own pocket. …And write it down.”", req: { alive: "human" } },
      { s: "oskar", t: "Two debts paid in one day. Entry {grudge} in the Book of Grudges: *struck out*. I'm keeping the ledger, though. Just in case." },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying the Halfellows and Westmarch. The market hall stands empty." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "No one to sell to. No one to buy from. No one to owe us anything. The ledger's balanced, Thane. It's also blank." },
      { s: "kazra", t: "Stone endures. It doesn't trade much." },
    ],
    "E-Fallen": [
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "brunna", t: "Well. We'll just have to sell them more iron. Write it as a debt, Uncle.", alt: { s: "sigrun", t: "Then we'll sell them more iron. Write it as a debt, Uncle." } },
      { s: "oskar", t: "In the ledger, Thane. Not the Book." },
    ],
  },
};
