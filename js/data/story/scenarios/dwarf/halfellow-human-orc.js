...
window.GameData.STORY_SCENARIOS["dwarf/halfellow+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "Barley's gone up, Goldie. War prices, dear.", m: "scheming" },
    ...
    B6: [
      ...
      { s: "sigrun", t: "And?" },
      { s: "brunna", t: "I got it wrong. The thing Karrak can't live without is *you* trusting it. Is he worth it?", m: "sad" },
