...
window.GameData.STORY_SCENARIOS["dwarf/elf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "brunna", t: "Then Karrak holds. We cut that stone from under this mountain. I'll have our Heartstone back." },
      { s: "oskar", t: "Two neighbours stand in the way. The Elves' forest to the west. The halfellows' meadows to the south." },
      { s: "kazra", t: "Soft ground, both of them. Roots and barley. Nothing you can build a proper wall on." },
      ...
      { s: "vaelis", t: "The mud-folk to the east. The Trickgrin woman to the south. Two nuisances, great-uncle. I have been waiting forty years to deal with *her*." },
      { n: "In the Hearthlands, home of the halfellows, Mayor Hobby Trickgrin is late for three meetings, and grinning." },
      { s: "hobby", t: "Dwarves on one side, Elves on the other, and us in the middle with all the barley. Goldie, I have a little plan." },
      { s: "goldie", t: "Does it involve a goose?" },
      { s: "hobby", t: "Only *mostly*." },
    ],
    B1: [
      ...
      { s: "brunna", t: "Stone foundations. A proper cellar. And not a single blade of grass inside the walls." },
    ...
    B2: [
      ...
      { s: "oskar", t: "First blood. Entry {grudge} in the Book of Grudges. The first of many, I expect." },
      ...
      { s: "vaelis", t: "*(in the Silverwood)* The mud-folk fight like they dig. Slowly, and in the dark.", req: { firstBlood: "elf" } },
    ...
    B3: [
      ...
      { s: "oskar", t: "The halfellow Mayor pranked the elf heir. In the middle of a war. With *geese*." },
      { s: "sigrun", t: "Put it in the Book, Uncle! Put it in the Book!" },
      { s: "oskar", t: "It's not *our* grudge, child." },
      { n: "He opens the Book anyway, and writes a small note in the margin." },
      { s: "oskar", t: "“The halfellows' conduct toward the Silverwood: *adequate*.” …That's the highest praise the Book has ever given anyone." },
    ],
    B6: [
      { n: "Night, on the walls of {capital}. Brunna looks out over forest to the west and meadow to the south." },
      { s: "brunna", t: "Soft ground, all of it. Roots and barley. And they've held against us longer than I thought they could.", alt: { s: "sigrun", t: "Soft ground, all of it. And they've held against us longer than Mother thought they could." } },
      { s: "kazra", t: "Soft ground holds, love. It just holds *differently*." },
      { s: "brunna", t: "Then let's see which kind holds longest.", alt: { s: "sigrun", t: "Then let's see which kind holds longest." } },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "oskar", t: "Entry the First, the Rootcut. And entry nine hundred and four, the ale tariff. Both struck out. Two in one day. I may need to lie down." },
      { s: "hobby", t: "*(arriving uninvited with a barrel)* Congratulations, Thane! I brought the ale. Lord Vaelis sends his regards. He doesn't know he does.", req: { alive: "halfellow" } },
      { s: "vaelis", t: "*(by letter)* “The Silverwood acknowledges the mud-folk's stones. It does not acknowledge the geese.”", req: { alive: "elf" } },
    ],
    "E-Remains": [
      { n: "The Dwarves have won by destroying the Elves and the Halfellows. The forest is silent and the meadows are empty." },
      { s: "stone", t: "REMAINS." },
      { s: "oskar", t: "Two grudges settled, Thane. The Rootcut and the tariff. There's no one left to prove anything to, or to buy barley from." },
    ...
    "E-Fallen": [
      ...
      { s: "vaelis", t: "The mud-folk, sealed in their own holes. How tidy.", req: { conqueror: "elf" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "brunna", t: "Soft ground won. Write it as a debt, Uncle.", alt: { s: "sigrun", t: "Soft ground won. Write it as a debt, Uncle." } },
      { s: "oskar", t: "And the geese?" },
      { s: "brunna", t: "The geese, Uncle, can stay a grudge.", alt: { s: "sigrun", t: "The geese can stay a grudge." } },
    ],
  },
};
