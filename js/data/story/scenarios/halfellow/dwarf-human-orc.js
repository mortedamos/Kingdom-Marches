...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "barnaby", t: "The Marchstone has split! The closing clause: the Marches pass to the crown that *holds* them, or failing that, the crown that *remains*. See footnote one. And two. And, Hobby, *all* of them." },
      { s: "hobby", t: "Dwarves, Humans and Orcs, Uncle. I haven't *time* for footnotes." },
      { s: "barnaby", t: "You never have. That's why I write them." },
      ...
      { s: "brunna", t: "The halfellows will fold to whoever reaches them first. Make sure it's us." },
      { s: "maren", t: "The Hearthlands are our granary. Nobody else touches them. …Write it down." },
      { s: "skarra", t: "The goose-girl's pub! Skarra wants the goose-girl's PUB!" },
      { s: "goldie", t: "*(folding her arms)* Well. She can't have it." },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Uncle, where should the walls go?" },
      { s: "barnaby", t: "*(unrolling a map)* Footnote nine. Where the Accord surveyors put the boundary stones, three hundred years ago. They picked the high ground." },
      { s: "hobby", t: "…Footnote nine. Right. I'll read the others. Eventually." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. Three kingdoms, and we're the supper." },
    ...
    B3: [
      ...
      { s: "barnaby", t: "Footnote forty. The Accord surveyors mapped the Underways, the old dwarf tunnels. Every one of them. Including the ones that run *under the Bloodmire*, and the ones that come up *behind Westmarch's walls*." },
      { s: "hobby", t: "Uncle. Does *anybody* else have this map?" },
      { s: "barnaby", t: "The Dwarves had one. They lost it in a flood. It's in their Book of Grudges: *the flood, for taking the map*." },
      { s: "hobby", t: "*(finally grinning)* Uncle Barnaby. I am going to read every single one of your footnotes." },
      { s: "barnaby", t: "…I'd like that in writing." },
    ...
    B5: [
      ...
      { s: "goldie", t: "*(to Hobby, low)* The Dwarf Thane's daughter and the Orc Warchief's son. They came up Barnaby's disused tunnel last night. They're in *love*, Hobby, and every army out there would kill them for it.", req: { notSeen: "lovers:meet" },
        alt: { s: "goldie", t: "*(to Hobby, low)* Our two lovebirds came up Barnaby's disused tunnel last night. Every army out there would kill them for it." } },
      { fx: { seen: "lovers:meet" } },
      { s: "hobby", t: "Then the safest place in the Marches is a pub cellar in a town with its gates shut. Nobody searches the *frightened* for runaways." },
      { s: "barnaby", t: "Footnote forty-one, Hobby. That tunnel runs *out* as well as in." },
      ...
      { s: "skarra", t: "*(at the Speaking Stones)* Skarra's Wisps saw them go INTO the goose-girl's town! And they never came OUT! Where ARE they?!" },
      { s: "goldie", t: "*(clearing the plates)* More pie, anyone?" },
    ],
    ...
    "E-Held": [
      ...
      { s: "maren", t: "We came to take your granaries, Mayor. You fed us instead. …Write it down.", req: { alive: "human" } },
      { s: "goldie", t: "Supper's at six! And Hobby, *you're* on time for once." },
      { s: "barnaby", t: "Footnote one hundred and thirteen: *she was on time*." },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. We read every footnote, Goldie. We just never found the one that said *stop*." },
    ],
    "E-Fallen": [
      ...
      { s: "barnaby", t: "Footnote forty-one, Hobby. It runs out as well as in." },
      { s: "goldie", t: "*(locking the pub door)* We'll be back. Somebody has to collect the tabs." },
      { s: "skarra", t: "*(in the ruins)* The goose-girl, GONE! Down a HOLE! Like the lovers! Like EVERYONE!", req: { conqueror: "orc" } },
      { s: "maren", t: "*(in the empty pub)* There's a supper laid upstairs. Still warm. …Write it down.", req: { conqueror: "human" } },
      { s: "brunna", t: "*(in the empty cellar)* That's one of *our* tunnels. …Oskar, strike that. We lost the map. Fair's fair.", req: { conqueror: "dwarf" }, alt: { s: "sigrun", t: "*(in the empty cellar)* That's one of our tunnels. I know it well.", req: { conqueror: "dwarf" } } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. Uncle, there must be a footnote for this." },
      { s: "barnaby", t: "Footnote eighty. *Crowns come and go*. I wrote it years ago. For you." },
    ],
  },
};
