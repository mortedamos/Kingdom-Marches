...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+human"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "barnaby", t: "Westmarch owes the Dwarves nothing. The Dwarves owe *us* a receipt, a hundred years overdue. And Westmarch owes us a hundred years of *thank you*.", m: "happy" },
      { s: "goldie", t: "Hobby. We're the only ones in this war who aren't in debt.", m: "happy" },
      { s: "hobby", t: "Then we're the only ones who owe nobody anything, dear. In a war about debts, that's the strongest hand at the table.", m: "scheming" },
    ],
    B6: [
      ...
      { s: "goldie", t: "The Moot can wait. One more scheme, and then you're done. And then you send *both* of them a copy of clause twenty-two.", m: "stern" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "They'll still argue about who owes whom, and we'll still have the receipts. Uncle, send them clause twenty-two.", m: "happy" },
