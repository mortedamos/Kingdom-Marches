...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "barnaby", t: "The Marchstone has split! And, Hobby, the only complete copy of the Accord in the Marches is in *my Archive*. Every crown will want to read it." },
      { s: "hobby", t: "The closing clause, Uncle?" },
      { s: "barnaby", t: "The Marches pass to the crown that *holds* them, or failing that, the crown that *remains*. And a great deal of fine print about *who owes whom*." },
      ...
      { s: "brunna", t: "Westmarch owes Karrak. The halfellows hold the barley. And the Accord says who owes what. I want that Archive." },
      { s: "maren", t: "The halfellows' Archive will prove we owe the Dwarves nothing. I want that Archive. …Write it down." },
      { s: "hobby", t: "Everyone wants your scrolls, Uncle." },
      { s: "barnaby", t: "They may *look*. Nobody breathes on them." },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! And, Uncle, make a copy of the Accord. Several copies. Hide them in every cellar in the Hearthlands." },
      { s: "barnaby", t: "*Copies*? Of the *original*?" },
      { s: "hobby", t: "If everyone has one, Uncle, nobody can steal the only one." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. Over debts that aren't even *ours*." },
    ...
    B3: [
      ...
      { s: "barnaby", t: "Mayor. Clause twenty-two. The Cathedral debt Westmarch owes the Dwarves? It was paid for in *halfellow grain*, a hundred years ago. It's in the ledger. Nobody wrote it down on the Dwarf side." },
      { s: "hobby", t: "So Westmarch doesn't owe the Dwarves at all?" },
      { s: "barnaby", t: "Westmarch owes the Dwarves nothing. The Dwarves owe *us* a hundred years of receipts. And Westmarch owes us a hundred years of *thank you*." },
      { s: "goldie", t: "Hobby. We're the only ones in this war who aren't in debt." },
      { s: "hobby", t: "Then we're the only ones who can afford to lose it. Which means, dear, we're the only ones who can afford to *win* it." },
    ],
    B6: [
      ...
      { s: "goldie", t: "The Moot can wait. Whatever you're planning next, it's the last one. And then you send *both* of them a copy of clause twenty-two." },
      { s: "hobby", t: "…The last one. And both of them. With footnotes." },
    ],
    ...
    "E-Held": [
      ...
      { s: "brunna", t: "*(reading)* …Paid. A century ago. In *grain*. Uncle, I owe the Queen of Westmarch an apology.", req: { alive: ["dwarf", "human"] } },
      { s: "maren", t: "And we owe the halfellows three hundred years of thank-yous. …Write it down. All of them.", req: { alive: ["dwarf", "human"] } },
      { s: "barnaby", t: "I told you nobody ever reads the fine print, Hobby." },
    ],
    "E-Remains": [
      { n: "The Halfellows have won by destroying the Dwarves and Westmarch. The mountains and the river cities are silent." },
      { s: "stone", t: "REMAINS." },
      { s: "barnaby", t: "Clause twenty-two, Hobby. The debt was paid. Neither of them ever read it." },
      { n: "That night, the halfellows light a great bonfire on the hill above {capital}. It is not a celebration." },
      { s: "hobby", t: "They fought over a debt that didn't exist, Uncle. And we let them." },
    ],
    "E-Fallen": [
      ...
      { s: "barnaby", t: "I have the Accord. And the copies are in every cellar in the Hearthlands. They'll never find them all." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. Uncle, send them clause twenty-two." },
      { s: "barnaby", t: "With footnotes?" },
      { s: "hobby", t: "With *all* the footnotes." },
    ],
  },
};
