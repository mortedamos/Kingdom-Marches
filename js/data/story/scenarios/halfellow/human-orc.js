...
window.GameData.STORY_SCENARIOS["halfellow/human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "The Orcs want our farms. Westmarch *needs* our farms. And we're the ones standing in them.", m: "scheming" },
      { s: "goldie", t: "The whole Marches is coming to my kitchen, love. And none of them have booked.", m: "stern" },
      ...
      { s: "skarra", t: "The goose-girl's larder! Skarra will eat her pies and burn her pub, and the humans can STARVE!", m: "gleeful" },
      { s: "gnash", t: "Gnash like pie.", m: "happy" },
      { n: "In Westmarch, the Human kingdom, Queen Maren Ashcroft reads the same news with her Archmage, Corvin Varro." },
      { s: "maren", t: "If the Orcs take the Hearthlands, Westmarch starves. So we must take them first. For their protection.", m: "resolute" },
      { s: "corvin", t: "Majesty, I'm not sure the halfellows will see it as *protection*.", m: "wry" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Big granary, please. With a *very* good lock.", m: "happy" },
      { s: "goldie", t: "And a kitchen. Every town needs a kitchen.", m: "stern" },
      { s: "hobby", t: "Goldie, we're at war.", m: "scheming" },
      { s: "goldie", t: "*Especially* at war, love.", m: "stern" },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. Over *food*. Everyone's fighting over food, and we're the ones who grow it.", m: "sad" },
    ...
    B5: [
      ...
      { n: "The Goose & Kettle's cellar is the biggest larder in town. The soldiers break the door. Somebody knocks over a lantern. Nobody means for it to happen, and that makes no difference at all.", req: { conqueror: "human" },
        alt: { s: "skarra", t: "The goose-girl's KITCHEN! Take the pies! Burn the rest!", m: "gleeful" } },
      ...
      { s: "goldie", t: "Out! All of you! Out the back, and don't you *dare* come back for the barrels!", m: "angry" },
    ...
    B6: [
      ...
      { s: "barnaby", t: "Sit. Eat. She'd have insisted.", m: "sad" },
      { s: "hobby", t: "I've a war to finish, Uncle.", m: "angry" },
      { s: "barnaby", t: "You've a war to *end*, Hobby. Those aren't the same thing. She'd have told you that too.", m: "sad" },
      { n: "Hobby sits. She eats the whole bowl without complaint, which is how Barnaby knows how bad it is." },
      { s: "barnaby", t: "I heard a rumour today. At the market. About… something. I've forgotten what. I'm very bad at this, Hobby.", m: "flustered" },
      { s: "hobby", t: "*(almost smiling)* You are, Uncle. You're *terrible* at it.", m: "happy" },
      { s: "hobby", t: "One last trick. For her. And then I'm done.", m: "scheming" },
    ],
    ...
    "E-Held": [
      ...
      { s: "maren", t: "*(at the bar)* Mayor. We came to your kitchen as if it were ours. I'm sorry.", m: "sad", req: { alive: "human" } },
      { s: "hobby", t: "Supper's at six, everyone. It always was. She'd want you on time.", m: "sad", req: { charDead: "goldie" }, alt: { s: "goldie", t: "Supper's at six! And Hobby, *you're* on time for once.", m: "happy" } },
      { s: "barnaby", t: "Everyone's fed, Hobby. That's how she'd have scored it.", m: "sad" },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "It's done, Goldie. All of it. There's no one left to come to the kitchen.", m: "sad", req: { charDead: "goldie" }, alt: { s: "goldie", t: "No more tricks, Hobby.", m: "sad" } },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "*(in the ruins)* The goose-girl's larder, EMPTY! Where are the PIES?!", m: "angry", req: { conqueror: "orc" } },
      { s: "gnash", t: "*(sadly)* No pie.", m: "sad", req: { conqueror: "orc" } },
      { s: "maren", t: "*(in the empty granary)* We came to protect their food. There's no one left to grow it.", m: "sad", req: { conqueror: "human" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
