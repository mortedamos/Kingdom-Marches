...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+elf"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "hobby", t: "That's the trick, Uncle. Leave early.", m: "scheming" },
    ],
    B6: [
      ...
      { s: "goldie", t: "I know. And it worked. Now it's your turn. Whatever you're planning next, it's the last one.", m: "stern" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. Set the big table. Both of them are invited.", m: "happy" },
