...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+elf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "barnaby", t: "And, Hobby, the Dwarves and the Elves. The Rootcut feud. Eight hundred years of it, and the Accord was the only thing keeping it quiet.", m: "flustered" },
      { s: "hobby", t: "The Dwarves on one side, the Elves on the other, and us in the middle with all the barley. Wonderful.", m: "scheming" },
      { s: "goldie", t: "They'll both want our bread, love. And they'll both want us to say *they're* in the right.", m: "stern" },
      { s: "hobby", t: "Then we'll feed them both, and agree with neither. That's a little plan.", m: "scheming" },
      ...
      { s: "vaelis", t: "The mud-folk to the east, the Trickgrin woman in the middle. How *convenient*.", m: "aloof" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Build a big table in the square, everyone. Big enough for a dwarf *and* an elf.", m: "happy" },
      { s: "barnaby", t: "They'll never sit at it, Hobby.", m: "flustered" },
      { s: "hobby", t: "No, Uncle. But they'll *know it's there*.", m: "scheming" },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. And we didn't even start the feud.", m: "sad" },
    ...
    B3: [
      ...
      { s: "brunna", t: "*(eyeing the elves)* I'll not eat at a table with the people who blamed Karrak for the Rootcut.", m: "angry" },
      { s: "vaelis", t: "*(eyeing the dwarves)* I shall not eat at *any* table. I am here to observe.", m: "aloof" },
      { s: "aelthir", t: "The soup is very good, Mayor.", m: "happy" },
      { s: "hobby", t: "Thank you, Warden. Lovely to see you. I've a Moot. Must dash.", m: "scheming" },
      ...
      { s: "barnaby", t: "They ate it, Hobby. All of it. Both of them.", m: "happy" },
      { s: "hobby", t: "That's the trick, Uncle. Leave early, and they've nobody left to argue with but each other.", m: "scheming" },
    ],
    B6: [
      ...
      { s: "goldie", t: "Sit. Eat. And stay for the *whole* meal this time.", m: "stern" },
      { s: "hobby", t: "Goldie, I left them alone at the table on *purpose*.", m: "scheming" },
      { s: "goldie", t: "I know. And it worked. Now it's your turn to stay put. One more plan, and that's the end of them.", m: "stern" },
      { s: "hobby", t: "…The last one. And then the biggest supper the Marches have ever seen.", m: "happy" },
    ],
    ...
    "E-Held": [
      ...
      { s: "goldie", t: "Supper's at six, everyone! Hobby, *you're* on time for once.", m: "happy" },
      { s: "hobby", t: "Only because I *live* here, dear.", m: "happy" },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. We were supposed to feed them both, Goldie. Not *this*.", m: "sad" },
    ],
    "E-Fallen": [
      ...
      { s: "vaelis", t: "*(in the empty square)* A table. Set for two enemies. How very *her*.", m: "sad", req: { conqueror: "elf" } },
      { s: "brunna", t: "*(in the empty square)* She left supper out. For *us*. …Don't touch it, anyone.", m: "sad", req: { conqueror: "dwarf" }, alt: { s: "sigrun", t: "*(in the empty square)* She left supper out. For *us*.", m: "sad", req: { conqueror: "dwarf" } } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Whoever holds the Marches, they still have to eat. Set the big table. Both of them are invited.", m: "happy" },
