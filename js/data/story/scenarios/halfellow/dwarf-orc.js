...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "And our neighbours are the Dwarves of Karrak and the Orcs of the Bloodmire. Who have hated each other for five hundred years." },
      { s: "goldie", t: "A pub hears everything, love. And I've heard a *lot* about those two lately. Travellers talk." },
      { s: "hobby", t: "What sort of a lot?" },
      { s: "goldie", t: "The sort I'm not telling you until I'm *sure*." },
      ...
      { s: "skarra", t: "Dwarves in their mountain, the goose-girl in her meadows! And Skarra's Wisps see EVERYTHING that happens in between!" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Plenty of cellars, please. Deep ones. With back doors." },
      { s: "barnaby", t: "Why back doors, Hobby?" },
      { s: "hobby", t: "Everyone needs a back door, Uncle. You never know who'll need to use it." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. I'd hoped they'd be too busy fighting each other." },
    ...
    B5: [
      ...
      { s: "goldie", t: "I'm sure now, love. The rumour I wouldn't tell you. The Dwarf Thane's daughter and the Orc Warchief's son. They're in *love*. They've been meeting in the old tunnels.", req: { notSeen: "lovers:meet" } },
      { fx: { seen: "lovers:meet" } },
      { s: "hobby", t: "Skarra's Wisps are hunting them, Goldie. The Thane's daughter and the Warchief's son. She wants the secret, so she can use it to take her brother's throne." },
      { s: "goldie", t: "And you're going to *hide* them. From a Bog Witch. With *cellars*." },
      { s: "hobby", t: "Wisps can't see underground, dear. And halfellows have been hiding things in cellars since before there *was* an Accord." },
      { s: "barnaby", t: "Hobby. If either mother finds out we hid them, we'll have both Karrak and the Bloodmire at our door." },
      { s: "hobby", t: "Then they'd best not find out, Uncle." },
      ...
      { s: "skarra", t: "*(in the Bloodmire)* WHERE ARE THEY? Skarra's Wisps see EVERYTHING! Everything except… *cellars*. …The GOOSE-GIRL!" },
      { n: "Back in The Goose & Kettle, Hobby grins for the first time in weeks. Goldie and Barnaby do not." },
      { s: "goldie", t: "You're enjoying this far too much, love." },
      { s: "hobby", t: "I know, dear. That's what frightens me." },
    ],
    B6: [
      ...
      { s: "goldie", t: "Sit. *All* of you. You too, dear. And get that wolf off my good rug." },
      ...
      { s: "hobby", t: "The last scheme, Goldie. I promise. Once they're safe, it's done." },
      { s: "goldie", t: "Then *eat*, all three of you. Love and war are both terrible on an empty stomach." },
    ],
    ...
    "E-Held": [
      ...
      { s: "brunna", t: "*(to Grukka, very stiffly)* The halfellows hid them. From both of us.", req: { alive: ["dwarf", "orc"] } },
      { s: "grukka", t: "*(equally stiffly)* Then the halfellows are smarter than both of us.", req: { alive: ["dwarf", "orc"] } },
      { s: "goldie", t: "They always were, dears. Now *eat*." },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "We saved *them*, Goldie. Just not anyone else." },
      { s: "goldie", t: "No more tricks, Hobby." },
      { s: "hobby", t: "No. That was the last one." },
    ],
    "E-Fallen": [
      ...
      { s: "barnaby", t: "The back doors, Hobby. You built them for the lovers. Now everyone's using them." },
      { s: "goldie", t: "*(locking the pub door)* We'll be back. Somebody has to collect the tabs." },
      { s: "skarra", t: "*(in the ruins)* The goose-girl's cellars! All EMPTY! Every one! HOW?!", req: { conqueror: "orc" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. Set two extra places." },
      { s: "goldie", t: "For the lovebirds? Already done, love. And a bowl for the wolf." },
    ],
  },
};
