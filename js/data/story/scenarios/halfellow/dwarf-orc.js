...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+orc"] = {
  ...
  beats: {
    ...
    B5: [
      ...
      { s: "hobby", t: "Wisps can't see underground, dear. And halfellows have been hiding things in cellars since before there *was* an Accord.", m: "scheming" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. Set two extra places.", m: "happy" },
