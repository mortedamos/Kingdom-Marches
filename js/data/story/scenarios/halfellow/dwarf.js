...
window.GameData.STORY_SCENARIOS["halfellow/dwarf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "goldie", t: "The *tariff*? Hobby, half our ale comes from Karrak. If they stop paying the tariff, they'll stop *selling*.", m: "stern" },
      { s: "hobby", t: "Then this war is about *ale*, dear. Or, well, the principle of ale.", m: "scheming" },
