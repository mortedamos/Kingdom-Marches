...
window.GameData.STORY_SCENARIOS["halfellow/elf+orc"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "ysolde", t: "My son thinks a great many things, and most of them are wrong. As for why: Skarra Ironjaw tried to set my hair on fire at a Midsummer Fair, eighty years ago. She failed, and she will try again. That is reason enough.", m: "uncanny" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Let them draw whatever borders they like. Supper's still at six, and the hedge is still standing.", m: "happy" },
