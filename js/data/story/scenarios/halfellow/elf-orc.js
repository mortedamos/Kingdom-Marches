...
window.GameData.STORY_SCENARIOS["halfellow/elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "Orcs to the south in their bog. Elves to the north in their forest. And us in the middle, with all the hedges." },
      { n: "In the Bloodmire, the Orcs' swamp country, the Bog Witch Skarra Ironjaw stands at the Speaking Stones." },
      { s: "skarra", t: "The goose-girl's meadows first! Then the tree-folk! Skarra will burn a path straight through to the Wellspring!" },
      ...
      { s: "ysolde", t: "Skarra. Of course it is Skarra. Then the Hearthlands are the Silverwood's first wall, whether they like it or not." },
      { s: "vaelis", t: "A wall made of *farmers*. How reassuring." },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Hedges on the south side, please. Thick ones. Thorny ones." },
      { s: "barnaby", t: "And the north side?" },
      { s: "hobby", t: "Leave the north side open, Uncle. The Elves like to *look down* on us. Let's give them a nice view." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. Well. The hedges held." },
    ...
    B3: [
      ...
      { s: "ysolde", t: "Thorn and root. When Skarra's raiders come, this will be a wall no axe can cut in a night." },
      { s: "hobby", t: "Why help us, Archdruid? Your son thinks we're a wall made of farmers." },
      { s: "ysolde", t: "My son thinks a great many things. Most of them are wrong. Skarra Ironjaw tried to set my hair on fire at a Midsummer Fair, eighty years ago. She failed. She will try again. That is enough." },
      { n: "Lord Vaelis watches from his horse, and does not dismount." },
      { s: "vaelis", t: "The Archdruid of the Silverwood, in the mud, with a halfellow. I shall never be able to look at a hedge again." },
      { s: "goldie", t: "*(handing up a mug)* Then drink your tea, dear, and look at the sky." },
      { n: "Far to the south, at the Speaking Stones, Skarra feels the hedge take root, and shrieks." },
      { s: "skarra", t: "THE MOSS-HAIRED CROW! Planting! In the goose-girl's mud! Skarra will burn it! Skarra will burn it ALL!" },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { s: "ysolde", t: "The hedge held, Mayor. So did you.", req: { alive: "elf" } },
      { s: "vaelis", t: "A kingdom of farmers holds the Marches. …I suppose someone must tell the Conclave.", req: { alive: "elf" } },
    ...
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. She sang to those saplings, Goldie. And we burned her forest anyway." },
    ],
    "E-Fallen": [
      ...
      { s: "skarra", t: "*(in the ruins)* The hedge is ASH! The goose-girl is GONE! Now, moss-haired crow, YOUR turn!", req: { conqueror: "orc" } },
      { s: "vaelis", t: "*(in the empty square)* They left. All of them. …I shall have someone plant something here.", req: { conqueror: "elf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. And the hedge is still standing." },
