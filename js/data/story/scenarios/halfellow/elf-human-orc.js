...
window.GameData.STORY_SCENARIOS["halfellow/elf+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "Elves to the north. Humans to the west. Orcs to the south. Every one of them twice our size." },
      { s: "goldie", t: "Then put the kettle on, love. Big folk always calm down with a cup of tea in their hands." },
      { s: "hobby", t: "Goldie, it's a *war*." },
      { s: "goldie", t: "Then put the *big* kettle on." },
      ...
      { s: "vaelis", t: "The Bog Witch must burn *something*. It is simply a question of what." },
      ...
      { s: "skarra", t: "Tree-folk, tin-folk, and the goose-girl in the middle! Skarra will start with the one who screams LOUDEST!" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! First building: a pub. Second building: a bigger pub." },
      { s: "barnaby", t: "Hobby, a *wall*, perhaps?" },
      { s: "hobby", t: "Uncle, a wall keeps people out. A pub keeps them *talking*. I want to know what they're saying." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. And every one of them is bigger than us." },
    ...
    B3: [
      ...
      { s: "goldie", t: "Sit down, all of you. No swords on the bar. Tea's on." },
      { n: "The orc is enormous. He sits on a halfellow stool, very carefully, and it holds. He holds his teacup with two fingers." },
      { s: "goldie", t: "*(to the elf)* Milk?" },
      { s: "hobby", t: "*(whispering to Barnaby)* She's going to make them *friends*, Uncle. In one afternoon. With *scones*." },
      { s: "barnaby", t: "She did it to me at your christening. I've never recovered." },
      ...
      { s: "vaelis", t: "*(his letter)* “Mistress Trickgrin. My envoy reports that your tea was adequate and your company was not. I shall not send him again. He has asked to go back.”", req: { alive: "elf" } },
      { s: "skarra", t: "*(at the Speaking Stones)* SCONES? Skarra's envoy went for WAR and came back with SCONES?!", req: { alive: "orc" } },
    ],
    ...
    B5: [
      ...
      { n: "The Goose & Kettle's cellar is the biggest larder in town. The soldiers break the door. Somebody knocks over a lantern. Nobody means for it to happen, and that makes no difference at all.", req: { conqueror: "human" },
        alt: { n: "The fire spreads from the granary to the pub next door faster than anyone can carry water.", req: { conqueror: "elf" },
          alt: { s: "skarra", t: "The goose-girl's KETTLE! Burn it! Burn the scones!" } } },
      ...
      { s: "goldie", t: "Out! All of you! Out the back, and don't you *dare* come back for the kettle!" },
    ...
    B6: [
      ...
      { s: "barnaby", t: "Sit. Drink. She'd have insisted." },
      { s: "barnaby", t: "And, Hobby. The orc scouts we captured. They say their orders came from the Speaking Stones, but the *map* came from somewhere else. A map drawn on silver paper.", req: { alive: "elf", notFlag: "pubRaidNotOrc" } },
      { s: "hobby", t: "Silver paper. Vaelis. He pointed the Bog Witch at *us*, so she'd burn our town instead of his forest.", req: { alive: "elf", notFlag: "pubRaidNotOrc" } },
      { s: "barnaby", t: "What will you do?", req: { alive: "elf", notFlag: "pubRaidNotOrc" } },
      ...
      { s: "hobby", t: "The last trick, Goldie. For you. And he'll never see it coming.", req: { alive: "elf", notFlag: "pubRaidNotOrc" }, alt: "The last trick, Goldie. For you. And then I'm done." },
      { s: "vaelis", t: "*(in the Silverwood, some days later, reading a very small note)* “I know about the map. — H.T.” …How very *unsettling*.", req: { alive: "elf", notFlag: "pubRaidNotOrc" } },
    ],
    ...
    "E-Held": [
      ...
      { s: "vaelis", t: "*(in the doorway)* Mayor. I have come to… The map was… I— …Is there tea?", req: { alive: "elf", seen: "B6", notFlag: "pubRaidNotOrc" } },
      { s: "hobby", t: "There's always tea, my lord. Sit down. Goldie would have made you.", req: { charDead: "goldie" }, alt: { s: "goldie", t: "Supper's at six! And Hobby, *you're* on time for once." } },
      { s: "barnaby", t: "The kettle's on, Hobby. It always was." },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "It's done, Goldie. All of them. There's nobody left to put the kettle on for.", req: { charDead: "goldie" }, alt: { s: "goldie", t: "No more tricks, Hobby." } },
    ...
    "E-Fallen": [
      ...
      { s: "barnaby", t: "I have the Accord. And the kettle. The Archive can burn. Those can't." },
      ...
      { s: "vaelis", t: "*(in the empty square)* The small folk are gone. I find I… do not care for the quiet.", req: { conqueror: "elf" } },
      { s: "maren", t: "*(in the empty granary)* We came for their bread. There's no one left to bake it. …Write it down.", req: { conqueror: "human" } },
      { s: "skarra", t: "*(in the ruins)* The goose-girl, GONE! Skarra WINS! …Is there any tea?", req: { conqueror: "orc" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go. Supper's still at six. And the kettle's on." },
