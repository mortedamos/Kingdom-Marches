...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+elf+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "Dwarves in the mountains. Elves in the forest. Orcs in the bog. And every one of them has to cross *our* hedges to reach the others." },
      { s: "goldie", t: "Then we'd best keep the hedges thick, love." },
      ...
      { s: "vaelis", t: "Stone, bog, and the small folk in the middle. The small piece is the interesting one. It moves in ways the others do not expect." },
      { n: "In the Bloodmire, the Orcs' swamp country, the Bog Witch Skarra Ironjaw cackles at the Speaking Stones." },
      { s: "skarra", t: "Skarra's Wisps are flying, goose-girl! Over your hedges, over your meadows! Skarra sees EVERYTHING!" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Hedges on *every* side, please. We've neighbours on every side." },
      { s: "barnaby", t: "That's a great deal of hedge, Hobby." },
      { s: "hobby", t: "It's a great deal of neighbours, Uncle." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. The hedges didn't hold everyone out." },
    ...
    B5: [
      ...
      { s: "goldie", t: "Before you open that, love. The rumour I've been sitting on. The Dwarf Thane's daughter and the Orc Warchief's son. They're in *love*. It's true.", req: { notSeen: "lovers:meet" } },
      { fx: { seen: "lovers:meet" } },
      { s: "vaelis", t: "*(his letter)* “Mayor. You know what I know about the Thane's daughter and the Warchief's son. Tell the Bog Witch. She will use it to seize her brother's throne, the Orcs will tear themselves apart, and your hedges will never see another raider. It is the obvious move. Even for you.”" },
      { s: "barnaby", t: "He's right, Hobby. That's the horrible thing. It would work." },
      { s: "hobby", t: "It would work. And two children would be dead by the end of the month." },
      { s: "goldie", t: "So what are you going to do?" },
      { n: "Hobby Trickgrin holds the letter over a candle until the silver wax runs." },
      { s: "hobby", t: "Nothing, Goldie. For once in my life, the trick is to do *nothing*." },
      ...
      { s: "skarra", t: "*(at the Speaking Stones)* The goose-girl's hedges, BROKEN! What happened to all your little TRICKS?" },
      { s: "vaelis", t: "*(in the Silverwood)* She had the winning piece in her hand, and she put it back in the box. …How very *irritating*." },
      { s: "hobby", t: "It cost us a dozen farms, Uncle. I'd pay it again." },
    ],
    ...
    "E-Held": [
      ...
      { s: "vaelis", t: "You kept their secret, and you still won. I shall have to reconsider several things. Not many.", req: { alive: "elf" } },
    ...
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. I did nothing when it mattered, Goldie. And then I did everything, when it didn't." },
    ],
    "E-Fallen": [
      ...
      { s: "barnaby", t: "I have the Accord. And you still never told anyone, Hobby. Not even now." },
      { s: "goldie", t: "*(locking the pub door)* We'll be back. Somebody has to collect the tabs." },
      { s: "skarra", t: "*(in the ruins)* The goose-girl, GONE! And her secrets with her! …She HAD secrets. Skarra KNOWS she had secrets!", req: { conqueror: "orc" } },
      { s: "vaelis", t: "*(in the empty square)* She could have won with one sentence. She chose to lose with her mouth shut. I do not understand the small folk.", req: { conqueror: "elf" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. And the secret's still safe." },
