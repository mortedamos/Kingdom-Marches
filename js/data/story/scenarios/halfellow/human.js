...
window.GameData.STORY_SCENARIOS["halfellow/human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "And Westmarch will want it. The Humans. We've fed their cities for three hundred years." },
      { s: "goldie", t: "And not once said thank you. And the Lord-Paladin of Westmarch, the Queen's own brother, owes *this pub* four hundred silver." },
      ...
      { s: "maren", t: "The Hearthlands hold half the granaries in the Marches. We'll need them, one way or another. …Write it down." },
      { s: "corvin", t: "Before we march on the bakers, Majesty, perhaps the Lord-Paladin should settle his bar tab with them." },
      { s: "aldric", t: "It is a *tithe*, Archmage. For the pub's spiritual wellbeing." },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Plant wheat. And *don't* sell any of it to Westmarch until they say please." },
      { s: "barnaby", t: "Hobby, that's an *embargo*." },
      { s: "hobby", t: "It's *manners*, Uncle." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. Over *bread*. Three hundred years we've fed them, and it's come to this." },
      { s: "hobby", t: "Our traps are out now, too. I used to laugh when those went off.", req: { tech: "self:halfellow_set_the_trap" } },
      { s: "goldie", t: "You're not grinning, love.", alt: { s: "barnaby", t: "You're not grinning, Hobby." } },
    ...
    B3: [
      ...
      { s: "barnaby", t: "Mayor, the complete text of the Long Accord. And the complete text of Lord Aldric's tab. The tab is longer." },
      { s: "goldie", t: "Four hundred silver, Hobby. I want it *in the peace treaty*." },
      { s: "hobby", t: "Goldie, there's no peace treaty. The stone's broken. Nobody can swear anything." },
      { s: "goldie", t: "Then I want it in the *war*." },
      { n: "A letter arrives from Westmarch the next day, in a dry, precise hand." },
      { s: "corvin", t: "*(his letter)* “Mistress Trickgrin. The Collegium formally supports your claim against the Lord-Paladin. I have never enjoyed a war aim more. Corvin Varro.”" },
    ],
    B6: [
      ...
      { s: "goldie", t: "Whatever you're planning next, it's the last one. And when this is over, you're going to Westmarch and you're collecting that tab *in person*." },
      { s: "hobby", t: "…The last one. And yes. In person. With interest." },
    ],
    ...
    "E-Held": [
      ...
      { s: "aldric", t: "…Four hundred silver. *And* supper.", req: { alive: "human" } },
      { s: "maren", t: "Pay it, brother. And say thank you. We've three hundred years of them to catch up on. …And write it down.", req: { alive: "human" } },
      { s: "goldie", t: "*(counting the coins)* Tab: *closed*." },
    ],
    "E-Remains": [
      { n: "The Halfellows have won by destroying Westmarch. The river cities are empty." },
      { s: "stone", t: "REMAINS." },
      { s: "goldie", t: "The tab's still open, Hobby. There's no one left to pay it.", alt: { s: "barnaby", t: "The tab's still open. There's no one left to pay it." } },
      { n: "That night, the halfellows light a great bonfire on the hill above {capital}. It is not a celebration." },
      { s: "hobby", t: "Three hundred years of bread, Goldie. And we never once heard them say thank you. Now we never will." },
    ],
    "E-Fallen": [
      ...
      { s: "maren", t: "Aldric. Pay it. *Now*. To whoever's left. …And write it down." },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      { n: "Westmarch has won by holding the Marches. Human roads run from the river to the hills, but the Hearthlands still stand." },
      { n: "Far away, the split Marchstone speaks, and not to the Halfellows." },
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. And they'll still need our bread." },
