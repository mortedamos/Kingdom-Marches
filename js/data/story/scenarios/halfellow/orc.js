...
window.GameData.STORY_SCENARIOS["halfellow/orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "And the Accord's gone. Which means nothing is keeping the Orcs in their bog any more.", m: "sad" },
      ...
      { s: "skarra", t: "The goose-girl is MAYOR now! Skarra has waited forty years for this! Gnash! Remember the goose?", m: "gleeful" },
      ...
      { s: "goldie", t: "No, Hobby. You promised me. *No more geese*.", m: "stern" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Thick hedges, please. Very thick. With *surprises* in them.", m: "scheming" },
      { s: "barnaby", t: "Surprises, Hobby?", m: "flustered" },
      { s: "hobby", t: "Traps, Uncle. But *friendly-looking* ones.", m: "scheming" },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. With Skarra's people. Just like forty years ago. Except I'm not twenty any more.", m: "sad" },
      ...
      { s: "skarra", t: "*(in the Bloodmire)* Halfellow blood! The goose-girl will PAY! Gnash, sharpen the big cleaver!", m: "gleeful" },
      { s: "gnash", t: "Gnash only HAVE big cleaver.", m: "confused" },
    ],
    ...
    B5: [
      ...
      { s: "skarra", t: "The goose-girl's PUB! Burn it! Burn the feather! Burn EVERYTHING!", m: "gleeful" },
    ...
    B6: [
      ...
      { s: "hobby", t: "I promised her no more geese. I promised her the last trick.", m: "sad" },
      { s: "barnaby", t: "Then keep the promise, Hobby. Make it the last one. Make it *count*.", m: "sad" },
    ],
    ...
    "E-Held": [
      ...
      { s: "barnaby", t: "I've written her into the Archive, Hobby. Page one. Above the Accord.", m: "sad" },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "It's done, Goldie. Skarra, the raiders, all of it. The bog is quiet.", m: "sad", req: { charDead: "goldie" }, alt: { s: "goldie", t: "No more tricks, Hobby.", m: "sad" } },
    ...
    "E-Fallen": [
      ...
      { s: "barnaby", t: "I have the Accord. And the painting of Goldie. The Archive can burn. Those can't.", m: "sad" },
      { s: "hobby", t: "We'll be back, Uncle. Somebody has to collect the tabs. She'd insist.", m: "sad" },
      { s: "skarra", t: "*(in the ruins)* The goose-girl, GONE! Forty years, and Skarra WINS! …Where are the geese? WHERE ARE THE GEESE?", m: "gleeful" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go. Supper's still at six.", m: "sad" },
      { s: "barnaby", t: "And you'll still be late for it. She'd have said that.", m: "sad" },
      { s: "hobby", t: "*(touching the singed feather in her hat)* …I know, Uncle. I know.", m: "sad" },
    ],
  },
};
