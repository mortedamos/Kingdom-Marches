...
window.GameData.STORY_SCENARIOS["halfellow/dwarf+elf+human+orc"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "Every crown, Uncle? Karrak, the Silverwood, Westmarch *and* the Bloodmire?" },
      { s: "barnaby", t: "Every crown that ever signed. All four of them. And us." },
      { s: "goldie", t: "The smallest folk in the Marches, against everyone. You've always wanted a trick big enough, love." },
      { s: "hobby", t: "Not like this, Goldie. Never like this." },
      { n: "Across the Marches, four crowns read the same news." },
      { s: "brunna", t: "Oskar. Open the Book. All the volumes." },
      { s: "vaelis", t: "Four armies and a village. I do hope the village is amusing." },
      { s: "maren", t: "Every crown at once. May the Dawn have mercy on us all. …Write it down." },
      { s: "skarra", t: "EVERYONE! Skarra gets to fight EVERYONE! Oh, it's like Midwinter!" },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Hedges, cellars, a pub, and the best forger in the Hearthlands." },
      { s: "barnaby", t: "*Forger*, Hobby?" },
      { s: "hobby", t: "Calligrapher, Uncle. I meant *calligrapher*." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. The first of four, I expect." },
    ...
    B3: [
      ...
      { s: "barnaby", t: "Hobby. The Silverwood has written to Karrak, to Westmarch and to the Bloodmire. The same letter, three times." },
      { s: "vaelis", t: "*(his letter)* “The Hearthlands feed every army in this war, including yours. Starve the small folk, and every other crown starves with them. I merely point it out.”" },
      { s: "goldie", t: "He's telling everyone to burn our fields." },
      { s: "hobby", t: "He's telling everyone that *we* are the prize. Clever. Very clever." },
      { n: "Hobby reads the letter three times. Slowly, for the first time since the Marchstone split, she starts to grin." },
      { s: "hobby", t: "Uncle. How good is your handwriting, exactly?" },
      { s: "barnaby", t: "…Oh, no." },
    ],
    // THE LAST TRICK.
    B5: [
      ...
      { s: "barnaby", t: "Forty years of scholarship, Hobby. Forty years. And now I'm *forging surrenders*." },
      { s: "hobby", t: "Not surrenders, Uncle. *Offers of truce*. One from each crown to each of the others. In perfect Accord calligraphy. With the old seals." },
      { s: "goldie", t: "And when they find out?" },
      { s: "hobby", t: "They'll find out in a week. And for one week, nobody in the Marches will fight anybody." },
      ...
      { s: "goldie", t: "*(to Hobby, low)* The Dwarf Thane's daughter and the Orc Warchief's son. In *love*, Hobby. They heard about the truce. They thought it was *real*.", req: { notSeen: "lovers:meet" },
        alt: { s: "goldie", t: "*(to Hobby, low)* Our two lovebirds. They heard about the truce. They thought it was *real*." } },
      { fx: { seen: "lovers:meet" } },
      { s: "hobby", t: "Then let it be real, Goldie. For one week. Pour them something nice." },
      { n: "On the seventh day, the crowns compare their letters. The Marches erupt." },
      { s: "brunna", t: "*Forged*! Oskar, a new volume! Just for the halfellows!", req: { alive: "dwarf" } },
      { s: "maren", t: "Forged. Beautifully. …Write it down. And then find me whoever did the calligraphy.", req: { alive: "human" } },
      { s: "skarra", t: "A WEEK! Skarra lost a whole WEEK! Skarra was going to burn things ALL WEEK!", req: { alive: "orc" } },
      { s: "vaelis", t: "*(very quietly, alone)* She used my letter. She read it, and she *used* it. …Magnificent." },
    ],
    B6: [
      ...
      { s: "hobby", t: "I've got a Moot in ten minutes, and four very angry crowns." },
      { s: "goldie", t: "That was it, love. That was the big one. There's no trick left after that." },
      { s: "hobby", t: "…I know. Now we just have to *win*. The ordinary way." },
      { s: "barnaby", t: "I've been asked for my calligraphy by three separate crowns. As a *commission*." },
    ],
    ...
    "E-Held": [
      ...
      { s: "brunna", t: "Karrak signs. With the *real* seal.", req: { alive: "dwarf" } },
      { s: "maren", t: "Westmarch signs. …Write it down. Properly, this time.", req: { alive: "human" } },
      { s: "vaelis", t: "The Silverwood signs. I checked the ink myself.", req: { alive: "elf" } },
      { s: "grukka", t: "Bloodmire signs. Skarra is not allowed near the pen.", req: { alive: "orc" } },
      { n: "At the bar, a young dwarf and an orc sit together in the daylight, and this time the truce is real.", req: { alive: ["dwarf", "orc"] } },
      { s: "goldie", t: "Supper's at six! And Hobby, *you're* on time for once." },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. One week, Goldie. I gave them one week of peace, and it was the best thing I ever did." },
    ],
    "E-Fallen": [
      ...
      { s: "barnaby", t: "I have the Accord. And the four letters. Somebody should remember the week the Marches stood still." },
      { s: "goldie", t: "*(locking the pub door)* We'll be back. Somebody has to collect the tabs." },
      { s: "vaelis", t: "*(in the empty Archive)* The forger's desk. Still warm. …I shall keep the pen.", req: { conqueror: "elf" } },
      { s: "skarra", t: "*(in the ruins)* The goose-girl, GONE! And NO TRICKS! Skarra checked! Skarra checked EVERYWHERE!", req: { conqueror: "orc" } },
      { s: "maren", t: "*(in the empty pub)* One week of peace. She gave us that. …Write it down.", req: { conqueror: "human" } },
      { s: "brunna", t: "*(in the empty pub)* Oskar. Close the halfellow volume. …Leave the last page blank.", req: { conqueror: "dwarf" }, alt: { s: "sigrun", t: "*(in the empty pub)* This is where we sat. In the daylight. …Leave it standing.", req: { conqueror: "dwarf" } } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. And they'll always remember the week." },
