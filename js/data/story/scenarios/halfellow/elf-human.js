...
window.GameData.STORY_SCENARIOS["halfellow/elf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "hobby", t: "The Elves of the Silverwood on one side, the Humans of Westmarch on the other. Both very old, very proud, and very hungry." },
      { s: "goldie", t: "They call this country *the settled lands*, love. As if we just sat down one day and never got up." },
      ...
      { s: "vaelis", t: "The humans will march. The small folk will feed whoever asks politely. How tiresome. How *useful*." },
      { n: "In Westmarch, the Human kingdom, Queen Maren Ashcroft studies a map of the granaries." },
      { s: "maren", t: "Half our bread comes from the Hearthlands. If the Elves get there first, Westmarch starves by winter. …Write it down." },
    ],
    B1: [
      ...
      { s: "hobby", t: "Lovely town! Let's make sure it's *unsettled*. Lots of moving about. Fairs, markets, parades." },
      { s: "barnaby", t: "Is that a strategy, Hobby?" },
      { s: "hobby", t: "It's a *reputation*, Uncle. It's hard to conquer somebody who's never where you left them." },
    ],
    B2: [
      ...
      { s: "hobby", t: "First blood. They thought we'd just hand over the harvest." },
    ...
    B3: [
      ...
      { s: "vaelis", t: "Mayor. The Silverwood will buy every sack of grain in the Hearthlands this season. At twice the price. On one condition: *none of it goes west*." },
      { s: "hobby", t: "You want me to starve Westmarch for you." },
      { s: "vaelis", t: "I want you to *sell your bread*. What the humans eat is not your concern. It is barely mine." },
      { s: "goldie", t: "*(from behind the bar)* Would his lordship like a pint while he's plotting famines?" },
      { s: "vaelis", t: "His lordship would not." },
      { n: "Hobby shakes his hand, smiling. At the door, he pauses. For forty years, Hobby Trickgrin has been the one creature in the Marches who can make Lord Vaelis lose his composure." },
      { s: "vaelis", t: "And Mayor. If I find a single frog in my saddlebags this time—" },
      { s: "hobby", t: "Wouldn't dream of it, my lord." },
      { n: "There are three. The moment he is gone, she is writing a letter." },
      { s: "hobby", t: "*(her letter)* “Archmage. An elf just tried to buy your winter. I said yes. Send carts. Lots of them. At night. — H.T.”" },
      { s: "barnaby", t: "Hobby, you just double-crossed the heir to the Silverwood." },
      { s: "hobby", t: "Single-crossed, Uncle. I never crossed *Westmarch*." },
    ],
    ...
    "E-Held": [
      ...
      { s: "maren", t: "We thought of you as our pantry, Mayor. I'm sorry. …Write that down.", req: { alive: "human" } },
      { s: "vaelis", t: "*(standing in the doorway, still not sitting)* Remarkable. The pantry has eaten the kitchen.", req: { alive: "elf" } },
      { s: "goldie", t: "Sit *down*, dear. You're blocking the draught." },
    ],
    "E-Remains": [
      ...
      { s: "hobby", t: "No. That was the last one. They called us *settled*, Goldie. I wanted to prove them wrong. Not like this." },
    ],
    "E-Fallen": [
      ...
      { s: "vaelis", t: "*(in the empty pub)* Gone. Every one of them. And they never *sat still* long enough to be conquered.", req: { conqueror: "elf" } },
      { s: "maren", t: "*(in the empty pub)* We've taken the pantry. And there's no one left to bake. …Write it down.", req: { conqueror: "human" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "hobby", t: "Crowns come and go, dear. Supper's still at six. And someone still has to grow it." },
