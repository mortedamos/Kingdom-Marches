...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "A thousand years ago, the Accord gave the Dwarves the mountains and the Elves the forest. The two old hoarders. And it gave us the bog." },
      { s: "grukka", t: "That stone was a fence, sister. Fences break." },
      ...
      { s: "gnash", t: "Mountain AND forest? Gnash smash rocks AND trees! Gnash pick… both!" },
      ...
      { s: "oskar", t: "Volume Seven. The Orc volume. The only one we never closed." },
      { s: "vaelis", t: "The orcs are coming. Like weather. Tell the mud-folk. Perhaps the weather will fall on *them* first." },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "grukka", t: "*(handing it to Varg)* You read, boy. Read it." },
      { s: "varg", t: "*(reading, slowly going grey)* “Warchief. My rangers have seen your son at an old dwarf door, in the company of the Thane's daughter. I thought you would wish to know. Or perhaps the Thane would. I have not yet decided whom to tell first.”" },
      { n: "The fire pit crackles. Grukka looks at his son. Varg does not look away." },
      { s: "grukka", t: "…Is it true?", req: { notSeen: "B5" } },
      { s: "varg", t: "Her name is Sigrun, Father. And that elf is trying to break both of us with one letter." },
      { s: "skarra", t: "*(delighted)* Oh, the tree-lord is CLEVER! Skarra could KISS him! …Skarra won't. He's very tall. But Skarra *could*." },
      { s: "grukka", t: "Burn the letter. Nobody speaks of this. *Nobody*, Skarra." },
    ...
    "E-Held": [
      ...
      { s: "vaelis", t: "*(in the Silverwood, on hearing)* I held the letter that could have ended them both. I waited too long. How *very* unlike me.", req: { alive: "elf" } },
    ],
    "E-Remains": [
      ...
      { s: "grukka", t: "We broke the fence. Both hoarders, gone. So what do we keep inside it now?" },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(in Karrak)* The last entry in Volume Seven: “The Bloodmire Clans. Broken.” …Amend it. “Worthy foe.”", req: { conqueror: "dwarf" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "The old hoarders hold the Marches again. New borders." },
