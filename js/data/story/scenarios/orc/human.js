...
window.GameData.STORY_SCENARIOS["orc/human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "I went to that parley unarmed. I kept my word. Their knight struck first, and their Queen calls *us* oath-breakers.", m: "angry" },
      { s: "skarra", t: "And Skarra LOVES it! A grudge this juicy only comes along once a century!", m: "gleeful" },
      ...
      { s: "gnash", t: "Humans! Gnash smash humans! They have shiny hats!", m: "happy" },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "Father. What if the Queen doesn't know? What if her knight lied to her too?", m: "bashful" },
      { s: "grukka", t: "Then she should ask him, boy. Loudly.", m: "angry" },
    ],
    B2: [
      ...
      { s: "skarra", t: "Human blood on the road, little Warchief! The ancestors are HUNGRY! And so is Skarra's grudge-jar!", m: "gleeful" },
      { s: "gnash", t: "Gnash got shiny hat! …Hat has head in it. Gnash give head back.", m: "confused" },
    ...
    B3: {
      ...
      lines: [
        ...
        { s: "varg", t: "Temple records, Father. From a chapel we raided. One of them is about the parley.", m: "bashful" },
        { s: "grukka", t: "I can't read human, boy.", m: "defiant" },
        { s: "varg", t: "I can. A little. *(reading slowly)* “The Lord-Paladin… drew first… the ground shook… he mistook it for… an ambush.”", m: "sad" },
        { n: "The fire pit crackles. Nobody at the council speaks." },
        { s: "grukka", t: "The Lord-Paladin. The Queen's own brother. He struck first. And he told her *we* did.", m: "angry" },
        { s: "varg", t: "Father, we could send it to her. She might not know.", m: "bashful" },
        { s: "skarra", t: "*(snatching the scroll)* Send it? SEND it? And ruin the best grudge in a hundred years? Skarra will *eat* this scroll first!", m: "gleeful" },
        { s: "grukka", t: "Give it back, Skarra.", m: "angry" },
        ...
        { s: "grukka", t: "*(to Varg, quietly)* Doesn't matter. I know now. That's enough.", m: "sad" },
      ],
      fallback: [
        ...
        { s: "grukka", t: "You were at the parley, boy. I saw your face.", m: "defiant" },
        { n: "The squire nods, shaking." },
        { s: "grukka", t: "Who struck first?", m: "angry" },
        ...
        { s: "grukka", t: "*(to his captains)* Let him go. Give him a horse.", m: "defiant" },
        { s: "skarra", t: "LET HIM GO?! He knows the truth, brother! What if he TELLS someone? Skarra LIKES the grudge!", m: "angry" },
        { s: "grukka", t: "That's why I'm letting him go, Skarra.", m: "defiant" },
      ],
    },
    ...
    "E-Held": [
      ...
      { s: "aldric", t: "Warchief. At the parley. I struck first. The ground shook, and I was afraid. I have come to say so, to your face.", m: "sad", req: { alive: "human" } },
      { s: "grukka", t: "I know, paladin. I've known a long time. …Took you long enough.", m: "defiant", req: { alive: "human" } },
    ],
    "E-Remains": [
      ...
      { s: "grukka", t: "The Queen never knew. Her brother never told her. And now there's nobody left to tell.", m: "sad" },
      { s: "varg", t: "We knew, Father. We could have sent the truth. We sent an army instead.", m: "sad" },
      { s: "grukka", t: "…Keep talking, boy. I deserve it.", m: "sad" },
    ],
    "E-Fallen": [
      ...
      { s: "grukka", t: "I kept my word at the parley, sister. I'll keep this one too. Axe in hand, to the end.", m: "defiant" },
      { s: "grukka", t: "Take Moss. Ride. And take the truth with you, boy. Somebody has to tell it one day.", m: "sad" },
      ...
      { s: "maren", t: "“The Lord-Paladin drew first.” …Aldric. *Aldric*. …Write it down. All of it.", m: "sad", req: { flag: "parleyScroll" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      { n: "Westmarch has won by holding the Marches. Westmarch's banners fly to the edge of the bog, but the Bloodmire Clans still stand." },
      { n: "Far away, the split Marchstone speaks, and not to the Orcs." },
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "The Queen holds the Marches. The Queen whose brother drew first.", m: "angry" },
      { s: "grukka", t: "The Queen's banners at the reeds. The cage is back. …This time, we build inside it.", m: "defiant" },
      { s: "varg", t: "And the truth, Father?", m: "bashful" },
      { s: "grukka", t: "Send it to her, boy. Wrapped in the ribbon. Let her read it on her new throne.", m: "defiant", req: { flag: "parleyScroll" }, alt: "Tell her, boy. Loudly. Let her hear it on her new throne." },
    ],
  },
};
