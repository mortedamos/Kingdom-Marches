...
window.GameData.STORY_SCENARIOS["orc/halfellow+human"] = {
  ...
  beats: {
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "I'll die with a full belly and my axe in my hand, sister. That's more than our grandmother ever got.", m: "defiant" },
      { s: "grukka", t: "Take Moss. Ride. Find a farm that'll take an orc, and learn to grow things. Don't look back.", m: "sad" },
      { n: "Varg rides into the bog on his dire wolf. No one follows." },
      { s: "maren", t: "*(in the ashes)* All they wanted was bread, and their Warchief came to our parley unarmed. We answered him with knights.", m: "sad", req: { conqueror: "human" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "Their fields on every side. The bog's a cage again, but at least it's a cage next to a kitchen.", m: "defiant" },
