...
window.GameData.STORY_SCENARIOS["orc/halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The halfellows grow the food. Westmarch buys it. Take the Hearthlands, and the Humans starve without a single battle." },
      { s: "skarra", t: "And the goose-girl gets what's coming to her! Forty years, Skarra has waited!" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Food! Gnash like food! …Food has geese?" },
      { s: "grukka", t: "Some food *is* geese, Gnash." },
      { s: "gnash", t: "*(horrified)* Gnash never think of that." },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "And Westmarch still says we broke the parley, Father." },
      { s: "grukka", t: "Then Westmarch can say it hungry." },
    ],
    B2: [
      ...
      { s: "gnash", t: "Gnash hungry too. Is that same thing?" },
    ...
    B3: [
      ...
      { s: "gnash", t: "*(asleep on a pile of crusts)* …pie…" },
      { s: "grukka", t: "Look at them, boy. Full. Warm. Singing. I've never seen the Clans like this." },
      { s: "varg", t: "And next winter, Father? When we've eaten everything we took, and burned the farms we took it from?" },
      { n: "Grukka doesn't answer for a long time." },
      { s: "skarra", t: "Next winter we raid AGAIN! That's what raiding IS, you soft-hearted turnip!" },
      { s: "varg", t: "Then the halfellows will stop planting. And Westmarch will stop buying. And we'll be the only people in the Marches who know how to take, and nobody left who knows how to grow." },
      { s: "grukka", t: "…Keep talking, boy. Do I want the Marches? Or do I just want the kitchen?" },
      { s: "varg", t: "I think you want to *never be hungry again*, Father. That's not the same thing as raiding." },
    ],
    ...
    "E-Held": [
      ...
      { s: "grukka", t: "Not a fence. A hearth. …And a *kitchen*. Don't tell anyone I said kitchen." },
      { s: "gnash", t: "EVERYONE HEARD. Gnash tell everyone anyway, to be sure. Also Gnash is cook now." },
      { s: "hobby", t: "*(in the Hearthlands)* The Orcs have asked for *seed*. Not raids. *Seed*. Uncle, write it down.", req: { alive: "halfellow" } },
    ],
    "E-Remains": [
      ...
      { s: "grukka", t: "We took the kitchen, boy. And the cooks." },
      { s: "varg", t: "Then learn to cook, Father. All of us. Before the snow." },
    ],
    "E-Fallen": [
      ...
      { s: "hobby", t: "*(setting a pie on the Speaking Stones)* For the Warchief. He only ever wanted to not be hungry. That's not so strange.", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "…This time, we build inside it. And we plant something. Boy, find me a halfellow who'll sell us seed." },
    ],
  },
};
