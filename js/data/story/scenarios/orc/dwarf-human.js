...
window.GameData.STORY_SCENARIOS["orc/dwarf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "Karrak and Westmarch. The Dwarves lent the Humans a cathedral, and now they'll squabble over the bill. And neither of them will be watching the bog." },
      { s: "grukka", t: "And the Queen of Westmarch owes *me* something too. An apology, for the parley. I'll collect it the orc way." },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Gnash collect! Gnash VERY good collector! Gnash collect heads!" },
      ...
      { s: "skarra", t: "*(stroking her frog)* No, Varg. I'm *sure* they weren't. Hee hee." },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "gnash", t: "*(sitting on the pile)* Shiny! Gnash rich! Gnash buy… more cleaver!" },
      { s: "grukka", t: "The Humans paid it. The Dwarves never got it. Each one will blame the other." },
      { s: "varg", t: "Father, we could give it back. To either one. They'd owe us." },
      { s: "skarra", t: "GIVE IT BACK? Varg, you are so SOFT! Is this a Warchief's son or a dwarf's *bookkeeper*?" },
      { n: "Varg flinches. Skarra smiles." },
      { s: "grukka", t: "Keep the gold. Keep talking, boy. I'm listening. …Just not about this." },
      { n: "In Karrak, Loremaster Oskar Grimgate opens the Book of Grudges to an old page, and a new one." },
      { s: "oskar", t: "Entry {grudge} in the Book of Grudges: the Orcs, for robbing Westmarch of *our* money. The first grudge I've ever written on the Humans' behalf. I feel unwell." },
    ],
    ...
    "E-Held": [
      ...
      { s: "brunna", t: "Stay by the door, Warchief. And the gold. We'll discuss the gold.", req: { alive: "dwarf" } },
      { s: "grukka", t: "I'll stay by the door. The gold stays with me.", req: { alive: "dwarf" } },
    ],
    "E-Remains": [
      { n: "The Orcs have won by destroying Karrak and Westmarch. The mountains and the river cities are silent." },
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "The ledger and the anvil. Both broken. All the gold in the Marches is ours, and nothing to spend it on." },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(in Karrak)* The last entry in Volume Seven: “The Bloodmire Clans. Broken.” …And the gold, recovered. Amend it. “Worthy foe.”", req: { conqueror: "dwarf" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. We've the gold for it." },
      { s: "varg", t: "Father, I'm riding to Karrak.", req: { alive: "dwarf" }, alt: "Then let's build, Father." },
      { s: "grukka", t: "…Knock loud. And take them their gold back. *Some* of it.", req: { alive: "dwarf" } },
    ],
  },
};
