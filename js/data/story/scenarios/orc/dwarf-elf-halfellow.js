...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+halfellow"] = {
  ...
  beats: {
    ...
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "Every old people with a war against us. All gone. So what do we keep inside the cage now?", m: "sad" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New cage. Same bog. …Boy. That map of yours. Show it to me.", m: "defiant" },
