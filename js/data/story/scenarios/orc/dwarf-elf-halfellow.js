...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+halfellow"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "varg", t: "So we draw a new map. One where nobody's fence is anyone else's wall.", m: "bashful" },
    ...
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "Every old people with a war against us. All gone. So what do we keep inside the fence now?", m: "sad" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …Boy. That map of yours. Show it to me.", m: "defiant" },
      { s: "varg", t: "Every border's a road, Father.", m: "bashful" },
      { s: "grukka", t: "…Then we build roads. Inside the fence, and out.", m: "happy" },
    ],
  },
};
