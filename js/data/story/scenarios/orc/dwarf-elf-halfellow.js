...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Dwarves remember the Mountain Wars. The Elves remember the burning groves. The halfellows remember the Goose Rout. Every old people in the Marches has a war with us in its memory." },
      { s: "skarra", t: "And Skarra remembers ALL of them! Fondly!" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Gnash remember goose. Gnash remember it EVERY NIGHT." },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "Every song about us is about a war, Father. Maybe someone should write a different one." },
      { s: "skarra", t: "*(stroking her frog)* Oh, Varg. Skarra thinks someone already *is*. Hee hee." },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "sigrun", t: "Here's the Hearthlands, here's the Silverwood, here's Karrak, here's your bog. Every border on this map is a war someone remembers." },
      { s: "varg", t: "So we draw a new map. One where nobody's fence is anyone else's wall." },
      { s: "sigrun", t: "My mother would call that treason." },
      { s: "varg", t: "Mine would call it *soft*. …And then he'd listen. He always listens, in the end." },
      ...
      { s: "skarra", t: "A new MAP! With the Thane's BRAT! Oh, little Warchief. Your boy has just handed Skarra your whole bog." },
    ],
    ...
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "Every old people with a war against us. All gone. So what do we keep inside the fence now?" },
      { s: "varg", t: "We drew a map, Father. Sigrun and I. Every border was a road. …You burned all the places on it." },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! Every old people at ONCE! Skarra always said so—" },
      ...
      { s: "grukka", t: "Take Moss. Take the map. Ride. Don't look back." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …Boy. That map of yours. Show it to me." },
      { s: "varg", t: "Every border's a road, Father." },
      { s: "grukka", t: "…Then we build roads. Inside the fence, and out." },
    ],
  },
};
