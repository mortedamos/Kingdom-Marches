/**
 * STORY SCENARIO -- orc/dwarf+elf+human, "The Three Bars"
 ...
 * B3 override: the three bars on one map. B5 override: Skarra's coup with
...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Dwarves' mountains to the north. The Elves' forest to the east. Westmarch's mage-towers to the west. Three bars of a cage, and the Clans inside it, for a thousand years.", m: "angry" },
      { s: "grukka", t: "That stone was a cage, sister. Bars break. *All* of them.", m: "defiant" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Three bars! Gnash count them! One… two… many! MANY bars!", m: "confused" },
    ...
    B3: [
      ...
      { s: "varg", t: "Father. What if one of those lines could be a door instead of a bar?", m: "bashful" },
    ...
    B5: [
      ...
      { s: "skarra", t: "THREE bars, the Warchief says! And his son wants to open a *door* in one! Is this a Warchief's blood? It is TREASON!", m: "gleeful" },
