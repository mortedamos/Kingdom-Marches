 ...
 * Every border that boxed in the bogs: mountain, forest and road. The purest
...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Dwarves' mountains to the north. The Elves' forest to the east. Westmarch's roads to the west. Three fences, and the Clans in the middle, for a thousand years." },
      { s: "grukka", t: "That stone was a fence, sister. Fences break. *All* of them." },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Three fences! Gnash count them! One… two… many! MANY fences!" },
      ...
      { s: "vaelis", t: "The orcs, the mud-folk and the mayflies. Three angry neighbours. I believe I shall write to all of them." },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "grukka", t: "Bronze: the Dwarves took the mountains. Silver: the Elves took the forest. Purple: the Humans built roads to the edge of the reeds. Every line on this hide was drawn *without us*." },
      { s: "skarra", t: "And Skarra will burn every line off it!" },
      { s: "varg", t: "Father. What if one of those lines could be a door instead of a fence?" },
      { s: "grukka", t: "Which one, boy?" },
      { n: "Varg's eyes go, for a moment, to the bronze line in the north. Only Skarra sees it." },
      { s: "varg", t: "…Any of them." },
      { s: "skarra", t: "*(stroking her frog, very softly)* *Any* of them. Of course, Varg. Hee hee." },
    ],
    ...
    B5: [
      ...
      { s: "skarra", t: "Hear me, clans of Bloodmire! A friend in the Silverwood has sent Skarra PROOF! The Warchief's own son crawls through dwarf tunnels to meet the Thane's daughter!" },
      { fx: { seen: "lovers:meet" } },
      { n: "A roar of disbelief. Every eye turns to Varg. He doesn't deny it." },
      { s: "varg", t: "Her name is Sigrun." },
      { s: "skarra", t: "THREE fences, the Warchief says! And his son wants to open a *door* in one! Is this a Warchief's blood? It is TREASON!" },
      ...
      { s: "grukka", t: "The Elves sent you this, Skarra. The same Elves who drew the silver line. They want the Clans at each other's throats. And you *helped* them." },
      { s: "skarra", t: "Skarra would help ANYONE!" },
      { s: "grukka", t: "I've hated those three lines my whole life. I hate them more than I love anything. …Except him." },
      { s: "grukka", t: "Get out of my bog, Skarra. Take your frog. And your *friend's* letter." },
      ...
      { s: "vaelis", t: "*(in the Silverwood, on hearing)* She chose the boy over the grievance. …I did not think orcs *could*.", req: { alive: "elf" } },
    ],
    ...
    "E-Held": [
      ...
      { s: "grukka", t: "I'll stay by the door. It's a good door.", req: { alive: "dwarf" } },
    ],
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "Three fences. All burned off the map. So what do we keep inside it now?" },
      { s: "varg", t: "You told me to keep talking, Father, so I'll say it. I wanted a door. You burned the whole wall, and everyone behind it." },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! All three fences came for us at ONCE! Skarra always said so—" },
      ...
      { s: "grukka", t: "Take Moss. Ride north. Knock loud." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. And we put a door in it." },
