...
window.GameData.STORY_SCENARIOS["orc/dwarf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Dwarves of Karrak to the north. The halfellows of the Hearthlands to the east. The only two peoples who ever sent the Clans home beaten." },
      { s: "skarra", t: "The mud-diggers at their gates, and the goose-girl in her HEDGES! Skarra has grudges against BOTH! Skarra is SPOILED for choice!" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Dwarves, Gnash smash. Halfellows… is there goose?" },
      { s: "grukka", t: "Probably, Gnash." },
      { s: "gnash", t: "Gnash do dwarves." },
    ...
    B2: [
      ...
      { s: "gnash", t: "Was there goose? …Gnash hear honking. Gnash hear honking in Gnash's *dreams*." },
    ...
    B3: [
      ...
      { s: "gnash", t: "Varg! Gnash guarding! …Who is little metal lady?" },
      { s: "varg", t: "…A prisoner, Gnash. I caught her." },
      { s: "sigrun", t: "*(very loudly)* Oh no. I have been caught. By an orc. How terrible." },
      { s: "gnash", t: "Why prisoner hugging Varg?" },
      { s: "varg", t: "It's a dwarf thing. They hug before they're interrogated." },
      { n: "Gnash counts on his fingers for a very long time." },
      { s: "gnash", t: "Gnash not understand. Gnash go tell Skarra. Skarra understand everything." },
      { s: "varg", t: "Gnash! *Wait*. …There's a goose loose in the camp. Near Skarra's hut." },
      { n: "Gnash runs the other way, screaming. Sigrun laughs so hard she has to sit down." },
      { s: "sigrun", t: "Is that the one who's *afraid of geese*? I'm going to write a song about him." },
      { fx: { seen: "lovers:meet" } },
    ],
    ...
    "E-Held": [
      ...
      { s: "gnash", t: "*(in the doorway)* …Song about Gnash? Gnash is FAMOUS!", req: { alive: "dwarf" } },
    ],
    "E-Remains": [
      { n: "The Orcs have won by destroying the Dwarves and the halfellows. The mountains and the hedgerows are silent." },
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "The two peoples who beat us. Both gone. So what do we keep inside the fence now?" },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! Beaten by the same two AGAIN! Skarra always said so—" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. Walls like the dwarves. Hedges like the halfellows." },
