...
window.GameData.STORY_SCENARIOS["orc/dwarf+halfellow"] = {
  ...
  beats: {
    ...
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "The two peoples who beat us. Both gone. So what do we keep inside the cage now?", m: "sad" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New cage. Same bog. …This time, we build inside it. Walls like the dwarves. Hedges like the halfellows.", m: "defiant" },
