...
window.GameData.STORY_SCENARIOS["orc/dwarf+halfellow"] = {
  ...
  beats: {
    ...
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "The two peoples who beat us. Both gone. So what do we keep inside the fence now?", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(in Karrak)* The last entry in Volume Seven: “The Bloodmire Clans. Broken.” …Amend it. “Worthy foe.”", m: "grudging", req: { conqueror: "dwarf" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. Walls like the dwarves. Hedges like the halfellows.", m: "defiant" },
