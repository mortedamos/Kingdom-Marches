...
window.GameData.STORY_SCENARIOS["orc/dwarf+halfellow+human"] = {
  ...
  beats: {
    ...
    B2: [
      ...
      { s: "varg", t: "They fight like they're on the same side, Father. They can't swear it, with the stone broken. They do it anyway.", m: "sad" },
    ],
    // Varg's wall.
    B3: [
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "I'll die with my axe in my hand, sister. Like I always said. By the boy's wall.", m: "defiant" },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. Boy. More walls.", m: "defiant" },
