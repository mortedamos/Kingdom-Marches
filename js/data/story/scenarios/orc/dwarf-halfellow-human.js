 ...
 * road. Grukka learns what he's missing -- builders -- and Varg has been
...
window.GameData.STORY_SCENARIOS["orc/dwarf+halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Dwarves build walls. The halfellows build farms. Westmarch builds roads. Everyone in the Marches builds something, sister. Except us." },
      { s: "skarra", t: "We build GRUDGES! Big ones! Tall as mountains!" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Gnash build too! Gnash build pile of smashed things! Very tall pile!" },
    ...
    B2: [
      ...
      { s: "varg", t: "They fight like they're on the same side, Father. They can't swear it, with the stone broken. They do it anyway." },
    ],
    // Varg's wall.
    B3: [
      { n: "The edge of {capital}, at dusk. Varg has brought his mother to see something. It is a wall." },
      { n: "It is not a pile of logs, or a ring of spikes. It is a real wall: dressed stone, mortared, with a gate that swings true." },
      { s: "grukka", t: "…Who built this?" },
      { s: "varg", t: "I did, Father." },
      { s: "grukka", t: "Orcs don't build walls, boy. Who *taught* you?" },
      { n: "Varg is quiet for a moment too long." },
      { s: "varg", t: "Someone who builds very good walls." },
      ...
      { s: "skarra", t: "*(appearing from nowhere)* A DWARF wall, brother. In OUR bog. Skarra wonders how *that* happened. Hee hee." },
      { s: "grukka", t: "*(not looking away from the wall)* Go away, Skarra. …Build more of these, boy. As many as you can." },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { n: "Across the Marches, the orc settlements have become real towns, with walls like the dwarves', hedges like the halfellows', and roads like Westmarch's." },
      ...
      { s: "grukka", t: "I'll stay by the door. …Your daughter builds a good wall, Thane.", req: { alive: "dwarf" } },
    ],
    "E-Remains": [
      ...
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { s: "grukka", t: "All the builders, gone. And we never learned how." },
      { s: "varg", t: "I did, Father. She taught me. …You took the whole mountain." },
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "I'll die with my axe in my hand, sister. Like I always said. By the boy's wall." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. Boy. More walls." },
      { s: "varg", t: "Father, I'm riding to Karrak. I need a better trowel.", req: { alive: "dwarf" }, alt: "As many as I can, Father." },
    ],
  },
};
