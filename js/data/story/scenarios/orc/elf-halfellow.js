...
window.GameData.STORY_SCENARIOS["orc/elf+halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Elves' forest. The halfellows' fields. The two softest peoples in the Marches, sitting on the most land. And us in the bog.", m: "angry" },
      { s: "skarra", t: "The moss-haired crow AND the goose-girl! Skarra has waited SO LONG for this!", m: "gleeful" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Soft peoples! Gnash like soft! Soft is easy smash! …Soft peoples have geese?", m: "confused" },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "If they're so soft, Father, why have they held that land for a thousand years, and we haven't held anything?", m: "bashful" },
    ...
    B3: [
      ...
      { s: "hobby", t: "Warchief! Lovely to finally meet you. You burned my hedge.", m: "scheming" },
      { s: "grukka", t: "I did.", m: "defiant" },
      { s: "aelthir", t: "And three of my groves. May I ask why?", m: "sad" },
      { s: "grukka", t: "Because you have the land and we have the bog. Because you're soft, and we're strong.", m: "defiant" },
      { s: "hobby", t: "Are you, dear? You've burned a hedge. We'll grow it back by spring. What will *you* have by spring?", m: "scheming" },
      { n: "Grukka opens his mouth, and finds he has no answer." },
      { s: "aelthir", t: "Taking is not strength, Warchief. It is only hunger. Strength is what you keep, afterwards.", m: "wistful" },
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "*(in the Hearthlands)* He *kept* it. Uncle, the Warchief actually kept it! I'm almost proud.", m: "happy", req: { alive: "halfellow" } },
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "All their land. All of it. And the hedges won't grow back by spring. There's nobody to grow them.", m: "sad" },
      { s: "varg", t: "It was only hunger, Father. The Warden said so.", m: "sad" },
      { s: "grukka", t: "…I know, boy. I know.", m: "sad" },
    ],
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! Beaten by the SOFT ones! Skarra always said so—", m: "angry" },
      { s: "skarra", t: "*(her voice cracks)* …You were always the favourite. I HATE you. Don't die.", m: "sad" },
      { s: "grukka", t: "I burned their hedge, and they grew it back around my town. I'll stand in it with my axe. That much I can still do.", m: "defiant" },
      { s: "grukka", t: "Take Moss. Ride. Plant something where you stop, boy. Something that grows back.", m: "sad" },
      { n: "Varg rides into the bog on his dire wolf. No one follows." },
      { s: "vaelis", t: "*(in the ashes)* Like weather, I said. I did not expect the quiet afterwards to be so loud.", m: "sad", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(setting a pie on the Speaking Stones)* For the Warchief. He came to look at the hedge he burned. Most never do.", m: "sad", req: { conqueror: "halfellow" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "Gardeners, fencing in the bog. …This time, we plant something too. Something that grows back by spring.", m: "defiant" },
    ],
  },
};
