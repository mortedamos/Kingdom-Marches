...
window.GameData.STORY_SCENARIOS["orc/elf+halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "No Dwarves. No mountain walls. Just forest, fields and towers. The softest march in the whole of the Marches.", m: "defiant" },
      { s: "skarra", t: "SOFT! Skarra LOVES soft! Soft BURNS!", m: "gleeful" },
      { n: "A huge shape shoulders through the crowd: Gnash, the ogre who serves as the clans' butcher." },
      { s: "gnash", t: "Soft! Easy smash! …Soft places have geese. Gnash KNOWS it.", m: "confused" },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "Taking soft land is easy, Father. Keeping it isn't. Nobody's ever kept the Marches by burning them.", m: "bashful" },
      { s: "grukka", t: "Then you'll show me how, boy. You and that wolf of yours.", m: "defiant" },
    ],
    B2: [
    ...
    B4: [
      ...
      { n: "Moss takes both arrows meant for his rider, and carries Varg home through the reeds. Only at the edge of {capital} does the great wolf lie down in the mud. He does not get up." },
      { fx: { flag: "mossDead" } },
      ...
      { s: "varg", t: "*(to his father)* No more building. Forest, fields, towers. We burn all of it. Starting with the trees.", m: "angry" },
    ...
    B5: [
      ...
      { s: "skarra", t: "Hear me, clans of Bloodmire! The elves shot the Warchief's son's wolf, and what did the Warchief do? *Nothing*! He's gone SOFT! Soft as the march he wants to *keep*!", m: "gleeful" },
      { s: "skarra", t: "But his SON hasn't! Varg! Stand with Skarra! Together we'll burn the whole soft march, for Moss!", m: "gleeful" },
      { n: "Every eye turns to Varg. For a long moment, he says nothing." },
      { s: "varg", t: "I'll burn it, aunt. But not for you. You never once said his name before today.", m: "angry" },
      { s: "grukka", t: "You'd use my son's grief to steal my seat, Skarra.", m: "angry" },
      ...
      { s: "grukka", t: "*(to Varg, when the clans have gone)* You didn't go with her.", m: "sad" },
    ...
    B6: [
      ...
      { s: "grukka", t: "Your halls, boy. We need them now. Every town we've taken is emptying. Nobody knows how to *keep*.", m: "sad" },
      { s: "varg", t: "Moss knew the way, Father. I don't any more.", m: "sad" },
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "*(in the Hearthlands)* The Orcs kept the Marches. With halls, and walls, and a carved wolf on every door. Uncle, write it down.", m: "happy", req: { alive: "halfellow", flag: "mossDead" } },
    ],
    "E-Remains": [
      { n: "The Orcs have won by destroying the Silverwood, the Hearthlands and Westmarch. The forest, the fields and the towers are silent." },
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "REMAINS." },
      { n: "Grukka sits atop the split Marchstone as if it were a throne. The stone is cold." },
      { s: "grukka", t: "We took the soft march. All of it. And nobody kept anything.", m: "sad" },
      ...
      { s: "varg", t: "Nothing to keep, Father. That was the point.", m: "sad", req: { flag: "mossDead" },
    ...
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! Beaten by the SOFT march! Skarra always said so—", m: "angry" },
      { s: "skarra", t: "*(her voice cracks)* …You were always the favourite. I HATE you. Don't die.", m: "sad" },
      { s: "grukka", t: "They called us the hard ones, sister. I'll show them what hard means, one last time, at the Speaking Stones.", m: "defiant" },
      { s: "grukka", t: "Ride, boy. Don't stop until the smoke is behind you.", m: "sad", req: { flag: "mossDead" }, alt: "Take Moss. Ride. Don't stop until the smoke is behind you." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "The soft march has fenced us in again. …This time, we build inside the fence. Something they can't burn down in a night.", m: "defiant" },
