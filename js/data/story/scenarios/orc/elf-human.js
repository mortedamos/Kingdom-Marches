...
window.GameData.STORY_SCENARIOS["orc/elf+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "On one side of the bog, the Elves' forest. On the other, Westmarch's towers. Between them, over a thousand years, they built our cage without ever asking us.", m: "angry" },
      ...
      { s: "varg", t: "Moss hates the mage-towers. They smell like lightning. Nothing real smells like lightning.", m: "bashful" },
    ],
    B2: [
    ...
    B3: [
      ...
      { s: "grukka", t: "Look at it, boy. Root on one side, tower on the other. A thousand years, and they never needed a wall. They *were* the wall.", m: "defiant" },
      { s: "varg", t: "They don't hate us, Father. They just never looked at us.", m: "sad" },
      { s: "grukka", t: "That's worse.", m: "angry" },
      ...
      { s: "vaelis", t: "Orcs on the hill. Looking at us. How *peculiar*. They have never done that before.", m: "aloof" },
      { n: "Far to the west, in Westmarch, the Human Queen Maren Ashcroft receives the same report." },
      { s: "maren", t: "The Warchief's looking at our towers. I want to know what he sees.", m: "resolute" },
    ],
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { n: "Across the Marches, the orc settlements have become real towns. Their walls have gates, and the gates stand open." },
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "Root and tower, closing the cage for good. At least they'll have to look at me, sister, when I meet them with my axe.", m: "defiant" },
      { s: "grukka", t: "Take Moss. Ride. And wherever you go, boy, make them look at you.", m: "sad" },
      { n: "Varg rides into the bog on his dire wolf. No one follows." },
      { s: "vaelis", t: "*(in the ashes)* The orcs are gone. I called them weather for years. I never once asked what the storm wanted.", m: "sad", req: { conqueror: "elf" } },
      { s: "maren", t: "*(in the ashes)* He came to our parley without a weapon. I should have asked my brother why we needed ours.", m: "sad", req: { conqueror: "human" } },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "Fine. This time we build inside it, where they can see. And we make them *look*.", m: "defiant" },
    ],
  },
};
