...
window.GameData.STORY_SCENARIOS["orc/halfellow"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "skarra", t: "And the goose-girl is MAYOR now! Forty years, Skarra has waited! Gnash! Remember the goose?" },
      ...
      { s: "varg", t: "The halfellows don't even have an army, Father." },
      { s: "grukka", t: "That's what we said last time, boy." },
    ],
    B2: [
      ...
      { s: "skarra", t: "Blood in the goose-girl's hedges! The ancestors are HUNGRY!" },
      { s: "gnash", t: "Was there goose? Gnash only go if no goose." },
      { n: "Varg says nothing. Grukka notices." },
      { s: "varg", t: "They set traps, Father. In *hedges*. With *jam* in them. Who fights like that?" },
    ],
    ...
    B3: [
      ...
      { s: "grukka", t: "No army. No walls. And they hold more land than the Clans have ever held. How?" },
      { s: "varg", t: "They *live* on it, Father. Every field has a family. Every family has a cellar. You can't raid a place where everyone is home." },
      { s: "skarra", t: "They hold it with GEESE and TRICKERY! It's CHEATING!" },
      { s: "grukka", t: "It's *keeping*, sister. …I want to learn it." },
      { n: "Far below, a halfellow farmer looks up at the orcs on the hill, and waves." },
      { s: "gnash", t: "*(waving back, very slowly)* …Gnash confused." },
    ],
    ...
    "E-Held": [
      ...
      { s: "hobby", t: "*(in the Hearthlands, on reading the news)* The Orcs, holding the Marches. With *hedges*. …I'm almost proud.", req: { alive: "halfellow" } },
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "We broke the fence. We took their fields. And there's nobody left to show us how to *keep* them." },
      { s: "varg", t: "Each other, Father. Try that." },
      { s: "skarra", t: "*(from somewhere in the reeds)* FORTY YEARS! SKARRA WINS! …Where are the geese?" },
    ],
    "E-Fallen": [
      ...
      { s: "skarra", t: "Look what you've DONE, little Warchief! Beaten by FARMERS! AGAIN! Skarra always said so—" },
      ...
      { s: "hobby", t: "For the Warchief. He kept his word. That's rarer than geese." },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "The halfellows hold the Marches. No army. No walls. Just… *everywhere*." },
      { s: "grukka", t: "New fence. Same bog. …This time, we build inside it. Plant a hedge, boy." },
      { s: "varg", t: "A hedge, Father?" },
      { s: "grukka", t: "They beat us with hedges twice. I'm not too proud to learn." },
    ],
  },
};
