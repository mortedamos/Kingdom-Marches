...
window.GameData.STORY_SCENARIOS["orc/halfellow"] = {
  ...
  beats: {
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "We broke the cage. We took their fields. And there's nobody left to show us how to *keep* them.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "Beaten by farmers twice. There won't be a third time, sister. My axe will see to that.", m: "defiant" },
      { s: "grukka", t: "Take Moss. Ride to the halfellows, boy. They hid geese from us for forty years. They can hide one orc.", m: "sad" },
    ...
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "A cage of hedges. …Then we plant our own. Plant a hedge, boy.", m: "defiant" },
