...
window.GameData.STORY_SCENARIOS["orc/elf"] = {
  ...
  beats: {
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "The best land in the Marches, and all of it ours. I thought it would feel like more than this.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "They never learned my name, sister. They'll learn it today, from the edge of my axe.", m: "defiant" },
      { s: "grukka", t: "Ride, boy. Moss would have carried you. Let the bog carry you now.", m: "sad", req: { flag: "mossDead" }, alt: "Take Moss. Ride. Don't look back." },
    ...
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "The trees have walked back over the borders. The bog is a cage again.", m: "defiant" },
