...
window.GameData.STORY_SCENARIOS["orc/elf"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "skarra", t: "The Marchstone, little Warchief! SPLIT in two! Now the Marches pass to the crown that HOLDS them, or else to the crown that REMAINS!" },
      { s: "grukka", t: "The Accord gave the Elves the Silverwood, the best land in the Marches. It gave us the bog. That stone was a fence, sister. Fences break." },
      ...
      { s: "gnash", t: "Fence break! Gnash smash fence MORE, to be sure!" },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "Moss can smell the forest from here, Father. It smells like… rain. Like things growing." },
      { s: "skarra", t: "It smells like the moss-haired crow! Eighty years, Skarra has waited to burn that witch's spring!" },
      ...
      { s: "vaelis", t: "Orcs. Yes. Who leads them now?" },
      { s: "vaelis", t: "…No, don't tell me. It will change by spring." },
    ],
    B2: [
      ...
      { s: "skarra", t: "Blood under the trees! The ancestors are HUNGRY, little Warchief! Avenge them!" },
      ...
      { s: "vaelis", t: "*(in the Silverwood)* Orcs at the edge of the forest. Like weather. Someone close the shutters." },
    ],
    ...
    B4: [
      ...
      { s: "varg", t: "*(to his father)* You always wanted me harder, Father. You've got it. I want every ranger in that forest dead. I want *him* dead." },
    ...
    B5: [
      ...
      { s: "skarra", t: "Hear me, clans of Bloodmire! The elves shot the Warchief's son's wolf, and what did the Warchief do? *Nothing*! He's gone SOFT!" },
      { s: "skarra", t: "But her SON hasn't! Varg! Stand with Skarra! Together we'll burn the Silverwood to the roots, for Moss!", req: { flag: "mossDead" } },
      { n: "Every eye turns to Varg. For a long moment, he says nothing." },
      { s: "varg", t: "I'll burn the Silverwood, aunt. But I won't do it for *you*. You never once said his name before today." },
      { s: "grukka", t: "You heard him, Skarra. You'd use my son's grief to steal my seat." },
      ...
      { s: "grukka", t: "You didn't go with her." },
    ...
    B6: [
      ...
      { s: "grukka", t: "Your halls, boy. You were going to show me how we keep things." },
      { s: "varg", t: "We don't keep things, Father. They shoot them. So we take theirs." },
    ...
    "E-Held": [
      ...
      { s: "vaelis", t: "*(in the Silverwood)* The orcs hold the Marches. …What *was* the Warchief's name?", req: { alive: "elf" } },
      { s: "grukka", t: "*(on hearing)* Somebody go and tell him. Slowly. Twice.", req: { alive: "elf" } },
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "We broke the fence. The best land in the Marches is ours. So what do we keep inside it now?" },
      ...
      { s: "varg", t: "Nothing, Father. There's nothing left to keep. That was the point.", req: { flag: "mossDead" },
    ...
    "E-Fallen": [
      ...
      { s: "vaelis", t: "*(in the ashes)* The Warchief is dead. Someone should record his name. …Does anyone know it?" },
      { n: "At the heart of the Marches, the split Marchstone speaks." },
      { s: "stone", t: "NOT YOU." },
    ],
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "The Elves hold the Marches. They've drawn new borders." },
