...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+halfellow+human"] = {
  ...
  beats: {
    ...
    B3: [
      ...
      { s: "varg", t: "The Dwarves dig in. The halfellows plant. The Humans raise towers. Even the Elves grow things. We're the only people in the Marches who've never *kept* anything.", m: "sad" },
      { s: "skarra", t: "Four peoples to break, and the Warchief's son wants to *keep* things. Careful, nephew. Soft things are always the first to be taken.", m: "gleeful" },
    ...
    "E-Held": [
      ...
      { s: "stone", t: "HELD." },
      { n: "Across the Marches, the orc settlements have become real towns, with walls, wells, and fields that don't rot. Where the Accord forged bars, there are gates now, and they stand open." },
    ...
    "E-Remains": [
      ...
      { s: "grukka", t: "We broke the cage. Every bar of it. And now there's nothing out there but ash, and nothing in here but us.", m: "sad" },
    ...
    "E-Fallen": [
      ...
      { s: "grukka", t: "Four crowns came for one bog, sister. I'll meet them at the Speaking Stones, axe in hand. Like I always said.", m: "defiant" },
      { n: "Grukka turns to his son one last time." },
      { s: "grukka", t: "Take Moss. Go north, to the singer. Whatever's left of the Clans will need somebody who knows how to keep things.", m: "sad" },
      { n: "Varg rides north on his dire wolf. No one follows." },
      { s: "oskar", t: "*(in Karrak)* The last entry in Volume Seven of the Book of Grudges: “The Bloodmire Clans. Broken.” …It took four crowns to do it. Put that in the margin. They'd want it remembered.", m: "grudging", req: { conqueror: "dwarf" } },
      { s: "vaelis", t: "*(in the ashes)* The weather has cleared. …I find I rather miss it.", m: "sad", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(setting a pie on the Speaking Stones)* For the Warchief. He was the only crown in this war who ever turned up unarmed. Somebody ought to remember that.", m: "sad", req: { conqueror: "halfellow" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "grukka", t: "New borders, same bog. Every crown in the Marches drew a line, and we're still on the inside of all of them.", m: "defiant" },
      ...
      { s: "grukka", t: "…Knock loud. And take her something from the bog. Dwarves like a guest who brings a gift.", m: "happy", req: { alive: "dwarf" } },
    ],
  },
};
