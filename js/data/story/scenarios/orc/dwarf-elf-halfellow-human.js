...
window.GameData.STORY_SCENARIOS["orc/dwarf+elf+halfellow+human"] = {
  ...
  beats: {
    B0: [
      ...
      { s: "grukka", t: "The Accord. The peace that gave the Elves their forests, the Dwarves their mountains, the Humans their rivers, the halfellows their fields… and us the bog." },
      ...
      { s: "grukka", t: "That stone was a fence, sister. Every crown in the Marches helped build it. Fences break." },
      ...
      { s: "grukka", t: "Everyone, Gnash. One at a time." },
      { n: "At the edge of the torchlight stands Varg, Grukka's son, one hand buried in the fur of Moss, his grey dire wolf mount." },
      { s: "varg", t: "Father, the people I met at the Midsummer Fair… they weren't all like the songs say." },
      { s: "grukka", t: "They were *them*, Varg." },
      { n: "Skarra's green eyes narrow at her nephew." },
      { s: "skarra", t: "Yes, Varg. They were *them*. Hee hee." },
    ],
    B2: [
      ...
      { s: "skarra", t: "Blood! The ancestors are HUNGRY, little Warchief! Avenge them! AVENGE THEM!" },
    ...
    B3: [
      ...
      { s: "grukka", t: "Mountain, forest, field and road. Four fences. We've broken through all of them this season. So why the long face, boy?" },
      ...
      { s: "varg", t: "The Dwarves dig in. The halfellows plant. The Humans pave. Even the Elves grow things. We're the only people in the Marches who've never *kept* anything." },
    ...
    B6: [
      ...
      { s: "grukka", t: "…That's the Thane's daughter. In my bog. Shoeing my wolves." },
      { s: "sigrun", t: "*(not looking up)* Your son's wall was leaning, Warchief. I fixed it. You're welcome." },
      { s: "varg", t: "Dwarves don't just take a mountain, Father. They dig in and stay. Cellars. Walls. Wells. Things you *keep*. She's been teaching me." },
      { s: "grukka", t: "Orcs don't keep, boy. Orcs take." },
      { s: "sigrun", t: "Then the next orc will take it from you. Unless you build something worth holding. …Hand me that hammer." },
      { n: "Grukka looks at the hammer. Then at the dwarf. Then at his son. Then he hands it over." },
      { s: "grukka", t: "Taking is easy. I've done it my whole life. …Show me how you keep it. Both of you." },
    ],
    ...
    "E-Held": [
      ...
      { s: "grukka", t: "I heard there was singing.", req: { alive: "dwarf" } },
      { s: "brunna", t: "Stay by the door, Warchief.", req: { alive: "dwarf" } },
      { s: "grukka", t: "I'll stay by the door.", req: { alive: "dwarf" } },
    ...
    "E-Fallen": [
      ...
      { s: "oskar", t: "*(in Karrak)* The last entry in Volume Seven of the Book of Grudges: “The Bloodmire Clans. Broken.” …Amend it. “Worthy foe.”", req: { conqueror: "dwarf" } },
      { s: "vaelis", t: "*(in the ashes)* The weather has cleared. …I find I rather miss it.", req: { conqueror: "elf" } },
      { s: "hobby", t: "*(setting a pie on the Speaking Stones)* For the Warchief. He kept his word. That's rarer than geese.", req: { conqueror: "halfellow" } },
    ...
    "E-Eclipsed": [
      ...
      { s: "stone", t: "HELD." },
      { s: "grukka", t: "Another crown holds the Marches. They've drawn new borders." },
      ...
      { s: "varg", t: "Father, I'm riding to Karrak.", req: { alive: "dwarf" }, alt: "Then let's build, Father." },
      { s: "grukka", t: "To fight?", req: { alive: "dwarf" } },
      { s: "varg", t: "To knock.", req: { alive: "dwarf" } },
      { s: "grukka", t: "…Knock loud. Dwarves are deaf from all that singing.", req: { alive: "dwarf" } },
    ],
  },
};
