...
window.GameData.STORY_BARKS.advance = {
  ...
  halfellow: {
    ...
    lines: [
      ...
      { s: "hobby", t: "{tech}. A happier Hearthlands is a harder Hearthlands to conquer.", cat: "civic", m: "scheming" },
      ...
      { s: "barnaby", t: "**The Riddle Game**! At last, the Archive's *true* purpose! I have eleven hundred riddles ready!", techs: ["halfellow_riddle_game"], m: "happy",
        then: [{ s: "hobby", t: "Start with the easy ones.", m: "happy" }, { s: "barnaby", t: "There *are* no easy ones!", m: "flustered" }] },
