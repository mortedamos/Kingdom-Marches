...
Object.assign(window.GameData.STORY_SHARED.halfellow, {
  ...
  B3: [
    ...
    { s: "barnaby", t: "Mayor, the complete text of the Long Accord. The only one in the Marches. I have annotated it. Lightly.", m: "flustered" },
    { s: "hobby", t: "Uncle, there are more footnotes than Accord.", m: "happy" },
    { s: "barnaby", t: "The Accord was *badly written*, Hobby. Someone had to fix it. Footnote nine: every crown swore peace. Footnote nine-*a*: none of them meant it.", m: "flustered" },
    { s: "goldie", t: "Eat something while you read, both of you. Footnotes don't count as supper.", m: "stern", alt: { s: "barnaby", t: "*(quietly)* Goldie would have made us eat something while we read.", m: "sad" } },
  ],
  B4: [
    ...
    { s: "barnaby", t: "It's not a *trick*, Hobby. It's *agriculture*.", m: "flustered" },
    { s: "hobby", t: "Uncle. It's *both*.", m: "scheming" },
  ],
  B5: [
    ...
    { s: "hobby", t: "I'm going in. Alone, tonight. Their war plans are in the command tent, and I'm going to walk out with them in my hat.", m: "scheming" },
    { s: "goldie", t: "No. You're not twenty, Hobby, and that goose is dead. If they catch you, the Hearthlands lose their Mayor in the middle of a war.", m: "angry",
      alt: { s: "barnaby", t: "No. Goldie would have said no, and she'd have been right. You're not twenty, Hobby.", m: "sad" } },
    { s: "barnaby", t: "For once in my life, I agree with your sister. It is *reckless*, even by your standards.", m: "flustered", req: { charAlive: "goldie" } },
    ...
    { s: "hobby", t: "…I'm turning into one of *them*, aren't I, Uncle. The ones who win wars.", m: "sad" },
    { s: "barnaby", t: "Not yet, Hobby. But you're close enough to see the house from here.", m: "sad" },
  ],
  B6: [
    ...
    { s: "goldie", t: "Sit. Eat. And then promise me something.", m: "stern", alt: { s: "barnaby", t: "Sit. Eat. She'd have insisted. And then promise *me* something.", m: "sad" } },
    { s: "hobby", t: "I've got a Moot in ten minutes.", m: "scheming" },
    { s: "goldie", t: "The Moot can wait ten minutes. Whatever you're planning next, it's the last one. The last scheme, the last trick. Then we go home.", m: "stern",
      alt: { s: "barnaby", t: "The Moot can wait. Whatever you're planning next, it's the last one. For her.", m: "sad" } },
    { s: "hobby", t: "…The last one. I promise.", m: "sad" },
  ],
