...
(function () {
  ...
  const CONDITION_DESCRIPTIONS = {
    ...
    blind: "Vision Radius drops to exactly 0 -- it can still see the tile it's standing on, but nothing beyond that, fog of war included. Unlike every other vision penalty in the game, this is NOT floored at 1; Blind is the one deliberate exception. Inflicted by a Bog Witch's Afflictions of Anguish (20% chance per landed hit, 3 turns).",
    keepingWatch: "Posted as a lookout (Halfellow's Keep an Eye Out) -- holds position with +3 Vision.",
    greatBonfireAura: "Within The Great Bonfire's warmth (Halfellow's Banish the Darkness): heals 10% of max HP per turn (minimum 1) regardless of resting, +2 Defense, +2 Vision, +1 Movement, +5% First Strike, +10% Double Strike, and +50% Siege -- also cures, and grants immunity to, Burning, Poisoned, Frozen, Curse, Befuddled, Webbed, and Blind. Refreshed every turn the aura still reaches it.",
  ...
  const UNIT_ACTIONS = [
    ...
    {
      key: "createMushroom", label: "Create Mushroom", icon: "🍄", restriction: "Halfellow — Mycomancer",
